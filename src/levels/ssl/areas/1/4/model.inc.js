...
import {
    ssl_seg7_texture_07000800} from "../../../texture.inc"

const ssl_seg7_vertex_0700BC88 = [
	{ pos: [ -6143, 0, -4697 ], flag: 0, tc: [ 990, 0 ], color: [ 255, 255, 255, 200 ] },
	{ pos: [ -5836, 0, -4697 ], flag: 0, tc: [ 0, 0 ], color: [ 255, 255, 255, 200 ] },
	{ pos: [ -5836, 0, -5004 ], flag: 0, tc: [ 0, 990 ], color: [ 255, 255, 255, 200 ] },
	{ pos: [ -6143, 0, -5004 ], flag: 0, tc: [ 990, 990 ], color: [ 255, 255, 255, 200 ] },
]

export const ssl_seg7_dl_0700BCC8 = [
	Gbi.gsDPSetTextureImage(Gbi.G_IM_FMT_IA, Gbi.G_IM_SIZ_16b, 1, ssl_seg7_texture_07000800),
	Gbi.gsDPLoadBlock(Gbi.G_TX_LOADTILE, 0, 0, 32 * 32 - 1),
	Gbi.gsSPVertex(ssl_seg7_vertex_0700BC88, 4, 0),
...
export const ssl_seg7_dl_0700BD00 = [
	...
	Gbi.gsSPDisplayList(ssl_seg7_dl_0700BCC8),
