...
import {
    gdSPDefLights1, gsSPLight, gsSPVertex, gsSP2Triangles, gsSPEndDisplayList, gsSP1Triangle, gsDPSetTextureImage, gsDPTileSync, gsDPSetTile, gsDPLoadSync, gsDPLoadBlock, gsDPPipeSync, gsDPSetCombineMode, gsSPLight, gsSPNumLights, gsSPTexture, gsDPSetTileSize, gsSPDisplayList, gsSPDisplayList
} from "../../include/gbi"

// 0x0500BA90
const bullet_bill_seg5_lights_0500BA90 = gdSPDefLights1(
    0x06, 0x07, 0x14,
...
// 0x0500DAA8
const bullet_bill_seg5_vertex_0500DAA8 = [
...
// 0x0500DB98
const bullet_bill_seg5_vertex_0500DB98 = [
...
// 0x0500DC28
const bullet_bill_seg5_vertex_0500DC28 = [
...
// 0x0500DD18
const bullet_bill_seg5_vertex_0500DD18 = [
    [[   -70,     71,    347], 0, [   508,   -448], [0xf0, 0x15, 0x7c, 0xff]],
...
// 0x0500DE08
const bullet_bill_seg5_vertex_0500DE08 = [
    [[   -70,    -70,    347], 0, [   508,    384], [0xd9, 0xe3, 0x74, 0xff]],
...
// 0x0500DEC8
const bullet_bill_seg5_vertex_0500DEC8 = [
...
// 0x0500DFB8
const bullet_bill_seg5_vertex_0500DFB8 = [
...
// 0x0500E0A8
const bullet_bill_seg5_vertex_0500E0A8 = [
    [[     0,   -249,   -192], 0, [     0,      0], [0xf0, 0x8a, 0xd6, 0xff]],
    [[     0,   -249,    161], 0, [     0,      0], [0x10, 0x86, 0x1c, 0xff]],
    [[  -176,   -176,    161], 0, [     0,      0], [0xb6, 0x9e, 0x1c, 0xff]],
    [[     0,   -249,   -192], 0, [     0,      0], [0xf0, 0x8a, 0xd6, 0xff]],
...
// 0x0500E198
const bullet_bill_seg5_vertex_0500E198 = [
    [[   177,    177,   -192], 0, [     0,      0], [0x52, 0x3e, 0xb7, 0xff]],
...
// 0x0500E288
const bullet_bill_seg5_vertex_0500E288 = [
    [[     0,    196,    272], 0, [     0,      0], [0x02, 0x62, 0x50, 0xff]],
...
// 0x0500E378
const bullet_bill_seg5_vertex_0500E378 = [
    [[  -138,    139,    272], 0, [     0,      0], [0xbc, 0x47, 0x50, 0xff]],
    [[     0,    196,    272], 0, [     0,      0], [0x02, 0x62, 0x50, 0xff]],
    [[     0,    250,    161], 0, [     0,      0], [0xef, 0x7a, 0x1c, 0xff]],
    [[  -176,    177,   -192], 0, [     0,      0], [0xc2, 0x52, 0xb7, 0xff]],
...
// 0x0500E468
const bullet_bill_seg5_vertex_0500E468 = [
    [[  -176,   -176,   -192], 0, [     0,      0], [0xd6, 0xe0, 0x8d, 0xff]],
    [[  -249,      0,    161], 0, [     0,      0], [0x86, 0xef, 0x1c, 0xff]],
    [[  -249,      0,   -192], 0, [     0,      0], [0x8a, 0x10, 0xd6, 0xff]],
...
// 0x0500E558
const bullet_bill_seg5_vertex_0500E558 = [
...
const bullet_bill_seg5_dl_0500E5E8 = [
...
const bullet_bill_seg5_dl_0500E678 = [
...
const bullet_bill_seg5_dl_0500E730 = [
...
const bullet_bill_seg5_dl_0500E8A8 = [
    gsDPPipeSync(),
