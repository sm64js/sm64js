...
import {
    ...
    SURFACE_DEFAULT, SURFACE_BURNING, SURFACE_HANGABLE, SURFACE_VERY_SLIPPERY,
...
export const bitfs_seg7_collision_level = [
    COL_INIT(),
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(24),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_null_start,   /*pos*/ -7577, -2764,    0, /*yaw*/ 64),
