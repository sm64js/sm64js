...
import {
    ...
    gsSPDisplayList, gsSPGeometryMode,
...
import {
    lll_seg7_texture_0700DC00, lll_seg7_texture_0700E400, lll_seg7_texture_0700EC00,
    lll_seg7_texture_0700F400
} from "../../../texture.inc"

import { fire_09005800 } from "../../../../../textures/fire"

const lll_seg7_vertex_0701D7D0 = [
...
const lll_seg7_vertex_0701D8C0 = [
    [[   583,   2352,  -2942], 0, [   324,    936], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701D9C0 = [
    [[  2034,   3181,   1185], 0, [  3132,   -578], [0xff, 0xff, 0xff, 0xff]],
    [[  1840,   3050,   1444], 0, [  2742,   -154], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701DAC0 = [
...
const lll_seg7_vertex_0701DBB0 = [
    [[   468,   1698,    405], 0, [  1578,   1898], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701DCA0 = [
    [[  1463,   3115,  -2175], 0, [  1022,    150], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701DDA0 = [
...
const lll_seg7_vertex_0701DEA0 = [
    [[ -2046,   1930,    475], 0, [  3132,   -578], [0xff, 0xff, 0xff, 0xff]],
    [[ -2363,   1799,    402], 0, [  2742,   -154], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701DF90 = [
...
const lll_seg7_vertex_0701E090 = [
...
const lll_seg7_vertex_0701E180 = [
...
const lll_seg7_vertex_0701E280 = [
    [[  2154,   2121,  -2153], 0, [     0,    902], [0xff, 0xff, 0xff, 0xff]],
    [[  2554,    159,  -1461], 0, [  2556,   7260], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701E360 = [
...
const lll_seg7_vertex_0701E440 = [
...
const lll_seg7_vertex_0701E530 = [
...
const lll_seg7_vertex_0701E620 = [
...
const lll_seg7_vertex_0701E720 = [
    [[   645,    978,   2328], 0, [   432,   4604], [0xff, 0xff, 0xff, 0xff]],
    [[  -787,   1152,   2328], 0, [  5078,   4040], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701E810 = [
...
const lll_seg7_vertex_0701E900 = [
...
const lll_seg7_vertex_0701E940 = [
...
const lll_seg7_vertex_0701EA30 = [
...
const lll_seg7_vertex_0701EB30 = [
    [[   199,      0,  -2520], 0, [  -512,   1018], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701EC30 = [
    [[ -1602,    102,   1563], 0, [  1150,    150], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701ED20 = [
...
const lll_seg7_vertex_0701EE00 = [
...
const lll_seg7_vertex_0701EF00 = [
    [[  1492,    184,  -1253], 0, [  -266,   -284], [0xff, 0xff, 0xff, 0xff]],
    [[  1564,      0,  -1290], 0, [  -562,    470], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701F000 = [
    [[ -1201,    103,  -1273], 0, [  1274,   -488], [0xff, 0xff, 0xff, 0xff]],
    [[  -842,    103,  -1301], 0, [   788,    606], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701F100 = [
...
const lll_seg7_vertex_0701F200 = [
    [[  -776,      0,   -615], 0, [ -1320,   -292], [0xff, 0xff, 0xff, 0xff]],
    [[  -825,    102,   -746], 0, [  -862,   -226], [0xff, 0xff, 0xff, 0xff]],
    [[  -970,    102,   -746], 0, [  -632,   -650], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701F2F0 = [
    [[  1569,     82,  -1978], 0, [  2108,  -1776], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701F3F0 = [
    [[   996,     82,  -1725], 0, [   484,   -470], [0xff, 0xff, 0xff, 0xff]],
    [[   948,      0,  -1849], 0, [   224,   -826], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701F4F0 = [
...
const lll_seg7_vertex_0701F5E0 = [
...
const lll_seg7_vertex_0701F6E0 = [
    [[  1866,    128,  -1657], 0, [  1788,      0], [0xff, 0xff, 0xff, 0xff]],
    [[  2154,   -204,  -2153], 0, [     0,   1044], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701F7C0 = [
...
const lll_seg7_vertex_0701F8B0 = [
    [[ -2942,    128,    788], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]],
    [[ -2942,   -204,   -787], 0, [  5078,   1044], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_0701F990 = [
...
const lll_seg7_vertex_0701FA90 = [
...
const lll_seg7_vertex_0701FB80 = [
...
const lll_seg7_vertex_0701FC60 = [
...
const lll_seg7_vertex_0701FD60 = [
...
const lll_seg7_vertex_0701FE40 = [
...
const lll_seg7_vertex_0701FF40 = [
...
const lll_seg7_vertex_07020040 = [
...
const lll_seg7_vertex_07020140 = [
...
const lll_seg7_vertex_07020230 = [
    [[  -787,   1203,   2943], 0, [   890,  -4694], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_07020310 = [
...
const lll_seg7_vertex_07020400 = [
...
const lll_seg7_vertex_070204F0 = [
...
const lll_seg7_vertex_070205E0 = [
...
const lll_seg7_vertex_070206E0 = [
...
const lll_seg7_vertex_070207D0 = [
    [[  1266,   3202,   1191], 0, [   644,      0], [0xff, 0xff, 0xff, 0xff]],
    [[  1266,   3151,   1191], 0, [   644,    479], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_070208D0 = [
...
const lll_seg7_vertex_070209C0 = [
...
const lll_seg7_vertex_07020AA0 = [
...
const lll_seg7_vertex_07020B80 = [
...
const lll_seg7_vertex_07020C80 = [
...
const lll_seg7_vertex_07020D80 = [
    [[   830,   1126,    -97], 0, [  1176,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   830,   1075,    -97], 0, [  1176,    479], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_07020E80 = [
    [[  1332,   3222,  -2205], 0, [   644,      0], [0xff, 0xff, 0xff, 0xff]],
    [[  1332,   3171,  -2205], 0, [   644,    479], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_07020F80 = [
...
const lll_seg7_vertex_07021070 = [
...
const lll_seg7_vertex_07021170 = [
...
const lll_seg7_vertex_07021250 = [
...
const lll_seg7_vertex_07021350 = [
...
const lll_seg7_vertex_07021450 = [
    [[ -2110,   1853,   -520], 0, [  1160,    479], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_07021550 = [
    [[ -2090,   1864,   1124], 0, [   984,      0], [0xff, 0xff, 0xff, 0xff]],
    [[ -2032,   1812,    695], 0, [  2012,    479], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_07021630 = [
...
const lll_seg7_vertex_07021720 = [
...
const lll_seg7_vertex_07021820 = [
    [[  1704,   3539,  -1703], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]],
    [[  2411,   3463,   -480], 0, [  4056,    479], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_07021920 = [
    [[ -2153,   2442,  -2153], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]],
...
const lll_seg7_vertex_07021A00 = [
...
const lll_seg7_vertex_07021AE0 = [
...
const lll_seg7_vertex_07021BD0 = [
...
const lll_seg7_vertex_07021CC0 = [
...
const lll_seg7_vertex_07021DB0 = [
...
export const lll_seg7_dl_070235C8 = [
    gsDPPipeSync(),
