...
export const level_ccm_entry = [
    ...
    { command: LevelCommands.load_model_from_geo, args: [MODEL_LEVEL_GEOMETRY_04, ccm_geo_00045C] },
    { command: LevelCommands.load_model_from_geo, args: [MODEL_LEVEL_GEOMETRY_05, ccm_geo_000494] },
    { command: LevelCommands.load_model_from_geo, args: [MODEL_LEVEL_GEOMETRY_06, ccm_geo_0004BC] },
    ...
    { command: LevelCommands.load_model_from_geo, args: [MODEL_CCM_CABIN_DOOR, cabin_door_geo ] },
