import { AREA, CALL, CALL_LOOP, CLEAR_LEVEL, END_AREA, EXIT, INIT_LEVEL, JUMP_LINK,
         ...
         RETURN, SLEEP_BEFORE_EXIT, TERRAIN, TERRAIN_TYPE, SET_BACKGROUND_MUSIC
...
import { MODEL_MARIO, MODEL_BOB_BARS_GRILLS, MODEL_BOB_BUBBLY_TREE, MODEL_BOB_CHAIN_CHOMP_GATE,
         ...
         MODEL_CHECKERBOARD_PLATFORM, MODEL_DL_CANNON_LID, MODEL_KING_BOBOMB,
...
const script_load_one_flag = [
    ...
    OBJECT(MODEL_STAR, /*pos*/ -3213, 3348, -3011, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvCastleFlagWaving),
    RETURN(),
]
...
export const level_bob_entry = [
    ...
    AREA(/*index*/ 1, bob_geo_000488),
        JUMP_LINK(script_load_one_flag),
