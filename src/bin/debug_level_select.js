import {
    gdSPDefLights1, gsDPPipeSync, gsSPSetLights1, gsSPVertex, gsSP2Triangles, gsSP1Triangle,
    gsSPEndDisplayList
} from "../include/gbi"

// 0x07000000 - 0x07000018
const debug_level_select_lights_07000000 = gdSPDefLights1(
    0x7f, 0x00, 0x00,
    0xff, 0x00, 0x00, 0x00, 0x00, 0x50
);

// 0x07000018 - 0x07000108
const debug_level_select_vertex_07000018 = [
...
const debug_level_select_vertex_07000108 = [
    [[    -8,    -21,    -19], 0, [     0,      0], [0xd9, 0x79, 0x00, 0x00]],
    [[   -59,    -38,     20], 0, [     0,      0], [0xd9, 0x79, 0x00, 0x00]],
...
const debug_level_select_vertex_070001F8 = [
    [[    31,    -57,    -19], 0, [     0,      0], [0x5a, 0xa5, 0x00, 0x00]],
...
const debug_level_select_vertex_070002E8 = [
    [[   -10,     30,    -19], 0, [     0,      0], [0x55, 0xa0, 0x00, 0x00]],
    [[     5,     44,     20], 0, [     0,      0], [0x55, 0xa0, 0x00, 0x00]],
...
const debug_level_select_vertex_070003D8 = [
...
const debug_level_select_vertex_070004C8 = [
    [[   -23,     74,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    56,     49,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_070005B8 = [
    [[    31,    -57,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -59,    -38,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_070006A8 = [
    [[    -8,    -21,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[   -23,    -71,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
const debug_level_select_vertex_07000798 = [
    [[     5,     44,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    19,     77,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
export const debug_level_select_dl_07000858 = [
    gsDPPipeSync(),
...
const debug_level_select_lights_07000A28 = gdSPDefLights1(
    0x00, 0x00, 0x7f,
    0x00, 0x00, 0xff, 0x00, 0x00, 0x50
);

// 0x07000A40 - 0x07000B30
const debug_level_select_vertex_07000A40 = [
...
const debug_level_select_vertex_07000B30 = [
    [[   -20,    -72,    -22], 0, [     0,      0], [0x11, 0x81, 0x00, 0x00]],
    [[    33,    -64,     20], 0, [     0,      0], [0x30, 0x89, 0x00, 0x00]],
...
const debug_level_select_vertex_07000C20 = [
...
const debug_level_select_vertex_07000D10 = [
    [[    21,    -18,    -22], 0, [     0,      0], [0xb0, 0x64, 0x00, 0x00]],
    [[    -4,    -38,     20], 0, [     0,      0], [0xb0, 0x64, 0x00, 0x00]],
...
const debug_level_select_vertex_07000E00 = [
...
const debug_level_select_vertex_07000EF0 = [
    [[   -20,    -72,    -22], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07000FE0 = [
    [[    33,    -64,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    39,     58,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
const debug_level_select_vertex_070010D0 = [
    [[    -4,    -38,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[   -42,    -36,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    33,    -64,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
];
...
export const debug_level_select_dl_07001100 = [
    gsDPPipeSync(),
...
const debug_level_select_lights_07001288 = gdSPDefLights1(
    0x00, 0x56, 0x00,
    0x00, 0xad, 0x00, 0x00, 0x00, 0x50
);

// 0x070012A0 - 0x07001390
const debug_level_select_vertex_070012A0 = [
...
const debug_level_select_vertex_07001390 = [
    [[   -42,    -71,    -19], 0, [     0,      0], [0x02, 0x80, 0x00, 0x00]],
    [[    -5,    -71,     20], 0, [     0,      0], [0x02, 0x80, 0x00, 0x00]],
...
const debug_level_select_vertex_07001480 = [
    [[    20,    -44,    -19], 0, [     0,      0], [0x3e, 0x90, 0x00, 0x00]],
...
const debug_level_select_vertex_07001570 = [
    [[    47,     65,    -19], 0, [     0,      0], [0x2e, 0x77, 0x00, 0x00]],
    [[     3,     82,     20], 0, [     0,      0], [0x1f, 0x7c, 0x00, 0x00]],
...
const debug_level_select_vertex_07001660 = [
...
const debug_level_select_vertex_07001750 = [
    [[    29,     34,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[     3,     82,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07001840 = [
    [[   -42,     82,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[     3,     82,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    -5,     32,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -42,     82,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07001930 = [
    [[    -5,    -43,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    -5,     -4,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    18,     -9,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07001A20 = [
    [[    -5,    -43,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
const debug_level_select_vertex_07001B10 = [
    [[    18,     -9,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    -5,    -43,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    58,     -8,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    58,     -8,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
export const debug_level_select_dl_07001BA0 = [
    gsDPPipeSync(),
...
const debug_level_select_lights_07001D98 = gdSPDefLights1(
    0x7f, 0x00, 0x00,
    0xff, 0x00, 0x00, 0x00, 0x00, 0x50
);

// 0x07001DB0 - 0x07001EA0
const debug_level_select_vertex_07001DB0 = [
...
const debug_level_select_vertex_07001EA0 = [
    [[   -22,    -62,    -19], 0, [     0,      0], [0x0a, 0x80, 0x00, 0x00]],
    [[    73,    -54,     20], 0, [     0,      0], [0x0a, 0x80, 0x00, 0x00]],
...
const debug_level_select_vertex_07001F90 = [
...
const debug_level_select_vertex_07002080 = [
    [[    43,     -7,    -19], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
    [[    43,     19,     20], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
...
const debug_level_select_vertex_07002170 = [
...
const debug_level_select_vertex_07002260 = [
...
const debug_level_select_vertex_07002350 = [
    [[     7,    -28,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -22,    -62,    -19], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07002440 = [
    [[   -22,    -62,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    57,    -18,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
const debug_level_select_vertex_07002530 = [
    [[     1,     42,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    42,     76,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
export const debug_level_select_dl_070025F0 = [
    gsDPPipeSync(),
...
const debug_level_select_lights_070027C0 = gdSPDefLights1(
    0x00, 0x00, 0x7f,
    0x00, 0x00, 0xff, 0x00, 0x00, 0x50
);

// 0x070027D8 - 0x070028C8
const debug_level_select_vertex_070027D8 = [
...
const debug_level_select_vertex_070028C8 = [
    [[   -37,    -71,    -20], 0, [     0,      0], [0x00, 0x80, 0x00, 0x00]],
    [[     0,    -71,     20], 0, [     0,      0], [0x00, 0x80, 0x00, 0x00]],
    [[   -37,    -71,     20], 0, [     0,      0], [0x00, 0x80, 0x00, 0x00]],
...
const debug_level_select_vertex_070029B8 = [
...
const debug_level_select_vertex_07002AA8 = [
    [[    35,     -8,    -20], 0, [     0,      0], [0x53, 0x9f, 0x00, 0x00]],
    [[    64,     16,     20], 0, [     0,      0], [0x6d, 0xbd, 0x00, 0x00]],
    [[    35,     -8,     20], 0, [     0,      0], [0x53, 0x9f, 0x00, 0x00]],
    [[    64,     16,    -20], 0, [     0,      0], [0x7d, 0xe6, 0x00, 0x00]],
...
const debug_level_select_vertex_07002B98 = [
...
const debug_level_select_vertex_07002C88 = [
    [[    11,     -3,    -20], 0, [     0,      0], [0x44, 0x6c, 0x00, 0x00]],
    [[    -9,     10,     20], 0, [     0,      0], [0x63, 0x51, 0x00, 0x00]],
    [[    11,     -3,     20], 0, [     0,      0], [0x44, 0x6c, 0x00, 0x00]],
    [[    -9,     10,    -20], 0, [     0,      0], [0x79, 0x28, 0x00, 0x00]],
...
const debug_level_select_vertex_07002D78 = [
    [[    32,     32,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    59,     58,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07002E68 = [
    [[    -7,    -14,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -37,    -71,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07002F58 = [
    [[    -7,    -14,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -43,     76,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    -9,     10,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    -7,    -14,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07003048 = [
    [[    -7,    -14,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
const debug_level_select_vertex_07003138 = [
    [[    64,     16,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[   -43,     76,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    32,     32,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    64,     16,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
const debug_level_select_vertex_07003228 = [
    [[    -7,    -14,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    11,     -3,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    -9,     10,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
];
...
export const debug_level_select_dl_07003258 = [
    gsDPPipeSync(),
...
const debug_level_select_lights_070034A0 = gdSPDefLights1(
    0x7f, 0x00, 0x00,
    0xff, 0x00, 0x00, 0x00, 0x00, 0x50
);

// 0x070034B8 - 0x070035A8
const debug_level_select_vertex_070034B8 = [
...
const debug_level_select_vertex_070035A8 = [
    [[   -23,    107,    -20], 0, [     0,      0], [0x02, 0x7f, 0x00, 0x00]],
    [[   -64,    108,     19], 0, [     0,      0], [0x02, 0x7f, 0x00, 0x00]],
...
const debug_level_select_vertex_07003698 = [
...
const debug_level_select_vertex_07003788 = [
    [[    -2,    -46,    -20], 0, [     0,      0], [0x71, 0xc4, 0x00, 0x00]],
    [[    29,     14,     19], 0, [     0,      0], [0x71, 0xc4, 0x00, 0x00]],
...
const debug_level_select_vertex_07003878 = [
...
const debug_level_select_vertex_07003968 = [
    [[    64,     89,    -20], 0, [     0,      0], [0x4d, 0x65, 0x00, 0x00]],
    [[    17,    107,     19], 0, [     0,      0], [0x2f, 0x76, 0x00, 0x00]],
    [[    64,     89,     19], 0, [     0,      0], [0x68, 0x4a, 0x00, 0x00]],
...
const debug_level_select_vertex_07003A58 = [
    [[   -32,      9,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07003B48 = [
    [[    -1,     60,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   119,    -61,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    29,     14,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    -1,     60,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07003C38 = [
    [[   -32,      9,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
const debug_level_select_vertex_07003D28 = [
    [[    -1,     60,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[   -32,      9,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    29,     14,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    29,     14,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
export const debug_level_select_dl_07003DB8 = [
    gsDPPipeSync(),
...
const debug_level_select_lights_07003FB0 = gdSPDefLights1(
    0x00, 0x00, 0x7f,
    0x00, 0x00, 0xff, 0x00, 0x00, 0x50
);

// 0x07003FC8 - 0x070040B8
const debug_level_select_vertex_07003FC8 = [
...
const debug_level_select_vertex_070040B8 = [
    [[   -48,    -72,    -20], 0, [     0,      0], [0x70, 0xc2, 0x00, 0x00]],
    [[   -35,    -47,     19], 0, [     0,      0], [0x70, 0xc2, 0x00, 0x00]],
...
const debug_level_select_vertex_070041A8 = [
...
const debug_level_select_vertex_07004298 = [
    [[    28,     74,    -20], 0, [     0,      0], [0x3f, 0x6e, 0x00, 0x00]],
    [[   -15,     83,     19], 0, [     0,      0], [0x18, 0x7d, 0x00, 0x00]],
    [[    28,     74,     19], 0, [     0,      0], [0x63, 0x50, 0x00, 0x00]],
...
const debug_level_select_vertex_07004388 = [
...
const debug_level_select_vertex_07004478 = [
    [[    -6,     29,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -15,     83,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07004568 = [
    [[   -35,    -47,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -15,     83,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -22,    -19,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -35,    -47,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07004658 = [
    [[    26,    -65,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    15,    -20,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[     8,     28,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07004748 = [
    [[    26,    -65,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
const debug_level_select_vertex_07004838 = [
    [[    28,     74,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[     8,     28,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
export const debug_level_select_dl_070048C8 = [
    gsDPPipeSync(),
...
const debug_level_select_lights_07004AC0 = gdSPDefLights1(
    0x00, 0x59, 0x00,
    0x00, 0xb2, 0x00, 0x00, 0x00, 0x50
);

// 0x07004AD8 - 0x07004BC8
const debug_level_select_vertex_07004AD8 = [
...
const debug_level_select_vertex_07004BC8 = [
    [[   -17,    -92,    -20], 0, [     0,      0], [0x7f, 0xff, 0x00, 0x00]],
    [[   -17,    -40,     19], 0, [     0,      0], [0x7f, 0xff, 0x00, 0x00]],
...
const debug_level_select_vertex_07004CB8 = [
...
const debug_level_select_vertex_07004DA8 = [
    [[    64,     -1,    -20], 0, [     0,      0], [0x78, 0xd4, 0x00, 0x00]],
    [[    66,     58,     19], 0, [     0,      0], [0x7f, 0xfb, 0x00, 0x00]],
    [[    64,     -1,     19], 0, [     0,      0], [0x63, 0xaf, 0x00, 0x00]],
...
const debug_level_select_vertex_07004E98 = [
...
const debug_level_select_vertex_07004F88 = [
    [[    20,     24,    -20], 0, [     0,      0], [0x90, 0x3f, 0x00, 0x00]],
    [[    -1,    -14,     19], 0, [     0,      0], [0x90, 0x3f, 0x00, 0x00]],
...
const debug_level_select_vertex_07005078 = [
    [[   -12,     50,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[     6,     95,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07005168 = [
    [[   -17,    -40,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -61,    -92,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -60,     95,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -17,    -40,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07005258 = [
    [[    35,    -20,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -17,    -40,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    -1,    -14,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    35,    -20,    -20], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07005348 = [
    [[   -17,    -40,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    85,    -57,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
const debug_level_select_vertex_07005438 = [
    [[   -60,     95,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[   -12,     50,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
const debug_level_select_vertex_07005528 = [
    [[    66,     58,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    20,     24,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    -1,    -14,     19], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
];
...
export const debug_level_select_dl_07005558 = [
    gsDPPipeSync(),
...
const debug_level_select_lights_070057A0 = gdSPDefLights1(
    0x7f, 0x00, 0x00,
    0xff, 0x00, 0x00, 0x00, 0x00, 0x50
);

// 0x070057B8 - 0x070058A8
const debug_level_select_vertex_070057B8 = [
...
const debug_level_select_vertex_070058A8 = [
    [[    28,    -98,    -19], 0, [     0,      0], [0x7f, 0x09, 0x00, 0x00]],
    [[    13,    100,     20], 0, [     0,      0], [0x7f, 0x09, 0x00, 0x00]],
...
const debug_level_select_vertex_07005998 = [
...
export const debug_level_select_dl_070059F8 = [
    gsDPPipeSync(),
...
const debug_level_select_lights_07005A98 = gdSPDefLights1(
    0x00, 0x00, 0x7f,
    0x00, 0x00, 0xff, 0x00, 0x00, 0x50
);

// 0x07005AB0 - 0x07005BA0
const debug_level_select_vertex_07005AB0 = [
...
const debug_level_select_vertex_07005BA0 = [
    [[   -72,     33,    -26], 0, [     0,      0], [0x84, 0x23, 0x00, 0x00]],
    [[   -72,    -32,     20], 0, [     0,      0], [0x86, 0xd8, 0x00, 0x00]],
    [[   -72,     33,     20], 0, [     0,      0], [0x95, 0x47, 0x00, 0x00]],
    [[   -72,    -32,    -26], 0, [     0,      0], [0x9a, 0xb1, 0x00, 0x00]],
...
const debug_level_select_vertex_07005C90 = [
...
const debug_level_select_vertex_07005D80 = [
    [[     2,     31,    -26], 0, [     0,      0], [0xa8, 0xa3, 0x00, 0x00]],
    [[    31,      4,     20], 0, [     0,      0], [0xa8, 0xa3, 0x00, 0x00]],
...
const debug_level_select_vertex_07005E70 = [
...
const debug_level_select_vertex_07005F60 = [
...
const debug_level_select_vertex_07006050 = [
    [[   -72,    -32,    -26], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -30,     68,    -26], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    30,     71,    -26], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -72,    -32,    -26], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07006140 = [
    [[    54,    -62,    -26], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[   -14,    -27,    -26], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
    [[    20,    -19,    -26], 0, [     0,      0], [0x00, 0x00, 0x80, 0x00]],
...
const debug_level_select_vertex_07006230 = [
    [[    86,     14,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
const debug_level_select_vertex_07006320 = [
    [[   -14,    -72,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    86,     14,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[    20,    -19,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
    [[   -14,    -72,     20], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
export const debug_level_select_dl_070063B0 = [
    gsDPPipeSync(),
...
// 1621652030 - 2021-05-21 19:53:52 -0700
