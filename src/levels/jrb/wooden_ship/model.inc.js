...
import {
    ...
    gsSPClearGeometryMode, gsDPSetEnvColor,
    ...
    G_RM_AA_ZB_XLU_SURF2, G_CC_MODULATERGBFADE, G_RM_AA_ZB_XLU_SURF
} from "../../../include/gbi"
import {
    water_09005800, water_09000000, water_09000800, water_0900A800
} from "../../../textures/water"

const jrb_seg7_lights_070081A8 = gdSPDefLights1(
    0x1e, 0x2c, 0x3a,
    0x79, 0xb2, 0xeb, 0x28, 0x28, 0x28
);

// 0x070081C0 - 0x070081D8
const jrb_seg7_lights_070081C0 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x070081D8 - 0x070082C8
const jrb_seg7_vertex_070081D8 = [
...
const jrb_seg7_vertex_070082C8 = [
...
const jrb_seg7_vertex_070083B8 = [
...
const jrb_seg7_vertex_07008478 = [
...
const jrb_seg7_vertex_07008578 = [
    [[  -101,   -511,   2048], 0, [ -2034,    994], [0xa5, 0xaf, 0x21, 0xff]],
...
const jrb_seg7_vertex_07008668 = [
    [[  -306,    819,   2560], 0, [  2522,      0], [0x4a, 0x53, 0xc5, 0xff]],
...
const jrb_seg7_vertex_070086C8 = [
...
const jrb_seg7_vertex_070087B8 = [
...
const jrb_seg7_vertex_070088A8 = [
...
const jrb_seg7_vertex_070089A8 = [
    [[  -511,   -204,   1946], 0, [ -3708,  12230], [0xaf, 0xa7, 0x26, 0xff]],
    [[  -101,   -409,   -921], 0, [  7736,  14274], [0xa4, 0xa9, 0x00, 0xff]],
...
const jrb_seg7_vertex_07008A98 = [
    [[   256,   1075,   -101], 0, [  9676,    478], [0x00, 0x00, 0x7f, 0xff]],
    [[   717,   1126,   -101], 0, [ 14276,      0], [0x00, 0x00, 0x7f, 0xff]],
    [[  -716,   1126,   -101], 0, [     0,      0], [0x00, 0x00, 0x7f, 0xff]],
];
...
const jrb_seg7_vertex_07008AC8 = [
...
export const jrb_seg7_dl_07008FD8 = [
    gsDPPipeSync(),
...
export const jrb_seg7_dl_070090B0 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
...
const jrb_seg7_lights_07009190 = gdSPDefLights1(
    0x1e, 0x2c, 0x3a,
    0x79, 0xb2, 0xeb, 0x28, 0x28, 0x28
);

// 0x070091A8 - 0x070091C0
const jrb_seg7_lights_070091A8 = gdSPDefLights1(
    0x19, 0x2c, 0x3f,
    0x65, 0xb2, 0xff, 0x28, 0x28, 0x28
);

// 0x070091C0 - 0x070091D8
const jrb_seg7_lights_070091C0 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x070091D8 - 0x07009218
const jrb_seg7_vertex_070091D8 = [
...
const jrb_seg7_vertex_07009218 = [
...
const jrb_seg7_vertex_07009258 = [
...
const jrb_seg7_vertex_07009358 = [
...
const jrb_seg7_vertex_070093A8 = [
...
const jrb_seg7_vertex_07009488 = [
...
const jrb_seg7_vertex_07009588 = [
...
const jrb_seg7_vertex_07009688 = [
    [[  -511,    205,  -1330], 0, [  9372,   8142], [0x9f, 0xdf, 0xb7, 0xff]],
    [[  -306,    307,  -1535], 0, [ 10188,   7120], [0xce, 0xee, 0x8d, 0xff]],
...
const jrb_seg7_vertex_07009738 = [
...
export const jrb_seg7_dl_07009A58 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
export const jrb_seg7_dl_07009B30 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_XLU_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
const jrb_seg7_lights_07009C10 = gdSPDefLights1(
    0x1e, 0x2c, 0x3a,
    0x79, 0xb2, 0xeb, 0x28, 0x28, 0x28
);

// 0x07009C28 - 0x07009C40
const jrb_seg7_lights_07009C28 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x07009C40 - 0x07009C58
const jrb_seg7_lights_07009C40 = gdSPDefLights1(
    0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x07009C58 - 0x07009D48
const jrb_seg7_vertex_07009C58 = [
...
const jrb_seg7_vertex_07009D48 = [
...
const jrb_seg7_vertex_07009E38 = [
...
const jrb_seg7_vertex_07009F38 = [
    [[   102,   -101,   2662], 0, [ -2976,    690], [0x7f, 0x00, 0x00, 0xff]],
...
const jrb_seg7_vertex_07009FC8 = [
...
const jrb_seg7_vertex_0700A048 = [
...
const jrb_seg7_vertex_0700A128 = [
...
const jrb_seg7_vertex_0700A228 = [
...
export const jrb_seg7_dl_0700A608 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
const jrb_seg7_lights_0700A6D8 = gdSPDefLights1(
    0x1e, 0x2c, 0x3a,
    0x79, 0xb2, 0xeb, 0x28, 0x28, 0x28
);

// 0x0700A6F0 - 0x0700A708
const jrb_seg7_lights_0700A6F0 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0700A708 - 0x0700A748
const jrb_seg7_vertex_0700A708 = [
...
const jrb_seg7_vertex_0700A748 = [
...
const jrb_seg7_vertex_0700A838 = [
...
const jrb_seg7_vertex_0700A938 = [
...
const jrb_seg7_vertex_0700AA18 = [
...
export const jrb_seg7_dl_0700AC68 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
