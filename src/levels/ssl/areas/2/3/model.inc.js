...
import {
    ...
    G_CC_MODULATERGBFADEA, G_LIGHTING, G_TX_WRAP, G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD,
    G_TX_RENDERTILE, G_ON, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE
} from "../../../../../include/gbi"
import { generic_09000000 } from "../../../../../textures/generic"

const ssl_seg7_vertex_0701F9D8 = [
...
const ssl_seg7_vertex_0701FAD8 = [
    [[  1024,   1485,   3113], 0, [-10762,  -3610], [0x00, 0x00, 0x00, 0xff]],
    [[   870,   1485,   2621], 0, [ -8844,   2522], [0x00, 0x00, 0x00, 0xff]],
...
const ssl_seg7_vertex_0701FBD8 = [
...
export const ssl_seg7_dl_0701FCE0 = [
    gsDPPipeSync(),
