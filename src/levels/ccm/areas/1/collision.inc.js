...
export const ccm_seg7_area_1_collision = [
    ...
    ...SPECIAL_OBJECT(special_snow_tree, -5508, -1740, 4148),
    ...SPECIAL_OBJECT(special_snow_tree, -4576, -1740, 4814),
    ...SPECIAL_OBJECT(special_snow_tree,  -488, 2560, -2305),
    ...SPECIAL_OBJECT(special_snow_tree, -5892, -1740, 811),
    ...SPECIAL_OBJECT(special_snow_tree, -3748, -4607, 4464),
    ...SPECIAL_OBJECT(special_snow_tree,  2237, 2560, -1630),
    ...SPECIAL_OBJECT(special_snow_tree,  2885, 2560, -1638),
