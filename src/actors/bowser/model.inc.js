...
import {
    ...
    gsDPSetAlphaCompare, gsSPSetGeometryMode, gsDPSetRenderMode,
    ...
    G_RM_NOOP2, G_CC_SHADEFADEA, G_RM_CUSTOM_AA_ZB_XLU_SURF
} from "../../include/gbi"
...
// 0x06038C38
const bowser_seg6_lights_06038C38 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// Unreferenced light group
const bowser_lights_unused1 = gdSPDefLights1(
    0x33, 0x31, 0x00,
    0xce, 0xc7, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const bowser_lights_unused2 = gdSPDefLights1(
    0x34, 0x34, 0x00,
    0xd2, 0xd2, 0x00, 0x28, 0x28, 0x28
);

// 0x06038C80
const bowser_seg6_vertex_06038C80 = [
...
// 0x06038D80
const bowser_seg6_vertex_06038D80 = [
...
// 0x06038E20
const bowser_seg6_vertex_06038E20 = [
...
// 0x06038F20
const bowser_seg6_vertex_06038F20 = [
...
// 0x06038FB0
const bowser_seg6_vertex_06038FB0 = [
...
// 0x060390A0
const bowser_seg6_vertex_060390A0 = [
...
export const bowser_seg6_dl_06039110 = [
...
export const bowser_seg6_dl_060391C8 = [
...
export const bowser_seg6_dl_06039260 = [
...
export const bowser_seg6_dl_060392E0 = [
    gsDPPipeSync(),
...
// 0x06039368
const bowser_seg6_vertex_06039368 = [
...
// 0x06039458
const bowser_seg6_vertex_06039458 = [
...
// 0x06039528
const bowser_seg6_vertex_06039528 = [
...
// 0x06039628
const bowser_seg6_vertex_06039628 = [
...
// 0x060396C8
const bowser_seg6_vertex_060396C8 = [
...
// 0x060397C8
const bowser_seg6_vertex_060397C8 = [
...
export const bowser_seg6_dl_06039808 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06023C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_060398B0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_06039958 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_060399D8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x06039A60
const bowser_seg6_vertex_06039A60 = [
...
// 0x06039B60
const bowser_seg6_vertex_06039B60 = [
    [[    56,     36,    -17], 0, [   812,   1498], [0x0e, 0x7e, 0xfa, 0xff]],
    [[    92,     29,    -17], 0, [   802,   2114], [0x1c, 0x7b, 0x05, 0xff]],
...
// 0x06039C50
const bowser_seg6_vertex_06039C50 = [
    [[   -16,      3,     42], 0, [  1460,    844], [0xd8, 0xb0, 0x59, 0xff]],
    [[   -45,      9,     22], 0, [  1920,    562], [0xa1, 0xb9, 0x2d, 0xff]],
    [[   -15,     -5,     22], 0, [  1418,    552], [0xdf, 0x87, 0x11, 0xff]],
    [[   -15,     -5,    -17], 0, [  1408,    -28], [0xd8, 0x89, 0xef, 0xff]],
...
// 0x06039D50
const bowser_seg6_vertex_06039D50 = [
    [[   -14,     40,      2], 0, [   512,    280], [0x00, 0x7e, 0x00, 0xff]],
...
// 0x06039E10
const bowser_seg6_vertex_06039E10 = [
...
// 0x06039EF0
const bowser_seg6_vertex_06039EF0 = [
...
// 0x06039FF0
const bowser_seg6_vertex_06039FF0 = [
...
// 0x0603A0D0
const bowser_seg6_vertex_0603A0D0 = [
...
// 0x0603A1C0
const bowser_seg6_vertex_0603A1C0 = [
...
export const bowser_seg6_dl_0603A210 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_0603A380 = [
...
export const bowser_seg6_dl_0603A4E8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x0603A568
const bowser_seg6_vertex_0603A568 = [
...
// 0x0603A648
const bowser_seg6_vertex_0603A648 = [
...
// 0x0603A748
const bowser_seg6_vertex_0603A748 = [
...
// 0x0603A848
const bowser_seg6_vertex_0603A848 = [
    [[    20,    -23,    -22], 0, [   664,    880], [0x2f, 0x8d, 0xe9, 0xff]],
    [[     0,    -17,    -30], 0, [   204,   1114], [0xb9, 0xd5, 0xa1, 0xff]],
...
// 0x0603A928
const bowser_seg6_vertex_0603A928 = [
...
// 0x0603AA18
const bowser_seg6_vertex_0603AA18 = [
...
// 0x0603AAF8
const bowser_seg6_vertex_0603AAF8 = [
...
// 0x0603ABE8
const bowser_seg6_vertex_0603ABE8 = [
...
// 0x0603ACE8
const bowser_seg6_vertex_0603ACE8 = [
...
// 0x0603ADD8
const bowser_seg6_vertex_0603ADD8 = [
...
export const bowser_seg6_dl_0603AED8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_0603B038 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06029C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_0603B208 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x0603B288
const bowser_seg6_vertex_0603B288 = [
...
// 0x0603B388
const bowser_seg6_vertex_0603B388 = [
    [[    78,    -18,    -34], 0, [  1340,     88], [0x19, 0xd6, 0x8b, 0xff]],
    [[   111,    -17,    -15], 0, [  2070,    212], [0x62, 0xc3, 0xce, 0xff]],
...
// 0x0603B478
const bowser_seg6_vertex_0603B478 = [
...
// 0x0603B578
const bowser_seg6_vertex_0603B578 = [
    [[    -7,     38,    -15], 0, [    66,     58], [0xa2, 0x42, 0xcb, 0xff]],
...
// 0x0603B678
const bowser_seg6_vertex_0603B678 = [
    [[     6,    -49,    -15], 0, [  1370,      8], [0xdc, 0x8e, 0xd7, 0xff]],
...
export const bowser_seg6_dl_0603B718 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_0603B8D0 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const bowser_seg6_dl_0603B948 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x0603B948
const bowser_seg6_vertex_0603B948 = [
...
// 0x0603BA48
const bowser_seg6_vertex_0603BA48 = [
    [[    42,     -6,     37], 0, [   872,     70], [0x2b, 0xe3, 0x73, 0xff]],
...
// 0x0603BAF8
const bowser_seg6_vertex_0603BAF8 = [
...
// 0x0603BBF8
const bowser_seg6_vertex_0603BBF8 = [
...
// 0x0603BC98
const bowser_seg6_vertex_0603BC98 = [
...
// 0x0603BD88
const bowser_seg6_vertex_0603BD88 = [
...
export const bowser_seg6_dl_0603BDF8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06023C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_0603BEA0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_0603BF48 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_0603BFC8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x0603C050
const bowser_seg6_vertex_0603C050 = [
...
// 0x0603C150
const bowser_seg6_vertex_0603C150 = [
    [[    22,     -7,    -31], 0, [   860,    134], [0xc2, 0xeb, 0x94, 0xff]],
...
// 0x0603C200
const bowser_seg6_vertex_0603C200 = [
...
// 0x0603C300
const bowser_seg6_vertex_0603C300 = [
...
// 0x0603C3A0
const bowser_seg6_vertex_0603C3A0 = [
...
// 0x0603C490
const bowser_seg6_vertex_0603C490 = [
...
export const bowser_seg6_dl_0603C500 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06023C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_0603C5A8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_0603C650 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_0603C6D0 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x0603C758
const bowser_seg6_vertex_0603C758 = [
...
// 0x0603C848
const bowser_seg6_vertex_0603C848 = [
    [[   -15,     -5,     18], 0, [  1284,    550], [0xd8, 0x89, 0x11, 0xff]],
...
// 0x0603C948
const bowser_seg6_vertex_0603C948 = [
    [[   -15,     -5,    -21], 0, [  1302,     36], [0xdf, 0x87, 0xef, 0xff]],
    [[   -45,      9,    -21], 0, [  1816,     22], [0xa1, 0xb9, 0xd3, 0xff]],
    [[   -16,      3,    -41], 0, [  1362,   -224], [0xd8, 0xb0, 0xa7, 0xff]],
...
// 0x0603CA48
const bowser_seg6_vertex_0603CA48 = [
    [[   -51,     37,     18], 0, [   890,   -982], [0x98, 0x3c, 0x28, 0xff]],
...
// 0x0603CB28
const bowser_seg6_vertex_0603CB28 = [
...
// 0x0603CC18
const bowser_seg6_vertex_0603CC18 = [
...
// 0x0603CCF8
const bowser_seg6_vertex_0603CCF8 = [
...
// 0x0603CDF8
const bowser_seg6_vertex_0603CDF8 = [
...
// 0x0603CED8
const bowser_seg6_vertex_0603CED8 = [
...
export const bowser_seg6_dl_0603CF28 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_0603D098 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06029C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_0603D200 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x0603D280
const bowser_seg6_vertex_0603D280 = [
...
// 0x0603D380
const bowser_seg6_vertex_0603D380 = [
    [[    22,    -26,    -14], 0, [   416,   -192], [0xf8, 0x94, 0xbf, 0xff]],
...
// 0x0603D470
const bowser_seg6_vertex_0603D470 = [
...
// 0x0603D570
const bowser_seg6_vertex_0603D570 = [
...
// 0x0603D650
const bowser_seg6_vertex_0603D650 = [
...
// 0x0603D680
const bowser_seg6_vertex_0603D680 = [
...
// 0x0603D770
const bowser_seg6_vertex_0603D770 = [
...
// 0x0603D870
const bowser_seg6_vertex_0603D870 = [
    [[    67,     17,     -5], 0, [   728,   1360], [0x52, 0x5a, 0xde, 0xff]],
...
// 0x0603D950
const bowser_seg6_vertex_0603D950 = [
...
// 0x0603DA50
const bowser_seg6_vertex_0603DA50 = [
    [[    54,      0,      3], 0, [  -108,   1016], [0xf9, 0x18, 0x7c, 0xff]],
...
// 0x0603DB50
const bowser_seg6_vertex_0603DB50 = [
    [[    54,     23,      8], 0, [   704,   1320], [0xf1, 0x8f, 0x37, 0xff]],
...
// 0x0603DC40
const bowser_seg6_vertex_0603DC40 = [
...
export const bowser_seg6_dl_0603DC70 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_0603DDD0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06029C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_0603DFB0 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x0603E030
const bowser_seg6_vertex_0603E030 = [
...
// 0x0603E120
const bowser_seg6_vertex_0603E120 = [
...
// 0x0603E220
const bowser_seg6_vertex_0603E220 = [
...
// 0x0603E320
const bowser_seg6_vertex_0603E320 = [
    [[    12,    -21,     35], 0, [    90,   1020], [0xe2, 0xde, 0x76, 0xff]],
...
// 0x0603E420
const bowser_seg6_vertex_0603E420 = [
...
export const bowser_seg6_dl_0603E500 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_0603E6B8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x0603E718
const bowser_seg6_vertex_0603E718 = [
...
// 0x0603E7A8
const bowser_seg6_vertex_0603E7A8 = [
...
// 0x0603E8A8
const bowser_seg6_vertex_0603E8A8 = [
...
// 0x0603E988
const bowser_seg6_vertex_0603E988 = [
...
// 0x0603EA68
const bowser_seg6_vertex_0603EA68 = [
...
// 0x0603EB48
const bowser_seg6_vertex_0603EB48 = [
...
// 0x0603EC18
const bowser_seg6_vertex_0603EC18 = [
...
// 0x0603ED18
const bowser_seg6_vertex_0603ED18 = [
...
// 0x0603EDF8
const bowser_seg6_vertex_0603EDF8 = [
...
// 0x0603EE58
const bowser_seg6_vertex_0603EE58 = [
...
// 0x0603EF58
const bowser_seg6_vertex_0603EF58 = [
...
// 0x0603F038
const bowser_seg6_vertex_0603F038 = [
...
// 0x0603F128
const bowser_seg6_vertex_0603F128 = [
...
// 0x0603F1F8
const bowser_seg6_vertex_0603F1F8 = [
...
// 0x0603F2E8
const bowser_seg6_vertex_0603F2E8 = [
...
// 0x0603F3D8
const bowser_seg6_vertex_0603F3D8 = [
...
// 0x0603F4C8
const bowser_seg6_vertex_0603F4C8 = [
...
// 0x0603F5B8
const bowser_seg6_vertex_0603F5B8 = [
...
// 0x0603F6A8
const bowser_seg6_vertex_0603F6A8 = [
...
// 0x0603F7A8
const bowser_seg6_vertex_0603F7A8 = [
...
// 0x0603F898
const bowser_seg6_vertex_0603F898 = [
...
// 0x0603F988
const bowser_seg6_vertex_0603F988 = [
...
// 0x0603FA78
const bowser_seg6_vertex_0603FA78 = [
...
// 0x0603FB68
const bowser_seg6_vertex_0603FB68 = [
...
export const bowser_seg6_dl_0603FBA8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06023C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_0603FC18 = [
...
export const bowser_seg6_dl_0603FD38 = [
...
export const bowser_seg6_dl_0603FDD0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_0603FEA8 = [
...
export const bowser_seg6_dl_0603FFA8 = [
...
export const bowser_seg6_dl_06040180 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_060401F0 = [
...
export const bowser_seg6_dl_06040210 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const bowser_seg6_dl_06040358 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x060402D8
const bowser_seg6_vertex_060402D8 = [
...
// 0x060403D8
const bowser_seg6_vertex_060403D8 = [
    [[   -40,      7,     39], 0, [  -566,    990], [0x96, 0x22, 0x3c, 0xff]],
...
// 0x060404B8
const bowser_seg6_vertex_060404B8 = [
...
// 0x060405B8
const bowser_seg6_vertex_060405B8 = [
...
// 0x060406A8
const bowser_seg6_vertex_060406A8 = [
...
// 0x060407A8
const bowser_seg6_vertex_060407A8 = [
...
// 0x060407D8
const bowser_seg6_vertex_060407D8 = [
...
// 0x060408B8
const bowser_seg6_vertex_060408B8 = [
...
// 0x060409B8
const bowser_seg6_vertex_060409B8 = [
...
// 0x06040AA8
const bowser_seg6_vertex_06040AA8 = [
    [[   154,      6,    -89], 0, [     0,   -488], [0x0b, 0x42, 0x95, 0xff]],
...
// 0x06040BA8
const bowser_seg6_vertex_06040BA8 = [
...
// 0x06040CA8
const bowser_seg6_vertex_06040CA8 = [
...
// 0x06040DA8
const bowser_seg6_vertex_06040DA8 = [
...
// 0x06040EA8
const bowser_seg6_vertex_06040EA8 = [
...
// 0x06040FA8
const bowser_seg6_vertex_06040FA8 = [
...
// 0x06040FD8
const bowser_seg6_vertex_06040FD8 = [
...
// 0x06041088
const bowser_seg6_vertex_06041088 = [
...
// 0x06041188
const bowser_seg6_vertex_06041188 = [
    [[    10,    -97,     45], 0, [   804,   1636], [0xc6, 0xac, 0x4a, 0xff]],
    [[   -51,   -159,      0], 0, [  1462,    -16], [0x87, 0xdb, 0xff, 0xff]],
...
// 0x06041218
const bowser_seg6_vertex_06041218 = [
...
// 0x06041308
const bowser_seg6_vertex_06041308 = [
...
// 0x060413E8
const bowser_seg6_vertex_060413E8 = [
...
// 0x060414D8
const bowser_seg6_vertex_060414D8 = [
...
// 0x060415D8
const bowser_seg6_vertex_060415D8 = [
...
// 0x06041698
const bowser_seg6_vertex_06041698 = [
...
// 0x06041758
const bowser_seg6_vertex_06041758 = [
...
// 0x06041808
const bowser_seg6_vertex_06041808 = [
...
// 0x06041908
const bowser_seg6_vertex_06041908 = [
...
// 0x06041968
const bowser_seg6_vertex_06041968 = [
...
export const bowser_seg6_dl_06041A28 = [
...
export const bowser_seg6_dl_06041BA0 = [
...
export const bowser_seg6_dl_06041E48 = [
...
export const bowser_seg6_dl_06041EA8 = [
...
export const bowser_seg6_dl_06041F50 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_0602AC38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_06042098 = [
...
export const bowser_seg6_dl_060420F0 = [
...
export const bowser_seg6_dl_06042140 = [
...
export const bowser_seg6_dl_060421D8 = [
...
export const bowser_seg6_dl_06042220 = [
...
export const bowser_seg6_dl_06042278 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const bowser_seg6_dl_06042328 = [
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPEndDisplayList(),
...
export const bowser_seg6_dl_06042348 = [
...
export const bowser_seg6_dl_060423A0 = [
    gsSPDisplayList(bowser_seg6_dl_06042278),
...
export const bowser_seg6_dl_060423F8 = [
    gsSPDisplayList(bowser_seg6_dl_06042278),
...
export const bowser_seg6_dl_06042450 = [
    gsSPDisplayList(bowser_seg6_dl_06042278),
...
export const bowser_seg6_dl_060424A8 = [
    gsSPDisplayList(bowser_seg6_dl_06042278),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06031C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_06042500 = [
    gsSPDisplayList(bowser_seg6_dl_06042278),
...
export const bowser_seg6_dl_06042558 = [
    gsSPDisplayList(bowser_seg6_dl_06042278),
...
export const bowser_seg6_dl_060425B0 = [
    gsSPDisplayList(bowser_seg6_dl_06042278),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06030C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_06042608 = [
    gsSPDisplayList(bowser_seg6_dl_06042278),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06031C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
// 0x06042660
const bowser_seg6_vertex_06042660 = [
...
// 0x06042760
const bowser_seg6_vertex_06042760 = [
...
// 0x06042860
const bowser_seg6_vertex_06042860 = [
...
// 0x06042950
const bowser_seg6_vertex_06042950 = [
...
// 0x06042A40
const bowser_seg6_vertex_06042A40 = [
...
// 0x06042B40
const bowser_seg6_vertex_06042B40 = [
    [[   -25,    198,    164], 0, [   646,    620], [0xf2, 0x65, 0xb5, 0xff]],
...
// 0x06042BF0
const bowser_seg6_vertex_06042BF0 = [
...
// 0x06042CE0
const bowser_seg6_vertex_06042CE0 = [
...
// 0x06042DD0
const bowser_seg6_vertex_06042DD0 = [
...
// 0x06042E30
const bowser_seg6_vertex_06042E30 = [
...
export const bowser_seg6_dl_06042EE0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06020C38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_060430E8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_0602AC38),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_06043180 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06024438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_060431F0 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x06043278
const bowser_seg6_vertex_06043278 = [
...
// 0x06043378
const bowser_seg6_vertex_06043378 = [
...
// 0x06043468
const bowser_seg6_vertex_06043468 = [
    [[   127,      3,    -34], 0, [  2312,   1266], [0x24, 0x25, 0x8d, 0xff]],
...
// 0x060434D8
const bowser_seg6_vertex_060434D8 = [
...
export const bowser_seg6_dl_06043548 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06022438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(bowser_seg6_lights_06038C38.l, 1),
...
export const bowser_seg6_dl_06043648 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bowser_seg6_texture_06025438),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bowser_seg6_dl_06043698 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
