...
import {
    gdSPDefLights1, gsDPSetTextureImage, gsDPLoadSync, gsDPLoadBlock, gsSPVertex, gsSP2Triangles,
    ...
    gsSP1Triangle, gsSPLight,
    G_IM_FMT_RGBA, G_IM_SIZ_16b, CALC_DXT, G_TX_LOADTILE, G_IM_SIZ_16b_BYTES, G_CC_DECALRGB,
    G_LIGHTING, G_TX_WRAP, G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_RENDERTILE, G_ON,
    G_TX_CLAMP, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE, G_CC_MODULATERGB, G_CULL_BACK
} from "../../include/gbi"

// 0x05001758
const manta_seg5_lights_05001758 = gdSPDefLights1(
    0x31, 0x3b, 0x3b,
    0xc6, 0xee, 0xed, 0x28, 0x28, 0x28
);

// 0x05001770
const manta_seg5_lights_05001770 = gdSPDefLights1(
    0x00, 0x16, 0x18,
    0x03, 0x5b, 0x63, 0x28, 0x28, 0x28
);

// Unreferenced light group
const manta_lights_unused = gdSPDefLights1(
    0x3f, 0x3f, 0x35,
...
// 0x050047A0
const manta_seg5_vertex_050047A0 = [
...
// 0x050048A0
const manta_seg5_vertex_050048A0 = [
...
export const manta_seg5_dl_05004960 = [
...
export const manta_seg5_dl_050049C8 = [
...
export const manta_seg5_dl_05004A70 = [
    gsDPPipeSync(),
...
// 0x05004AE8
const manta_seg5_vertex_05004AE8 = [
...
// 0x05004BE8
const manta_seg5_vertex_05004BE8 = [
...
export const manta_seg5_dl_05004CA8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_05002FA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05004D10 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050017A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05004DB8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGB, G_CC_DECALRGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x05004E30
const manta_seg5_vertex_05004E30 = [
...
export const manta_seg5_dl_05004E60 = [
...
export const manta_seg5_dl_05004E90 = [
    gsDPPipeSync(),
...
// 0x05004F00
const manta_seg5_vertex_05004F00 = [
...
export const manta_seg5_dl_05004FA0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050017A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05005038 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x050050A8
const manta_seg5_vertex_050050A8 = [
...
// 0x05005118
const manta_seg5_vertex_05005118 = [
...
// 0x050051B8
const manta_seg5_vertex_050051B8 = [
...
export const manta_seg5_dl_05005248 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050017A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05005288 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050037A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05005308 = [
...
export const manta_seg5_dl_05005358 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x050053F0
const manta_seg5_vertex_050053F0 = [
...
// 0x05005470
const manta_seg5_vertex_05005470 = [
...
export const manta_seg5_dl_050054F0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050037A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05005558 = [
...
export const manta_seg5_dl_050055A8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGB, G_CC_DECALRGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x05005620
const manta_seg5_vertex_05005620 = [
...
// 0x05005680
const manta_seg5_vertex_05005680 = [
...
export const manta_seg5_dl_050056E0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050037A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05005730 = [
...
export const manta_seg5_dl_05005768 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x050057E0
const manta_seg5_vertex_050057E0 = [
...
export const manta_seg5_dl_05005880 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050017A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05005918 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x05005988
const manta_seg5_vertex_05005988 = [
...
// 0x050059F8
const manta_seg5_vertex_050059F8 = [
...
// 0x05005A98
const manta_seg5_vertex_05005A98 = [
...
export const manta_seg5_dl_05005B28 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050017A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05005B68 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050037A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05005BE8 = [
...
export const manta_seg5_dl_05005C38 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x05005CD0
const manta_seg5_vertex_05005CD0 = [
...
// 0x05005D50
const manta_seg5_vertex_05005D50 = [
...
export const manta_seg5_dl_05005DD0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050037A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05005E38 = [
...
export const manta_seg5_dl_05005E88 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x05005F00
const manta_seg5_vertex_05005F00 = [
...
// 0x05005F60
const manta_seg5_vertex_05005F60 = [
...
export const manta_seg5_dl_05005FC0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050037A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05006010 = [
...
export const manta_seg5_dl_05006048 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x050060C0
const manta_seg5_vertex_050060C0 = [
...
// 0x050061A0
const manta_seg5_vertex_050061A0 = [
...
// 0x05006290
const manta_seg5_vertex_05006290 = [
...
// 0x05006370
const manta_seg5_vertex_05006370 = [
...
// 0x05006420
const manta_seg5_vertex_05006420 = [
...
export const manta_seg5_dl_05006510 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050017A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_05006588 = [
...
export const manta_seg5_dl_050065F0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, manta_seg5_texture_050037A0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
...
export const manta_seg5_dl_050066D0 = [
...
export const manta_seg5_dl_05006750 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGB, G_CC_DECALRGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x05006808
const manta_seg5_vertex_05006808 = [
...
// 0x05006868
const manta_seg5_vertex_05006868 = [
    [[    -4,      0,      2], 0, [     0,      0], [0xa9, 0x00, 0x5b, 0x00]],
    [[     0,      5,     -3], 0, [     0,      0], [0xf3, 0x68, 0x46, 0x00]],
    [[     0,     -5,     -3], 0, [     0,      0], [0xf3, 0x98, 0x46, 0x00]],
...
// 0x050068C8
const manta_seg5_vertex_050068C8 = [
...
// 0x05006948
const manta_seg5_vertex_05006948 = [
    [[    -7,      0,      0], 0, [     0,      0], [0x84, 0x00, 0x18, 0x00]],
    [[     0,      8,     -5], 0, [     0,      0], [0xf1, 0x6c, 0x3f, 0x00]],
    [[     0,     -8,     -5], 0, [     0,      0], [0xf1, 0x94, 0x3f, 0x00]],
    [[   236,      5,     -3], 0, [     0,      0], [0x13, 0x72, 0xcd, 0x00]],
...
// 0x050069C8
const manta_seg5_vertex_050069C8 = [
...
// 0x05006A88
const manta_seg5_vertex_05006A88 = [
    [[    -8,      0,      0], 0, [     0,      0], [0x83, 0x00, 0x13, 0x00]],
    [[     0,     11,     -7], 0, [     0,      0], [0x95, 0x41, 0xee, 0x00]],
    [[     0,    -11,     -7], 0, [     0,      0], [0x95, 0xbf, 0xee, 0x00]],
    [[   168,      8,     -5], 0, [     0,      0], [0x13, 0x71, 0xcc, 0x00]],
...
export const manta_seg5_dl_05006B08 = [
...
export const manta_seg5_dl_05006B70 = [
    gsSPLight(manta_seg5_lights_05001770.l, 1),
    gsSPLight(manta_seg5_lights_05001770.a, 2),
...
export const manta_seg5_dl_05006C08 = [
    gsSPLight(manta_seg5_lights_05001770.l, 1),
    gsSPLight(manta_seg5_lights_05001770.a, 2),
...
// 2022-07-04 22:31:59 -0400 (Convert.rb 2022-07-03 12:20:08 -0400)
