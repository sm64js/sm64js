...
import { MODEL_BOB_BUBBLY_TREE, MODEL_LEVEL_GEOMETRY_03, MODEL_CASTLE_GROUNDS_FLAG, MODEL_CASTLE_GROUNDS_CASTLE_DOOR, MODEL_CASTLE_GROUNDS_METAL_DOOR } from "../../include/model_ids"
...
export const level_castle_grounds_entry = [
    ...
    { command: LevelCommands.load_model_from_geo, args: [MODEL_CASTLE_GROUNDS_CASTLE_DOOR, castle_door_geo] },
    { command: LevelCommands.load_model_from_geo, args: [MODEL_CASTLE_GROUNDS_METAL_DOOR, metal_door_geo] },
