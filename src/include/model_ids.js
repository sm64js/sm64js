...
export const MODEL_UNKNOWN_DOOR_1E                 = 0x1E        // referenced in special presets, undefinedexport const MODEL_CCM_CABIN_DOOR                  = 0x27        // cabin_door_geo
...
export const MODEL_CASTLE_GROUNDS_CASTLE_DOOR      = 0x26        // castle_door_geo
export const MODEL_CASTLE_GROUNDS_METAL_DOOR       = 0x29        // metal_door_geo - used duplicate
