...
import {
    ...
    gsSPTexture, gsDPTileSync, gsDPSetTileSize, gsSPDisplayList, gsSP1Triangle,
    gsSPClearGeometryMode, gsSPSetGeometryMode, gsSPBranchList,
    ...
    G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE, G_TX_CLAMP, G_CC_MODULATERGBA, G_SHADING_SMOOTH
} from "../../include/gbi"
...
// 0x06003A00
const lakitu_seg6_lights_06003A00 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x06003A18
const lakitu_seg6_lights_06003A18 = gdSPDefLights1(
    0x79, 0x55, 0x00,
    0xf2, 0xab, 0x00, 0x28, 0x28, 0x28
);

// 0x06003A30
const lakitu_seg6_vertex_06003A30 = [
...
// 0x06003B30
const lakitu_seg6_vertex_06003B30 = [
    [[    -2,     15,     99], 0, [   684,    990], [0xc1, 0x34, 0x60, 0xff]],
...
// 0x06003BD0
const lakitu_seg6_vertex_06003BD0 = [
...
export const lakitu_seg6_dl_06003C80 = [
...
export const lakitu_seg6_dl_06003DB0 = [
...
export const lakitu_seg6_dl_06003E30 = [
    gsDPPipeSync(),
...
// 0x06003E98
const lakitu_seg6_lights_06003E98 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x06003EB0
const lakitu_seg6_vertex_06003EB0 = [
...
// 0x06003FB0
const lakitu_seg6_vertex_06003FB0 = [
    [[     1,    -57,    -75], 0, [ -1062,    410], [0xd6, 0xe6, 0x8c, 0xff]],
...
// 0x060040A0
const lakitu_seg6_vertex_060040A0 = [
...
// 0x060041A0
const lakitu_seg6_vertex_060041A0 = [
    [[     2,     -6,    -82], 0, [ -1072,    916], [0xcf, 0x36, 0x99, 0xff]],
    [[   104,     34,    -89], 0, [ -2094,   1332], [0x1d, 0x53, 0xa5, 0xff]],
    [[   103,    -17,   -100], 0, [ -2084,    810], [0x33, 0xd1, 0x97, 0xff]],
    [[    98,    -35,    -80], 0, [ -2034,    626], [0x43, 0xd5, 0x9e, 0xff]],
...
// 0x06004290
const lakitu_seg6_vertex_06004290 = [
    [[   103,    -17,    101], 0, [ -2084,    810], [0x33, 0xd1, 0x69, 0xff]],
    [[   104,     34,     90], 0, [ -2094,   1332], [0x12, 0x57, 0x5a, 0xff]],
    [[     2,     -6,     83], 0, [ -1072,    916], [0xcb, 0x25, 0x6c, 0xff]],
    [[   138,    -47,     11], 0, [ -2428,    508], [0x6f, 0xce, 0x20, 0xff]],
...
// 0x06004390
const lakitu_seg6_vertex_06004390 = [
    [[   101,   -142,    -34], 0, [ -2058,   -434], [0x34, 0x92, 0xde, 0xff]],
    [[     0,   -140,     32], 0, [ -1046,   -414], [0xc5, 0x94, 0x1d, 0xff]],
    [[     0,   -140,    -31], 0, [ -1046,   -414], [0xd1, 0x9a, 0xc6, 0xff]],
    [[   101,   -142,     35], 0, [ -2058,   -434], [0x26, 0x99, 0x3d, 0xff]],
...
export const lakitu_seg6_dl_06004410 = [
...
export const lakitu_seg6_dl_06004680 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x060046E0
const lakitu_seg6_lights_060046E0 = gdSPDefLights1(
    0x79, 0x55, 0x00,
    0xf2, 0xab, 0x00, 0x28, 0x28, 0x28
);

// 0x060046F8
const lakitu_seg6_vertex_060046F8 = [
...
export const lakitu_seg6_dl_060047E8 = [
...
// 0x060048D8
const lakitu_seg6_lights_060048D8 = gdSPDefLights1(
    0x79, 0x55, 0x00,
    0xf2, 0xab, 0x00, 0x28, 0x28, 0x28
);

// 0x060048F0
const lakitu_seg6_vertex_060048F0 = [
...
export const lakitu_seg6_dl_060049E0 = [
...
// 0x06004AD0
const lakitu_seg6_lights_06004AD0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x06004AE8
const lakitu_seg6_vertex_06004AE8 = [
...
export const lakitu_seg6_dl_06004BA8 = [
...
export const lakitu_seg6_dl_06004BE8 = [
    gsDPPipeSync(),
...
export const lakitu_seg6_dl_06004C30 = [
...
export const lakitu_seg6_dl_06004C60 = [
...
export const lakitu_seg6_dl_06004C88 = [
    gsSPDisplayList(lakitu_seg6_dl_06004BE8),
...
// 0x06004CB0
const lakitu_seg6_lights_06004CB0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x06004CC8
const lakitu_seg6_lights_06004CC8 = gdSPDefLights1(
    0x0c, 0x0c, 0x0c,
    0x19, 0x19, 0x19, 0x28, 0x28, 0x28
);

// 0x06004CE0
const lakitu_seg6_lights_06004CE0 = gdSPDefLights1(
    0x19, 0x22, 0x20,
    0x32, 0x44, 0x40, 0x28, 0x28, 0x28
);

// 0x06004CF8
const lakitu_seg6_lights_06004CF8 = gdSPDefLights1(
    0x18, 0x18, 0x18,
    0x30, 0x30, 0x30, 0x28, 0x28, 0x28
);

// 0x06004D10
const lakitu_seg6_vertex_06004D10 = [
...
// 0x06004D50
const lakitu_seg6_vertex_06004D50 = [
...
// 0x06004E40
const lakitu_seg6_vertex_06004E40 = [
...
// 0x06004F30
const lakitu_seg6_vertex_06004F30 = [
...
// 0x06004F90
const lakitu_seg6_vertex_06004F90 = [
...
// 0x06005070
const lakitu_seg6_vertex_06005070 = [
...
// 0x06005150
const lakitu_seg6_vertex_06005150 = [
    [[     7,   -113,    -34], 0, [     0,      0], [0x00, 0x81, 0x00, 0xff]],
...
export const lakitu_seg6_dl_060051D0 = [
...
export const lakitu_seg6_dl_06005218 = [
...
export const lakitu_seg6_dl_06005360 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_SHADING_SMOOTH),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
const lakitu_cameraman_lights_unused1 = gdSPDefLights1(
    0x33, 0x1f, 0x0c,
    0xcc, 0x7f, 0x33, 0x28, 0x28, 0x28
);

// 0x060053F0
const lakitu_seg6_lights_060053F0 = gdSPDefLights1(
    0x29, 0x13, 0x06,
    0xa5, 0x4f, 0x1b, 0x28, 0x28, 0x28
);

// Unreferenced light group
const lakitu_cameraman_lights_unused2 = gdSPDefLights1(
    0x06, 0x06, 0x06,
    0x19, 0x19, 0x19, 0x28, 0x28, 0x28
);

// Unreferenced light group
const lakitu_cameraman_lights_unused3 = gdSPDefLights1(
    0x2c, 0x2c, 0x2c,
    0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28
);

// 0x06005438
const lakitu_seg6_lights_06005438 = gdSPDefLights1(
    0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const lakitu_cameraman_lights_unused4 = gdSPDefLights1(
    0x0d, 0x2c, 0x0b,
    0x34, 0xb2, 0x2c, 0x28, 0x28, 0x28
);

// 0x06005468
const lakitu_seg6_vertex_06005468 = [
...
// 0x06005538
const lakitu_seg6_vertex_06005538 = [
...
// 0x06005568
const lakitu_seg6_vertex_06005568 = [
...
export const lakitu_seg6_dl_06005598 = [
...
export const lakitu_seg6_dl_060055E8 = [
...
export const lakitu_seg6_dl_06005610 = [
    gsSPLight(lakitu_seg6_lights_06005438.l, 1),
    gsSPLight(lakitu_seg6_lights_06005438.a, 2),
