...
import {
    ...
    WARP_NODE, TERRAIN, MACRO_OBJECTS, SET_BACKGROUND_MUSIC, TERRAIN_TYPE, END_AREA, INSTANT_WARP,
    MARIO_POS, CALL, CALL_LOOP, CLEAR_LEVEL, SLEEP_BEFORE_EXIT, EXIT
} from "../../engine/LevelCommands"

import {
    MODEL_SSL_PYRAMID_TOP, MODEL_SSL_TOX_BOX, MODEL_TWEESTER, MODEL_KLEPTO, MODEL_STAR,
    MODEL_NONE, MODEL_SSL_GRINDEL, MODEL_SSL_SPINDEL, MODEL_SSL_MOVING_PYRAMID_WALL,
    MODEL_SSL_PYRAMID_ELEVATOR, MODEL_MARIO, MODEL_SSL_PALM_TREE, MODEL_LEVEL_GEOMETRY_03,
    MODEL_LEVEL_GEOMETRY_04
} from "../../include/model_ids"

import {
    script_func_global_1/*, script_func_global_6*/
} from "../global_scripts"

import { ssl_geo_0005C0 } from "./areas/1/5/geo.inc"

import { ssl_geo_0005D8 } from "./areas/2/4/geo.inc"

import { ssl_geo_000618 } from "./pyramid_top/geo.inc"

import { ssl_geo_000734 } from "./grindel/geo.inc"

import { ssl_geo_000794 } from "./moving_pyramid_wall/geo.inc"

import { ssl_geo_0007AC } from "./pyramid_elevator/geo.inc"
...
import { ssl_seg7_area_1_macro_objs } from "./areas/1/macro.inc"

import {
    SEQ_LEVEL_HOT, SEQ_LEVEL_UNDERGROUND
} from "../../include/seq_ids"

import {
    TERRAIN_SAND, TERRAIN_STONE
} from "../../include/surface_terrains"

import { ssl_geo_0007CC } from "./areas/2/geo.inc"

import { ssl_seg7_area_2_collision } from "./areas/2/collision.inc"

import { ssl_seg7_area_2_macro_objs } from "./areas/2/macro.inc"

import { ssl_geo_00088C } from "./areas/3/geo.inc"

import { ssl_seg7_area_3_collision } from "./areas/3/collision.inc"

import { ssl_seg7_area_3_macro_objs } from "./areas/3/macro.inc"

import { ssl_geo_000630 } from "./tox_box/geo.inc"
...
const script_func_local_4 = [
    ...
    //OBJECT(/*model*/ MODEL_SSL_MOVING_PYRAMID_WALL,  /*pos*/  1345,  2567,  -2307,  /*angle*/ 0,    0,  0,  /*behParam*/ 0x00020000,  /*beh*/ 'bhvSslMovingPyramidWall'), Commenting out due to lack of collision so the player does not get trolled and fall when trying to climb it
