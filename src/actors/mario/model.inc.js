...
import {
    gdSPDefLights1, gsSPVertex, gsSP2Triangles, gsSP1Triangle, gsSPEndDisplayList, gsDPPipeSync,
    gsDPSetCombineMode, gsSPLight, gsSPDisplayList, gsSPSetGeometryMode, gsDPLoadTextureBlock,
    gsSPTexture, gsSPClearGeometryMode, gsDPSetEnvColor, gsDPSetAlphaCompare, gsDPSetTile,
    gsDPTileSync, gsDPSetTileSize, gsDPSetTextureImage, gsDPLoadSync, gsDPLoadBlock,
    G_CC_SHADEFADEA, G_TEXTURE_GEN, G_CC_DECALFADE, G_IM_FMT_RGBA, G_IM_SIZ_16b, G_TX_WRAP,
    G_TX_NOMIRROR, G_TX_NOLOD, G_TX_RENDERTILE, G_ON, G_CC_SHADE, G_OFF, G_AC_NONE,
    G_CC_BLENDRGBFADEA, G_TX_LOADTILE, G_TX_NOMASK, G_TX_CLAMP, G_TEXTURE_IMAGE_FRAC, CALC_DXT,
    G_IM_SIZ_16b_BYTES, G_CC_MODULATERGBFADEA, G_CULL_BACK, G_SHADING_SMOOTH, G_CC_MODULATERGBA,
    G_CC_BLENDRGBA, G_CC_MODULATERGB, G_CC_DECALRGBA, G_CC_DECALFADEA
} from "../../include/gbi"

// 0x04000000 # solid color blue - butt, left thigh, right thigh - all poly types
const mario_blue_lights_group = gdSPDefLights1(
    0x00, 0x00, 0x7f,
    0x00, 0x00, 0xff, 0x28, 0x28, 0x28
);

// 0x04000018 # solid color red - left & right arm, torso (tshirt part), caps - all poly types
const mario_red_lights_group = gdSPDefLights1(
    0x7f, 0x00, 0x00,
...
const mario_white_lights_group = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
...
export const mario_metal_right_foot = [
    gsSPDisplayList(mario_right_foot_dl),
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_TEXTURE_GEN),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
...
export const mario_metal_torso_shared_dl = [
    gsSPDisplayList(mario_yellow_button_dl),
    gsSPDisplayList(mario_pants_overalls_shared_dl),
    gsSPDisplayList(mario_tshirt_shared_dl),
    gsSPEndDisplayList(),
...
export const mario_face_cap_on_dl = [
...
export const mario_cap_on_eyes_right = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_on_eyes_left = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_on_eyes_up = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_on_eyes_down = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_on_eyes_dead = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
const mario_lights_unused1 = gdSPDefLights1(
    0x3f, 0x30, 0x1e,
    0xfe, 0xc1, 0x79, 0x28, 0x28, 0x28
);

// Unreferenced light group
const mario_lights_unused2 = gdSPDefLights1(
    0x1c, 0x01, 0x00,
    0x73, 0x06, 0x00, 0x28, 0x28, 0x28
);
...
export const mario_face_cap_off_dl = [
...
export const mario_cap_off_eyes_front = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_off_eyes_half_closed = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_off_eyes_closed = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_off_eyes_right = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_off_eyes_left = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_off_eyes_up = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_off_eyes_down = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_off_eyes_dead = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_medium_poly_butt = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPLight(mario_blue_lights_group.l, 1),
    gsSPLight(mario_blue_lights_group.a, 2),
...
export const mario_metal_medium_poly_butt = [
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_TEXTURE_GEN),
    gsDPSetCombineMode(G_CC_DECALFADE, G_CC_DECALFADE),
    gsDPLoadTextureBlock(mario_texture_metal, G_IM_FMT_RGBA, G_IM_SIZ_16b, 64, 32, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_WRAP | G_TX_NOMIRROR, 6, 5, G_TX_NOLOD, G_TX_NOLOD),
...
export const mario_medium_poly_left_arm = [
    gsSPLight(mario_red_lights_group.l, 1),
    gsSPLight(mario_red_lights_group.a, 2),
...
export const mario_medium_poly_left_hand_closed = [
    gsSPLight(mario_white_lights_group.l, 1),
    gsSPLight(mario_white_lights_group.a, 2),
...
export const mario_medium_poly_right_arm = [
    gsSPLight(mario_red_lights_group.l, 1),
    gsSPLight(mario_red_lights_group.a, 2),
...
export const mario_medium_poly_right_hand_closed = [
    gsSPLight(mario_white_lights_group.l, 1),
    gsSPLight(mario_white_lights_group.a, 2),
...
export const mario_medium_poly_left_thigh = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPLight(mario_blue_lights_group.l, 1),
    gsSPLight(mario_blue_lights_group.a, 2),
...
export const mario_medium_poly_left_foot = [
    gsSPLight(mario_brown1_lights_group.l, 1),
    gsSPLight(mario_brown1_lights_group.a, 2),
...
export const mario_medium_poly_right_thigh = [
    gsSPLight(mario_blue_lights_group.l, 1),
    gsSPLight(mario_blue_lights_group.a, 2),
...
export const mario_medium_poly_right_foot = [
    gsSPLight(mario_brown1_lights_group.l, 1),
    gsSPLight(mario_brown1_lights_group.a, 2),
...
export const mario_medium_poly_torso_dl = [
...
export const mario_low_poly_butt = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPLight(mario_blue_lights_group.l, 1),
    gsSPLight(mario_blue_lights_group.a, 2),
...
export const mario_low_poly_left_arm = [
    gsSPLight(mario_red_lights_group.l, 1),
    gsSPLight(mario_red_lights_group.a, 2),
...
export const mario_low_poly_left_hand_closed = [
    gsSPLight(mario_white_lights_group.l, 1),
    gsSPLight(mario_white_lights_group.a, 2),
...
export const mario_low_poly_right_arm = [
    gsSPLight(mario_red_lights_group.l, 1),
    gsSPLight(mario_red_lights_group.a, 2),
...
export const mario_low_poly_right_hand_closed = [
    gsSPLight(mario_white_lights_group.l, 1),
    gsSPLight(mario_white_lights_group.a, 2),
...
export const mario_low_poly_left_thigh = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPLight(mario_blue_lights_group.l, 1),
    gsSPLight(mario_blue_lights_group.a, 2),
...
export const mario_low_poly_left_foot = [
    gsSPLight(mario_brown1_lights_group.l, 1),
    gsSPLight(mario_brown1_lights_group.a, 2),
...
export const mario_low_poly_right_thigh = [
    gsSPLight(mario_blue_lights_group.l, 1),
    gsSPLight(mario_blue_lights_group.a, 2),
...
export const mario_low_poly_right_foot = [
    gsSPLight(mario_brown1_lights_group.l, 1),
    gsSPLight(mario_brown1_lights_group.a, 2),
...
export const mario_low_poly_torso_dl = [
...
export const mario_low_poly_face_cap_on_dl = [
...
export const mario_low_poly_cap_on_eyes_front = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_low_poly_cap_on_eyes_half_closed = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_low_poly_cap_on_eyes_closed = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_low_poly_face_cap_off_dl = [
...
export const mario_low_poly_cap_off_eyes_front = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_low_poly_cap_off_eyes_half_closed = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_low_poly_cap_off_eyes_closed = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_left_hand_open = [
    gsSPLight(mario_white_lights_group.l, 1),
    gsSPLight(mario_white_lights_group.a, 2),
...
export const mario_right_hand_open = [
    gsSPLight(mario_white_lights_group.l, 1),
    gsSPLight(mario_white_lights_group.a, 2),
...
export const mario_right_hand_cap_dl = [
...
export const mario_right_hand_cap_wings_initial_dl = [
    gsDPPipeSync(),
...
export const mario_right_hand_peace = [
    gsSPLight(mario_white_lights_group.l, 1),
    gsSPLight(mario_white_lights_group.a, 2),
...
export const mario_cap_wings_unused_initial_dl = [
    gsDPPipeSync(),
...
export const mario_cap_wings_unused_end_dl = [
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPSetGeometryMode(G_CULL_BACK | G_SHADING_SMOOTH),
...
export const mario_cap_unused_dl = [
    gsDPPipeSync(),
...
export const mario_metal_cap_unused_dl = [
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_TEXTURE_GEN),
...
export const mario_cap_wings_unused = [
...
export const mario_metal_cap_wings_unused = [
    gsSPDisplayList(mario_cap_wings_unused_initial_dl),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, mario_texture_metal_wings_half_1),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
