...
// 0x0301CF08
const mario_cap_seg3_lights_0301CF08 = gdSPDefLights1(
    0x39, 0x03, 0x00,
    0x73, 0x06, 0x00, 0x28, 0x28, 0x28
);

// 0x0301CF20
const mario_cap_seg3_lights_0301CF20 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0301CF38
const mario_cap_seg3_lights_0301CF38 = gdSPDefLights1(
    0x7f, 0x00, 0x00,
    0xff, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x0301CF50
export const mario_cap_seg3_texture_0301CF50 = []
// actors/mario_cap/mario_cap_metal.rgba16.png

// 0x0301DF50
export const mario_cap_seg3_texture_0301DF50 = []
// actors/mario_cap/mario_cap_logo.rgba16.png

// 0x0301E750
export const mario_cap_seg3_texture_0301E750 = []
// actors/mario_cap/mario_cap_wing.rgba16.png

// 0x0301F750
export const mario_cap_seg3_texture_0301F750 = []
// actors/mario_cap/mario_cap_wing_tip.rgba16.png

// 0x03020750
export const mario_cap_seg3_texture_03020750 = []
// actors/mario_cap/mario_cap_metal_wing_unused.rgba16.png

// 0x03021750
export const mario_cap_seg3_texture_03021750 = []
// actors/mario_cap/mario_cap_metal_wing_tip_unused.rgba16.png

// 0x03022750
const mario_cap_seg3_vertex_03022750 = [
...
// 0x030227C0
const mario_cap_seg3_vertex_030227C0 = [
...
// 0x030228C0
const mario_cap_seg3_vertex_030228C0 = [
...
// 0x030229B0
const mario_cap_seg3_vertex_030229B0 = [
    [[   -76,     84,    -60], 0, [     0,      0], [0xd5, 0x6e, 0xd3, 0xff]],
    [[   -41,    144,     64], 0, [     0,      0], [0xdc, 0x79, 0x00, 0xff]],
    [[    76,     84,    -60], 0, [     0,      0], [0x2a, 0x6c, 0xcf, 0xff]],
...
// 0x03022AA0
const mario_cap_seg3_vertex_03022AA0 = [
    [[    86,      1,    -60], 0, [     0,      0], [0x20, 0x86, 0xfe, 0xff]],
    [[   -86,      1,    -60], 0, [     0,      0], [0xce, 0x8c, 0xf6, 0xff]],
    [[   -52,      0,   -118], 0, [     0,      0], [0xd2, 0x9d, 0xc1, 0xff]],
    [[    33,     17,    109], 0, [     0,      0], [0xfb, 0x84, 0xea, 0xff]],
...
export const mario_cap_seg3_dl_03022B30 = [
...
export const mario_cap_seg3_dl_03022B68 = [
...
export const mario_cap_seg3_dl_03022CC8 = [
...
export const mario_cap_seg3_dl_03022D10 = [
...
// 0x03022D38
const mario_cap_seg3_vertex_03022D38 = [
...
// 0x03022DF8
const mario_cap_seg3_vertex_03022DF8 = [
...
export const mario_cap_seg3_dl_03022E78 = [
...
export const mario_cap_seg3_dl_03022EA8 = [
...
export const mario_cap_seg3_dl_03022ED8 = [
    gsDPPipeSync(),
...
export const mario_cap_seg3_dl_03022F20 = [
...
export const mario_cap_seg3_dl_03022F48 = [
    gsDPPipeSync(),
...
export const mario_cap_seg3_dl_03022FF8 = [
    gsDPPipeSync(),
...
export const mario_cap_seg3_dl_030230B0 = [
...
export const mario_cap_seg3_dl_03023108 = [
    gsSPDisplayList(mario_cap_seg3_dl_03022ED8),
...
export const mario_cap_seg3_dl_03023160 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_BLENDRGBFADEA, G_CC_BLENDRGBFADEA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
export const mario_cap_seg3_dl_03023298 = [
    gsDPPipeSync(),
    gsSPSetGeometryMode(G_TEXTURE_GEN),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
