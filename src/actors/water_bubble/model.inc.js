...
import {
    ...
    gsDPPipeSync, gsSPSetGeometryMode, gsDPSetCombineMode, gsDPSetEnvColor, gsDPLoadTextureBlock,
    gsSPTexture, gsSPDisplayList, gsSPClearGeometryMode,
    G_TEXTURE_GEN, G_CC_MODULATERGBFADE, G_IM_FMT_RGBA, G_IM_SIZ_16b, G_TX_WRAP, G_TX_NOMIRROR,
    G_TX_NOLOD, G_TX_RENDERTILE, G_ON, G_OFF, G_CC_SHADE
} from "../../include/gbi"

// 0x0500FE68
const water_bubble_seg5_lights_0500FE68 = gdSPDefLights1(
    0xbf, 0xbf, 0xbf,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0500FE80
export const water_bubble_seg5_texture_0500FE80 = []
// actors/water_bubble/water_bubble.rgba16.png

// 0x05010680
const water_bubble_seg5_vertex_05010680 = [
...
// 0x05010780
const water_bubble_seg5_vertex_05010780 = [
...
// 0x05010870
const water_bubble_seg5_vertex_05010870 = [
...
// 0x05010950
const water_bubble_seg5_vertex_05010950 = [
...
// 0x05010A50
const water_bubble_seg5_vertex_05010A50 = [
    [[     0,    -76,      0], 0, [     0,      0], [0x00, 0x82, 0x00, 0xff]],
    [[   -20,    -64,    -33], 0, [     0,      0], [0xdd, 0x95, 0xc7, 0xff]],
    [[    21,    -64,    -33], 0, [     0,      0], [0x21, 0x98, 0xc0, 0xff]],
...
// 0x05010B50
const water_bubble_seg5_vertex_05010B50 = [
    [[   -55,     40,     34], 0, [     0,      0], [0xa4, 0x43, 0x37, 0xff]],
    [[   -44,     62,      0], 0, [     0,      0], [0xb6, 0x66, 0x00, 0xff]],
    [[   -72,     24,      0], 0, [     0,      0], [0x88, 0x27, 0x00, 0xff]],
    [[   -55,     40,    -33], 0, [     0,      0], [0xa8, 0x40, 0xc0, 0xff]],
...
// 0x05010C50
const water_bubble_seg5_vertex_05010C50 = [
...
export const water_bubble_seg5_dl_05010D30 = [
...
export const water_bubble_seg5_dl_05011000 = [
    gsDPPipeSync(),
