...
import { LEVEL_CASTLE_GROUNDS, LEVEL_BOB, LEVEL_CCM, LEVEL_PSS, LEVEL_DDD, LEVEL_TTM } from "../level_defines_constants"
...
const level_intro_entry_2 = () => {
    return [
        ...
        { command: LevelCommands.set_register, args: [getSelectedLevel] }, // getSelectedLevel
