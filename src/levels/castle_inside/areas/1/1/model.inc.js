...
import {
    gsDPPipeSync, gsDPSetCycleType, gsDPSetCombineMode, gsDPSetRenderMode, gsDPSetTextureLOD,
    gsSPClearGeometryMode, gsDPTileSync, gsDPSetTile, gsDPSetTileSize, gsSPTexture, gsSPVertex,
    gsDPSetTextureImage, gsDPLoadSync, gsDPLoadBlock, gsSP2Triangles, gsSPSetGeometryMode,
    gsSPEndDisplayList,
    G_CYC_2CYCLE, G_CC_TRILERP, G_CC_DECALRGB2, G_RM_PASS, G_RM_AA_ZB_OPA_SURF2, G_TL_LOD,
    G_LIGHTING, G_SHADING_SMOOTH, G_IM_FMT_RGBA, G_IM_SIZ_16b, G_TX_RENDERTILE, G_TX_CLAMP,
    G_TX_NOLOD, G_TEXTURE_IMAGE_FRAC, G_ON, G_TX_LOADTILE, G_TX_WRAP, G_TX_NOMIRROR, G_TX_NOMASK,
    CALC_DXT, G_IM_SIZ_16b_BYTES, G_OFF, G_CYC_1CYCLE, G_CC_SHADE, G_RM_AA_ZB_OPA_SURF,
    G_RM_NOOP2, G_TL_TILE
} from "../../../../../include/gbi"
import {
