...
import {
    sky_09001000, sky_09007000, sky_09001800
} from "../../../../../textures/sky"

import { bitfs_seg7_texture_07001800 } from "../../../texture.inc"

const bitfs_seg7_vertex_0700AC00 = [
...
const bitfs_seg7_vertex_0700AD00 = [
    [[ -1023,   -716,   -357], 0, [     0,    990], [0x7d, 0x83, 0x7b, 0xff]],
...
const bitfs_seg7_vertex_0700AE00 = [
    [[  1434,   -101,   -306], 0, [  8144,  -1054], [0x7d, 0x83, 0x7b, 0xff]],
...
const bitfs_seg7_vertex_0700AEE0 = [
...
const bitfs_seg7_vertex_0700AFD0 = [
...
const bitfs_seg7_vertex_0700B0C0 = [
...
const bitfs_seg7_vertex_0700B1B0 = [
...
const bitfs_seg7_vertex_0700B260 = [
    [[  -409,   -101,   -306], 0, [  2012,  -1054], [0x64, 0x64, 0x64, 0xff]],
...
const bitfs_seg7_vertex_0700B360 = [
...
const bitfs_seg7_vertex_0700B450 = [
...
const bitfs_seg7_vertex_0700B4D0 = [
...
const bitfs_seg7_vertex_0700B5D0 = [
...
const bitfs_seg7_vertex_0700B6C0 = [
...
const bitfs_seg7_vertex_0700B7B0 = [
...
const bitfs_seg7_vertex_0700B8A0 = [
...
const bitfs_seg7_vertex_0700B910 = [
...
const bitfs_seg7_vertex_0700BA10 = [
...
export const bitfs_seg7_dl_0700BED8 = [
    gsDPPipeSync(),
