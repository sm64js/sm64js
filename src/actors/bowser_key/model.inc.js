...
import {
    gdSPDefLights1, gsSPLight, gsSPVertex, gsSP2Triangles, gsSPEndDisplayList
} from "../../include/gbi"

// 0x030156E0, ambient color brown - light color orange
const bowser_key_lights = gdSPDefLights1(
    0x3f, 0x2c, 0x00,
    0xff, 0xb2, 0x00, 0x28, 0x28, 0x28
);

// 0x030156F8
const bowser_key_dl_vertex_group1 = [
...
// 0x030157F8
const bowser_key_dl_vertex_group2 = [
...
// 0x030158F8
const bowser_key_dl_vertex_group3 = [
...
// 0x030159F8
const bowser_key_dl_vertex_group4 = [
...
// 0x03015AF8
const bowser_key_dl_vertex_group5 = [
    [[    -4,    -39,    -37], 0, [     0,      0], [0xf0, 0xf1, 0x84, 0xff]],
...
// 0x03015BF8
const bowser_key_dl_vertex_group6 = [
    [[    -4,    -39,    -37], 0, [     0,      0], [0x8a, 0xd3, 0x00, 0xff]],
...
// 0x03015CF8
const bowser_key_dl_vertex_group7 = [
    [[    -4,    -39,     37], 0, [     0,      0], [0xef, 0xec, 0x7c, 0xff]],
...
// 0x03015DD8
const bowser_key_dl_vertex_group8 = [
...
// 0x03015ED8
const bowser_key_dl_vertex_group9 = [
...
// 0x03015FD8
const bowser_key_dl_vertex_group10 = [
    [[    12,    121,     15], 0, [     0,      0], [0x99, 0xdc, 0x3f, 0xff]],
...
// 0x030160B8
const bowser_key_dl_vertex_group11 = [
    [[    16,   -152,    -25], 0, [     0,      0], [0xce, 0x15, 0x8e, 0xff]],
...
// 0x030161B8
const bowser_key_dl_vertex_group12 = [
