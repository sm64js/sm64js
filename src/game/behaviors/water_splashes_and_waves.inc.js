...
import { spawn_water_droplet, obj_mark_for_deletion,
         try_to_spawn_object, cur_obj_scale,
         obj_scale_xyz,
...
import { MODEL_WHITE_PARTICLE_SMALL, MODEL_FISH,
         MODEL_SMALL_WATER_SPLASH                           } from "../../include/model_ids"

import { FLOOR_LOWER_LIMIT_MISC                             } from "../../include/surface_terrains"

import { oPosX, oPosY, oPosZ, oVelY, oTimer, oAnimState,
         oFaceAngleYaw                                      } from "../../include/object_constants"

import { bhvWaterDroplet, bhvWaterDropletSplash             } from "../BehaviorData"

import { random_int16, random_float                         } from "../../utils"
...
//     o.rawData[oPosY] = gMarioStates[0].waterLevel + 5;
...
//     f32 waterLevel = find_water_level(o.rawData[oPosX], o.rawData[oPosZ]);
...
//     if (o.rawData[oTimer] == 0)
//         o.rawData[oWaveTrailSize] = o.header.gfx.scale[0];

//     if (o.rawData[oAnimState] > 3) {
//         o.rawData[oWaveTrailSize] = o.rawData[oWaveTrailSize] - 0.1; // Shrink the wave
//         if (o.rawData[oWaveTrailSize] < 0)
//             o.rawData[oWaveTrailSize] = 0;
//         o.header.gfx.scale[0] = o.rawData[oWaveTrailSize];
//         o.header.gfx.scale[2] = o.rawData[oWaveTrailSize];
//     }
// }
