...
import {
    ...
    G_CC_MODULATERGBFADE, G_LIGHTING, G_TX_WRAP, G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD,
    G_TX_RENDERTILE, G_ON, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE
} from "../../../../../include/gbi"
import { sky_09000800 } from "../../../../../textures/sky"

const bitfs_seg7_vertex_0700ECF0 = [
...
export const bitfs_seg7_dl_0700ED90 = [
    gsDPPipeSync(),
