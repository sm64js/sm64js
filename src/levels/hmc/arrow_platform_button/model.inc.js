...
import {
    ...
    G_TX_CLAMP, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE, G_CYC_1CYCLE, G_RM_AA_ZB_OPA_SURF,
    G_RM_NOOP2
} from "../../../include/gbi"
import { hmc_seg7_texture_07003800 } from "../texture.inc"
const hmc_seg7_lights_07022E78 = gdSPDefLights1(
    0x79, 0x79, 0x79,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x07022E90 - 0x07022EA8
const hmc_seg7_lights_07022E90 = gdSPDefLights1(
    0x4f, 0x64, 0x5b,
    0xa8, 0xd3, 0xc0, 0x28, 0x28, 0x28
);

// 0x07022EA8 - 0x07022EE8
const hmc_seg7_vertex_07022EA8 = [
...
const hmc_seg7_vertex_07022EE8 = [
...
export const hmc_seg7_dl_07023090 = [
    gsDPPipeSync(),
