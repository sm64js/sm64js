...
import {
    MODEL_BLUE_FLAME, MODEL_BOO_CASTLE, MODEL_CASTLE_BOWSER_TRAP, MODEL_CASTLE_CASTLE_DOOR,
    MODEL_CASTLE_CASTLE_DOOR_UNUSED, MODEL_CASTLE_CLOCK_HOUR_HAND, MODEL_CASTLE_CLOCK_MINUTE_HAND,
    MODEL_CASTLE_CLOCK_PENDULUM, MODEL_CASTLE_DOOR_0_STARS, MODEL_CASTLE_DOOR_1_STAR, MODEL_CASTLE_DOOR_3_STARS,
    MODEL_CASTLE_KEY_DOOR, MODEL_CASTLE_METAL_DOOR, MODEL_CASTLE_STAR_DOOR_30_STARS, MODEL_CASTLE_STAR_DOOR_50_STARS,
    MODEL_CASTLE_STAR_DOOR_70_STARS, MODEL_CASTLE_STAR_DOOR_8_STARS, MODEL_CASTLE_WATER_LEVEL_PILLAR,
    MODEL_CASTLE_WOODEN_DOOR, MODEL_CASTLE_WOODEN_DOOR_UNUSED, MODEL_LAKITU, MODEL_MARIO, MODEL_MIPS, MODEL_NONE,
    MODEL_RED_FLAME, MODEL_TOAD
} from "../../include/model_ids"

import {
    LEVEL_BITDW, LEVEL_BITFS, LEVEL_BITS, LEVEL_BOB, LEVEL_CASTLE, LEVEL_CASTLE_COURTYARD, LEVEL_CASTLE_GROUNDS,
    LEVEL_CCM, LEVEL_DDD, LEVEL_HMC, LEVEL_INSIDE_CASTLE, LEVEL_JRB, LEVEL_LLL, LEVEL_PILLAR, LEVEL_PSS, LEVEL_RR,
    LEVEL_SA, LEVEL_SL, LEVEL_SSL, LEVEL_THI, LEVEL_TOTWC, LEVEL_TTC, LEVEL_TTM, LEVEL_WDW, LEVEL_WF, LEVEL_WMOTR 
} from "../level_defines_constants"

import {
    DIALOG_133, DIALOG_134, DIALOG_135, DIALOG_076, DIALOG_083, DIALOG_137, DIALOG_082, DIALOG_136
...
import { inside_castle_seg7_area_1_macro_objs } from "./areas/1/macro.inc"
import { inside_castle_seg7_area_2_macro_objs } from "./areas/2/macro.inc"
import { inside_castle_seg7_area_3_macro_objs } from "./areas/3/macro.inc"
...
import { castle_geo_000F00 } from "./star_door/geo.inc"
import { castle_geo_000F18 } from "./trap_door/geo.inc"
import { castle_geo_001518 } from "./areas/2/pendulum/geo.inc"
import { castle_geo_001530 } from "./clock_minute_hand/geo.inc"
import { castle_geo_001548 } from "./clock_hour_hand/geo.inc"
import { castle_geo_001940 } from "./water_level_pillar/geo.inc"

import {
    castle_door_0_star_geo, castle_door_1_star_geo, castle_door_3_stars_geo, castle_door_geo,
    key_door_geo, metal_door_geo, wooden_door_geo
} from "../../actors/door/geo.inc"
...
export const level_castle_inside_entry = [
    ...
    AREA(/*index*/ 1, castle_geo_001400),
        ...
        OBJECT(/*model*/ MODEL_TOAD,       /*pos*/ -1671,    0,  1313, /*angle*/ 0,  83, 0, /*behParam*/ DIALOG_133, /*beh*/ 'bhvToadMessage'),
        OBJECT(/*model*/ MODEL_TOAD,       /*pos*/  1524,  307,   458, /*angle*/ 0, 110, 0, /*behParam*/ DIALOG_134, /*beh*/ 'bhvToadMessage'),
        OBJECT(/*model*/ MODEL_TOAD,       /*pos*/   596, -306, -2637, /*angle*/ 0, 152, 0, /*behParam*/ DIALOG_135, /*beh*/ 'bhvToadMessage'),
    ...
    AREA(/*index*/ 2, castle_geo_001858),
        ...
        OBJECT(/*model*/ MODEL_TOAD,                     /*pos*/  -977, 1203, 2569, /*angle*/ 0,   0, 0, /*behParam*/ DIALOG_076, /*beh*/ 'bhvToadMessage'),
        OBJECT(/*model*/ MODEL_TOAD,                     /*pos*/ -1584, 2253, 7157, /*angle*/ 0, 136, 0, /*behParam*/ DIALOG_083, /*beh*/ 'bhvToadMessage'),
        OBJECT(/*model*/ MODEL_TOAD,                     /*pos*/   837, 1203, 3020, /*angle*/ 0, 180, 0, /*behParam*/ DIALOG_137, /*beh*/ 'bhvToadMessage'),
    ...
    AREA(/*index*/ 3, castle_geo_001C10),
        ...
        OBJECT(/*model*/ MODEL_TOAD,                      /*pos*/  1787, -1381, -1957, /*angle*/ 0, 126, 0, /*behParam*/ DIALOG_082, /*beh*/ 'bhvToadMessage'),
        OBJECT(/*model*/ MODEL_TOAD,                      /*pos*/ -4048, -1381, -1334, /*angle*/ 0,  30, 0, /*behParam*/ DIALOG_136, /*beh*/ 'bhvToadMessage'),
...
gLinker.level_scripts.level_castle_inside_entry = level_castle_inside_entry
