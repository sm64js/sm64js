...
import {
    ...
    G_TX_RENDERTILE, G_ON, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE, G_TX_CLAMP
} from "../../include/gbi"

// Unreferenced light group
const mad_piano_lights_unused1 = gdSPDefLights1(
    0x05, 0x04, 0x08,
    0x14, 0x13, 0x20, 0x28, 0x28, 0x28
);

// Unreferenced light group
const mad_piano_lights_unused2 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// Unreferenced light group
const mad_piano_lights_unused3 = gdSPDefLights1(
    0x2c, 0x2c, 0x2c,
    0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28
);

// Unreferenced light group
const mad_piano_lights_unused4 = gdSPDefLights1(
    0x30, 0x00, 0x00,
    0xc3, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x05006AF0
export const mad_piano_seg5_texture_05006AF0 = []
// actors/mad_piano/mad_piano_tooth.rgba16.png

// 0x050072F0
export const mad_piano_seg5_texture_050072F0 = []
// actors/mad_piano/mad_piano_body.rgba16.png

// 0x050076F0
export const mad_piano_seg5_texture_050076F0 = []
// actors/mad_piano/mad_piano_keys_corner.rgba16.png

// 0x05007AF0
export const mad_piano_seg5_texture_05007AF0 = []
// actors/mad_piano/mad_piano_mouth.rgba16.png

// 0x05007EF0
export const mad_piano_seg5_texture_05007EF0 = []
// actors/mad_piano/mad_piano_keys.rgba16.png

// 0x050082F0
export const mad_piano_seg5_texture_050082F0 = []
// actors/mad_piano/mad_piano_keys_edge.rgba16.png

// 0x050086F0
const mad_piano_seg5_lights_050086F0 = gdSPDefLights1(
    0x4c, 0x4c, 0x4c,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05008708
const mad_piano_seg5_vertex_05008708 = [
...
// 0x050087A8
const mad_piano_seg5_vertex_050087A8 = [
...
// 0x05008898
const mad_piano_seg5_vertex_05008898 = [
...
// 0x05008988
const mad_piano_seg5_vertex_05008988 = [
...
// 0x05008A78
const mad_piano_seg5_vertex_05008A78 = [
...
export const mad_piano_seg5_dl_05008B68 = [
...
export const mad_piano_seg5_dl_05008BD0 = [
...
export const mad_piano_seg5_dl_05008CB0 = [
    gsDPPipeSync(),
...
// 0x05008D40
const mad_piano_seg5_lights_05008D40 = gdSPDefLights1(
    0x3d, 0x3d, 0x3d,
    0xcc, 0xcc, 0xcc, 0x28, 0x28, 0x28
);

// 0x05008D58
const mad_piano_seg5_lights_05008D58 = gdSPDefLights1(
    0x4c, 0x4c, 0x4c,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05008D70
const mad_piano_seg5_lights_05008D70 = gdSPDefLights1(
    0x26, 0x26, 0x26,
    0x7f, 0x7f, 0x7f, 0x28, 0x28, 0x28
);

// 0x05008D88
const mad_piano_seg5_lights_05008D88 = gdSPDefLights1(
    0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x05008DA0
const mad_piano_seg5_vertex_05008DA0 = [
...
// 0x05008E70
const mad_piano_seg5_vertex_05008E70 = [
...
// 0x05008F60
const mad_piano_seg5_vertex_05008F60 = [
...
// 0x05009050
const mad_piano_seg5_vertex_05009050 = [
    [[  -674,    277,    -92], 0, [   138,     36], [0xc9, 0x58, 0xb8, 0xff]],
...
// 0x05009150
const mad_piano_seg5_vertex_05009150 = [
...
// 0x05009240
const mad_piano_seg5_vertex_05009240 = [
...
// 0x05009330
const mad_piano_seg5_vertex_05009330 = [
...
// 0x050093F0
const mad_piano_seg5_vertex_050093F0 = [
...
// 0x05009430
const mad_piano_seg5_vertex_05009430 = [
...
// 0x05009470
const mad_piano_seg5_vertex_05009470 = [
...
// 0x050094F0
const mad_piano_seg5_vertex_050094F0 = [
...
export const mad_piano_seg5_dl_05009590 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, mad_piano_seg5_texture_050072F0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 16 * 32 - 1, CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
...
export const mad_piano_seg5_dl_050096C8 = [
...
export const mad_piano_seg5_dl_050097B0 = [
...
export const mad_piano_seg5_dl_050097F8 = [
...
export const mad_piano_seg5_dl_05009840 = [
...
export const mad_piano_seg5_dl_05009888 = [
...
export const mad_piano_seg5_dl_050098E8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
