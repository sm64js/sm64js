...
import {
    ...
    gsSPClearGeometryMode, gsSPSetGeometryMode, gsSPBranchList, gsSPNumLights,
...
const lakitu_enemy_lights_unused1 = gdSPDefLights1(
    0x33, 0x1f, 0x0c,
    0xcc, 0x7f, 0x33, 0x28, 0x28, 0x28
);

// 0x0500ECB0
const lakitu_enemy_seg5_lights_0500ECB0 = gdSPDefLights1(
    0x29, 0x13, 0x06,
    0xa5, 0x4f, 0x1b, 0x28, 0x28, 0x28
);

// Unreferenced light group
const lakitu_enemy_lights_unused2 = gdSPDefLights1(
    0x0d, 0x2c, 0x0b,
...
// 0x050124E0
const lakitu_enemy_seg5_lights_050124E0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x050124F8
const lakitu_enemy_seg5_lights_050124F8 = gdSPDefLights1(
    0x79, 0x55, 0x00,
    0xf2, 0xab, 0x00, 0x28, 0x28, 0x28
);

// 0x05012510
const lakitu_enemy_seg5_vertex_05012510 = [
...
// 0x05012610
const lakitu_enemy_seg5_vertex_05012610 = [
    [[    -2,     15,     99], 0, [   684,    990], [0xc1, 0x34, 0x60, 0xff]],
...
// 0x050126B0
const lakitu_enemy_seg5_vertex_050126B0 = [
...
export const lakitu_enemy_seg5_dl_05012760 = [
...
export const lakitu_enemy_seg5_dl_05012890 = [
...
export const lakitu_enemy_seg5_dl_05012910 = [
    gsDPPipeSync(),
...
// 0x05012978
const lakitu_enemy_seg5_lights_05012978 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05012990
const lakitu_enemy_seg5_vertex_05012990 = [
...
// 0x05012A90
const lakitu_enemy_seg5_vertex_05012A90 = [
    [[     1,    -57,    -75], 0, [ -1062,    410], [0xd6, 0xe6, 0x8c, 0xff]],
...
// 0x05012B80
const lakitu_enemy_seg5_vertex_05012B80 = [
...
// 0x05012C80
const lakitu_enemy_seg5_vertex_05012C80 = [
    [[     2,     -6,    -82], 0, [ -1072,    916], [0xcf, 0x36, 0x99, 0xff]],
    [[   104,     34,    -89], 0, [ -2094,   1332], [0x1d, 0x53, 0xa5, 0xff]],
    [[   103,    -17,   -100], 0, [ -2084,    810], [0x33, 0xd1, 0x97, 0xff]],
    [[    98,    -35,    -80], 0, [ -2034,    626], [0x43, 0xd5, 0x9e, 0xff]],
...
// 0x05012D70
const lakitu_enemy_seg5_vertex_05012D70 = [
    [[   103,    -17,    101], 0, [ -2084,    810], [0x33, 0xd1, 0x69, 0xff]],
    [[   104,     34,     90], 0, [ -2094,   1332], [0x12, 0x57, 0x5a, 0xff]],
    [[     2,     -6,     83], 0, [ -1072,    916], [0xcb, 0x25, 0x6c, 0xff]],
    [[   138,    -47,     11], 0, [ -2428,    508], [0x6f, 0xce, 0x20, 0xff]],
...
// 0x05012E70
const lakitu_enemy_seg5_vertex_05012E70 = [
    [[   101,   -142,    -34], 0, [ -2058,   -434], [0x34, 0x92, 0xde, 0xff]],
    [[     0,   -140,     32], 0, [ -1046,   -414], [0xc5, 0x94, 0x1d, 0xff]],
    [[     0,   -140,    -31], 0, [ -1046,   -414], [0xd1, 0x9a, 0xc6, 0xff]],
    [[   101,   -142,     35], 0, [ -2058,   -434], [0x26, 0x99, 0x3d, 0xff]],
...
export const lakitu_enemy_seg5_dl_05012EF0 = [
...
export const lakitu_enemy_seg5_dl_05013160 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
// 0x050131C0
const lakitu_enemy_seg5_lights_050131C0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x050131D8
const lakitu_enemy_seg5_vertex_050131D8 = [
...
export const lakitu_enemy_seg5_dl_05013298 = [
...
export const lakitu_enemy_seg5_dl_050132D8 = [
    gsDPPipeSync(),
...
export const lakitu_enemy_seg5_dl_05013320 = [
...
export const lakitu_enemy_seg5_dl_05013350 = [
...
export const lakitu_enemy_seg5_dl_05013378 = [
    gsSPDisplayList(lakitu_enemy_seg5_dl_050132D8),
...
// 0x050133A0
const lakitu_enemy_seg5_lights_050133A0 = gdSPDefLights1(
    0x79, 0x55, 0x00,
    0xf2, 0xab, 0x00, 0x28, 0x28, 0x28
);

// 0x050133B8
const lakitu_enemy_seg5_vertex_050133B8 = [
...
export const lakitu_enemy_seg5_dl_050134A8 = [
...
// 0x05013598
const lakitu_enemy_seg5_lights_05013598 = gdSPDefLights1(
    0x79, 0x55, 0x00,
    0xf2, 0xab, 0x00, 0x28, 0x28, 0x28
);

// 0x050135B0
const lakitu_enemy_seg5_vertex_050135B0 = [
...
export const lakitu_enemy_seg5_dl_050136A0 = [
...
// 0x05013790
const lakitu_enemy_seg5_vertex_05013790 = [
...
export const lakitu_enemy_seg5_dl_05013860 = [
...
export const lakitu_enemy_seg5_dl_050138B0 = [
