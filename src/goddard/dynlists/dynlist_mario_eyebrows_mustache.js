...
const verts_mario_eyebrow_right = [
...
const facedata_mario_eyebrow_right = [
...
const vtx_mario_eyebrow_right = { type: 0x1, data: verts_mario_eyebrow_right }

const faces_mario_eyebrow_right = { type: 0x1, data: facedata_mario_eyebrow_right }



export const dynlist_mario_eyebrow_right = [
    Macros.StartList(),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0x5A),
    Macros.LinkWithPtr(vtx_mario_eyebrow_right),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0x5B),
    Macros.LinkWithPtr(faces_mario_eyebrow_right),
    Macros.StartGroup(0x5C),
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(0),
    Macros.SetAmbient(0.0, 0.005, 0.0),
    Macros.SetDiffuse(0.0, 0.0, 0.0),
    Macros.EndGroup(0x5C),
    Macros.MakeDynObj(Dynlist.D_SHAPE, 0x5D),
    Macros.SetNodeGroup(0x5A),
    Macros.SetPlaneGroup(0x5B),
    Macros.SetMaterialGroup(0x5C),
    Macros.StopList(),
]

const verts_mario_eyebrow_left = [
...
const facedata_mario_eyebrow_left = [
...
const vtx_mario_eyebrow_left = { type: 0x1, data: verts_mario_eyebrow_left }

const faces_mario_eyebrow_left = { type: 0x1, data: facedata_mario_eyebrow_left }


export const dynlist_mario_eyebrow_left = [
    Macros.StartList(),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0x38),
    Macros.LinkWithPtr(vtx_mario_eyebrow_left),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0x39),
    Macros.LinkWithPtr(faces_mario_eyebrow_left),
    Macros.StartGroup(0x3A),
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(0),
    Macros.SetAmbient(0.0, 0.0, 0.0),
    Macros.SetDiffuse(0.0, 0.0, 0.0),
    Macros.EndGroup(0x3A),
    Macros.MakeDynObj(Dynlist.D_SHAPE, 0x3B),
    Macros.SetNodeGroup(0x38),
    Macros.SetPlaneGroup(0x39),
    Macros.SetMaterialGroup(0x3A),
    Macros.StopList(),
]


const verts_mario_mustache = [
...
const vtx_mario_mustache = { type: 0x1, data: verts_mario_mustache }

const faces_mario_mustache = { type: 0x1, data: facedata_mario_mustache }


export const dynlist_mario_mustache = [
    Macros.StartList(),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0x16),
    Macros.LinkWithPtr(vtx_mario_mustache),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0x17),
    Macros.LinkWithPtr(faces_mario_mustache),
    Macros.StartGroup(0x18),
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(0),
    Macros.SetAmbient(0.0, 0.0, 0.0),
    Macros.SetDiffuse(0.0, 0.0, 0.0),
    Macros.EndGroup(0x18),
    Macros.MakeDynObj(Dynlist.D_SHAPE, 0x19),
    Macros.SetNodeGroup(0x16),
    Macros.SetPlaneGroup(0x17),
    Macros.SetMaterialGroup(0x18),
    Macros.StopList(),
]