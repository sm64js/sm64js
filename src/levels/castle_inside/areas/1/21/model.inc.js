...
import {
    ...
    gsSP2Triangles, gsSPEndDisplayList, gsDPPipeSync, gsSPClearGeometryMode, gsDPSetEnvColor,
    gsDPSetCombineMode, gsSPDisplayList, gsSPSetGeometryMode,
    G_IM_FMT_RGBA, G_IM_SIZ_16b, CALC_DXT, G_TX_LOADTILE, G_IM_SIZ_16b_BYTES, G_LIGHTING,
    G_CC_SHADEFADEA, G_CC_SHADE
} from "../../../../../include/gbi"
import { inside_0900B000 } from "../../../../../textures/inside"

const inside_castle_seg7_lights_07037C58 = gdSPDefLights1(
    0x37, 0x37, 0x37,
...
const inside_castle_seg7_dl_07037D70 = [
