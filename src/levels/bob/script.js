...
import { script_func_global_1,
         ...
         script_func_global_15 } from "../global_scripts"
...
import { MODEL_NONE,
         ...
         ACT_4,
         ACT_5,
         ACT_6                          } from "../../include/model_ids"

import { TERRAIN_GRASS                  } from "../../include/surface_terrains"

import { DialogTexts as D               } from "../../text/us/dialogs"
...
const script_func_local_2 = [
    ...
    // ['OBJECT_WITH_ACTS', /*model*/ MODEL_BOBOMB_BUDDY,          /*pos*/ -5723,  140,  6017, /*angle*/ 0, 0, 0,   /*behParam*/ D.DIALOG_002 << 16, /*beh*/ bhvBobombBuddy,            /*acts*/ ACT_1],
    // ['OBJECT_WITH_ACTS', /*model*/ MODEL_BOBOMB_BUDDY,          /*pos*/ -6250,    0,  6680, /*angle*/ 0, 0, 0,   /*behParam*/ D.DIALOG_001 << 16, /*beh*/ bhvBobombBuddy,            /*acts*/ ACT_1],
    ...
    // ['OBJECT_WITH_ACTS', /*model*/ MODEL_BOBOMB_BUDDY,          /*pos*/ -6250,    0,  6680, /*angle*/ 0, 0, 0,   /*behParam*/ D.DIALOG_003 << 16, /*beh*/ bhvBobombBuddy,            /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6],
    ...
    ['OBJECT_WITH_ACTS', /*model*/ MODEL_DL_CANNON_LID,         /*pos*/ -5694,  128,  5600, /*angle*/ 0, 180, 0, /*behParam*/ 0x00000000, /*beh*/ bhvCannonClosed,           /*acts*/ ALL_ACTS /*ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6*/],
...
export const level_bob_entry = [
    ...
    ['AREA', /*index*/ 1, bob_geo_000488],
        ...
        // ['SHOW_DIALOG', /*index*/ 0x00, D.DIALOG_000],
