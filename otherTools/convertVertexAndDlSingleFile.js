...
function convert(MDTY) {
	var input = require('os').homedir() + '/Programming/sm64pc/actors/explosion/model.inc.c' // directory of each model file
	...
	//MakeDirectory(dir);
	fs.writeFileSync(__dirname + '/model.inc.js', outputStr)
