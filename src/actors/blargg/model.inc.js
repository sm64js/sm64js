...
import {
    gsSPLight, gsSPVertex, gsSP2Triangles, gsSP1Triangle, gsSPEndDisplayList
} from "../../include/gbi"

// Unreferenced light group
const blargg_lights_unused = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05004740
const blargg_seg5_lights_05004740 = gdSPDefLights1(
    0x3f, 0x0d, 0x05,
    0xff, 0x36, 0x16, 0x28, 0x28, 0x28
);

// 0x05004758
const blargg_seg5_lights_05004758 = gdSPDefLights1(
    0x2c, 0x2c, 0x2c,
    0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28
);

// 0x05004770
const blargg_seg5_lights_05004770 = gdSPDefLights1(
    0x3f, 0x0a, 0x06,
    0xff, 0x2a, 0x1a, 0x28, 0x28, 0x28
);

// 0x05004788
const blargg_seg5_lights_05004788 = gdSPDefLights1(
    0x3f, 0x0b, 0x07,
    0xff, 0x2e, 0x1f, 0x28, 0x28, 0x28
);

// 0x050047A0
const blargg_seg5_vertex_050047A0 = [
...
// 0x050048A0
const blargg_seg5_vertex_050048A0 = [
...
// 0x050049A0
const blargg_seg5_vertex_050049A0 = [
...
// 0x05004A20
const blargg_seg5_vertex_05004A20 = [
...
// 0x05004B20
const blargg_seg5_vertex_05004B20 = [
    [[   111,     99,    -96], 0, [     0,      0], [0xe5, 0x71, 0xce, 0x00]],
    [[   410,     80,   -203], 0, [     0,      0], [0x35, 0x58, 0xb7, 0x00]],
...
// 0x05004BE0
const blargg_seg5_vertex_05004BE0 = [
...
// 0x05004CE0
const blargg_seg5_vertex_05004CE0 = [
...
// 0x05004DE0
const blargg_seg5_vertex_05004DE0 = [
...
// 0x05004E60
const blargg_seg5_vertex_05004E60 = [
...
// 0x05004F60
const blargg_seg5_vertex_05004F60 = [
...
// 0x05005050
const blargg_seg5_vertex_05005050 = [
...
// 0x05005150
const blargg_seg5_vertex_05005150 = [
...
// 0x05005250
const blargg_seg5_vertex_05005250 = [
    [[   161,   -168,   -171], 0, [     0,      0], [0x6f, 0xc7, 0xed, 0x00]],
...
// 0x05005340
const blargg_seg5_vertex_05005340 = [
    [[   617,     23,    154], 0, [     0,      0], [0x6b, 0xdf, 0x3b, 0x00]],
    [[   555,   -242,    127], 0, [     0,      0], [0x43, 0xba, 0x50, 0x00]],
    [[   571,   -260,      0], 0, [     0,      0], [0x7a, 0xdd, 0x00, 0x00]],
    [[   571,   -260,      0], 0, [     0,      0], [0x11, 0x83, 0x00, 0x00]],
...
// 0x050053E0
const blargg_seg5_vertex_050053E0 = [
...
// 0x050054E0
const blargg_seg5_vertex_050054E0 = [
...
// 0x050055E0
const blargg_seg5_vertex_050055E0 = [
...
// 0x050056E0
const blargg_seg5_vertex_050056E0 = [
...
// 0x050057E0
const blargg_seg5_vertex_050057E0 = [
    [[   146,     26,    196], 0, [     0,      0], [0x20, 0xcb, 0x6e, 0x00]],
    [[   288,    -17,     53], 0, [     0,      0], [0x64, 0xc7, 0x34, 0x00]],
    [[   286,    227,    123], 0, [     0,      0], [0x73, 0xf4, 0x32, 0x00]],
    [[   133,    191,    247], 0, [     0,      0], [0x23, 0xde, 0x74, 0x00]],
