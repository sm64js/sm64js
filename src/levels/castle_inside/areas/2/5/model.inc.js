...
import {
    inside_09003000, inside_09004000, inside_09005000, inside_09007000, inside_0900A000
...
const inside_castle_seg7_dl_07048A38 = [
...
const inside_castle_seg7_dl_07048AA0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_09004000),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
const inside_castle_seg7_dl_07048E68 = [
...
const inside_castle_seg7_dl_07048F68 = [
...
const inside_castle_seg7_dl_07049248 = [
...
const inside_castle_seg7_dl_070494D8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, inside_09007000),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
const inside_castle_seg7_dl_07049E98 = [
