...
import {
    water_09005800, water_0900A000, water_09000800, water_0900A800, water_09002800
} from "../../../../../textures/water"

const jrb_seg7_lights_0700D318 = gdSPDefLights1(
    0x14, 0x30, 0x2c,
    0x32, 0x78, 0x6e, 0x28, 0x28, 0x28
);

// 0x0700D330 - 0x0700D348
const jrb_seg7_lights_0700D330 = gdSPDefLights1(
    0x3c, 0x52, 0x4a,
    0x97, 0xcd, 0xbb, 0x28, 0x28, 0x28
);

// 0x0700D348 - 0x0700D360
const jrb_seg7_lights_0700D348 = gdSPDefLights1(
    0x66, 0x66, 0x66,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0700D360 - 0x0700D378
const jrb_seg7_lights_0700D360 = gdSPDefLights1(
    0x50, 0x66, 0x58,
    0xc8, 0xff, 0xdc, 0x28, 0x28, 0x28
);

// 0x0700D378 - 0x0700D3F8
const jrb_seg7_vertex_0700D378 = [
...
const jrb_seg7_vertex_0700D3F8 = [
...
const jrb_seg7_vertex_0700D4E8 = [
...
const jrb_seg7_vertex_0700D5D8 = [
...
const jrb_seg7_vertex_0700D6D8 = [
...
const jrb_seg7_vertex_0700D7C8 = [
...
const jrb_seg7_vertex_0700D878 = [
...
const jrb_seg7_vertex_0700D928 = [
...
const jrb_seg7_vertex_0700D968 = [
    [[  -475,   -351,    184], 0, [   750,    936], [0x1c, 0x69, 0xc0, 0xff]],
    [[  -705,   -289,    184], 0, [   920,    936], [0x1e, 0x73, 0xd5, 0xff]],
...
const jrb_seg7_vertex_0700DA28 = [
...
const jrb_seg7_vertex_0700DB28 = [
    [[  1653,   1382,  -1187], 0, [ -2752,  -5938], [0xb5, 0xb1, 0xc0, 0xff]],
    [[   668,   1534,  -1125], 0, [   536,  -5526], [0xf0, 0xc3, 0x93, 0xff]],
...
const jrb_seg7_vertex_0700DC08 = [
...
const jrb_seg7_vertex_0700DCF8 = [
    [[  1331,   2232,   3522], 0, [ 13472,   1812], [0xa9, 0x0b, 0xa5, 0xff]],
...
const jrb_seg7_vertex_0700DDD8 = [
...
const jrb_seg7_vertex_0700DED8 = [
    [[   111,   3148,   3194], 0, [ 13472,   -372], [0x1d, 0x85, 0x0b, 0xff]],
    [[  -697,   2180,   2833], 0, [ 10528,   2324], [0x77, 0xf1, 0xd9, 0xff]],
...
const jrb_seg7_vertex_0700DFD8 = [
    [[   759,   -351,  -2188], 0, [ -1372,  -2114], [0xd4, 0x67, 0x39, 0xff]],
...
const jrb_seg7_vertex_0700E0C8 = [
...
const jrb_seg7_vertex_0700E1C8 = [
    [[  -864,    191,  -2190], 0, [ -7208,   -372], [0x69, 0x42, 0x19, 0xff]],
    [[ -1071,   -351,  -1741], 0, [ -6876,   2038], [0x15, 0x7c, 0x09, 0xff]],
...
const jrb_seg7_vertex_0700E298 = [
...
const jrb_seg7_vertex_0700E398 = [
    [[  1876,   2217,   2428], 0, [  7736,  -3466], [0x98, 0xba, 0x12, 0xff]],
    [[  -515,   2858,   2428], 0, [  7736,   3400], [0x25, 0x8d, 0x25, 0xff]],
...
const jrb_seg7_vertex_0700E458 = [
...
const jrb_seg7_vertex_0700E518 = [
...
const jrb_seg7_vertex_0700E558 = [
...
const jrb_seg7_vertex_0700E658 = [
    [[ -1071,   -351,  -1741], 0, [  2612,    836], [0x15, 0x7c, 0x09, 0xff]],
    [[  -716,   -351,  -2182], 0, [  2036,   1112], [0x45, 0x54, 0x40, 0xff]],
...
export const jrb_seg7_dl_0700EF00 = [
    gsDPPipeSync(),
