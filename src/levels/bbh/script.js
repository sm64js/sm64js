...
import {
    ...
    WARP_NODE, TERRAIN, MACRO_OBJECTS, ROOMS, SHOW_DIALOG, SET_BACKGROUND_MUSIC, TERRAIN_TYPE,
    END_AREA, MARIO_POS, CALL, CALL_LOOP, CLEAR_LEVEL, SLEEP_BEFORE_EXIT, EXIT
} from "../../engine/LevelCommands"

import {
    MODEL_RED_FLAME, MODEL_BBH_TILTING_FLOOR_PLATFORM, MODEL_BBH_TUMBLING_PLATFORM,
    MODEL_BBH_MOVING_BOOKSHELF, MODEL_BBH_MESH_ELEVATOR, MODEL_BBH_MERRY_GO_ROUND, MODEL_NONE,
    MODEL_BOO, MODEL_BBH_STAIRCASE_STEP, MODEL_MAD_PIANO, MODEL_HAUNTED_CHAIR, MODEL_BOOKEND,
    MODEL_STAR, MODEL_MARIO, MODEL_BBH_HAUNTED_DOOR, MODEL_BBH_TUMBLING_PLATFORM_PART,
    MODEL_BBH_WOODEN_TOMB
} from "../../include/model_ids"

import {
    script_func_global_1, script_func_global_10, script_func_global_18
} from "../global_scripts"

import { geo_bbh_0005B0 } from "./staircase_step/geo.inc"

import { geo_bbh_0005C8 } from "./tilting_trap_platform/geo.inc"

import { geo_bbh_0005E0 } from "./tumbling_platform_far/geo.inc"

import { geo_bbh_0005F8 } from "./tumbling_platform_near/geo.inc"

import { geo_bbh_000610 } from "./moving_bookshelf/geo.inc"

import { geo_bbh_000628 } from "./mesh_elevator/geo.inc"

import { geo_bbh_000640 } from "./merry_go_round/geo.inc"

import { geo_bbh_000658 } from "./coffin/geo.inc"

import { geo_bbh_000F00 } from "./areas/1/geo.inc"

import {
    LEVEL_BBH, LEVEL_CASTLE_COURTYARD
...
import { bbh_seg7_macro_objs } from "./areas/1/macro.inc"

import { DIALOG_098 } from "../../text/us/dialogs"

import { SEQ_LEVEL_SPOOKY } from "../../include/seq_ids"

import { TERRAIN_SPOOKY } from "../../include/surface_terrains"
...
gLinker.level_scripts.level_bbh_entry = level_bbh_entry
