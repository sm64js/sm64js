...
import {
    gdSPDefLights1, gsSPLight, gsSPVertex, gsSP2Triangles, gsSPEndDisplayList, gsDPPipeSync,
    gsSPSetGeometryMode, gsDPSetEnvColor, gsDPSetCombineMode, gsDPLoadTextureBlock, gsSPTexture,
    gsSPDisplayList, gsSPClearGeometryMode, gsDPSetTextureImage, gsDPLoadSync, gsDPLoadBlock,
    gsDPSetTile, gsDPTileSync, gsDPSetTileSize,
    G_TEXTURE_GEN, G_CC_DECALFADE, G_IM_FMT_RGBA, G_IM_SIZ_16b, G_TX_WRAP, G_TX_NOMIRROR,
    G_TX_NOLOD, G_TX_RENDERTILE, G_ON, G_OFF, G_CC_SHADE, CALC_DXT, G_TX_LOADTILE,
    G_IM_SIZ_16b_BYTES, G_CC_MODULATERGBA, G_SHADING_SMOOTH, G_TX_NOMASK, G_TX_CLAMP,
    G_TEXTURE_IMAGE_FRAC
} from "../../include/gbi"

// 0x0302A6D8
const star_seg3_lights_0302A6D8 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0302A6F0
export const star_seg3_texture_0302A6F0 = []
// actors/star/star_surface.rgba16.png

// 0x0302AEF0
export const star_seg3_texture_0302AEF0 = []
// actors/star/star_eye.rgba16.png

// 0x0302B6F0
const star_seg3_vertex_0302B6F0 = [
...
export const star_seg3_dl_0302B7B0 = [
...
export const star_seg3_dl_0302B870 = [
    gsDPPipeSync(),
...
// 0x0302B908
const star_seg3_lights_0302B908 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0302B920
const star_seg3_vertex_0302B920 = [
...
export const star_seg3_dl_0302B9C0 = [
...
export const star_seg3_dl_0302BA18 = [
    gsDPPipeSync(),
