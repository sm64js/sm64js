...
import { CALC_DXT, gsDPLoadBlock, gsDPLoadSync, gsDPPipeSync, gsDPSetCombineMode, gsDPSetTextureImage, gsDPSetTile, gsDPSetTileSize, gsDPTileSync, gsSPClearGeometryMode, gsSPDisplayList, gsSPEndDisplayList, gsSPSetGeometryMode, gsSPTexture, gsSPVertex, gdSPDefLights1, G_CC_DECALRGB, G_CC_SHADE, G_IM_FMT_RGBA, G_IM_SIZ_16b, G_IM_SIZ_16b_BYTES, G_LIGHTING, G_OFF, G_ON, G_TEXTURE_IMAGE_FRAC, G_TX_LOADTILE, G_TX_NOLOD, G_TX_NOMASK, G_TX_NOMIRROR, G_TX_RENDERTILE, G_TX_WRAP, gsSPLight, gsSP2Triangles, G_CC_DECALRGBA, G_TX_CLAMP } from "../../include/gbi"
...
export const bully_seg5_dl_050002E0 = [
...
export const bully_seg5_dl_05000398 = [
    gsDPPipeSync(),
...
// 0x05000408
const bully_seg5_lights_05000408 = gdSPDefLights1(
    0x00, 0x38, 0x00,
    0x00, 0xe3, 0x00, 0x28, 0x28, 0x28
)

// 0x05000420
const bully_seg5_lights_05000420 = gdSPDefLights1(
    0x00, 0x3f, 0x00,
    0x00, 0xff, 0x00, 0x28, 0x28, 0x28
)

// Unreferenced light group
const bully_lights_unused = gdSPDefLights1(
    0x3f, 0x29, 0x00,
    0xff, 0xa5, 0x00, 0x28, 0x28, 0x28
)

// 0x05000450
const bully_seg5_lights_05000450 = gdSPDefLights1(
    0x00, 0x00, 0x00,
...
const bully_seg5_vertex_05002C68 = [
...
const bully_seg5_vertex_05002D48 = [
...
const bully_seg5_vertex_05002D88 = [
...
const bully_seg5_vertex_05002E68 = [
    [[    55,     28,    -41], 0, [     0,      0], [0xff, 0x7f, 0x00, 0xff]],
    [[   -37,     27,      0], 0, [     0,      0], [0xff, 0x7f, 0x00, 0x00]],
    [[    56,     28,     46], 0, [     0,      0], [0xff, 0x7f, 0x00, 0x00]],
    [[    90,     28,      0], 0, [     0,      0], [0xff, 0x7f, 0x00, 0xff]],
...
const bully_seg5_vertex_05002EA8 = [
...
const bully_seg5_vertex_05002F08 = [
...
const bully_seg5_vertex_05003008 = [
...
const bully_seg5_vertex_05003108 = [
...
const bully_seg5_vertex_05003208 = [
...
const bully_seg5_vertex_05003308 = [
...
const bully_seg5_vertex_05003408 = [
...
const bully_seg5_vertex_05003508 = [
...
const bully_seg5_vertex_05003608 = [
...
export const bully_seg5_dl_05003708 = [
...
export const bully_seg5_dl_050037A0 = [
...
export const bully_seg5_dl_05003838 = [
...
export const bully_seg5_dl_05003878 = [
...
const bully_seg5_vertex_05003C50 = [
...
const bully_seg5_vertex_05003C90 = [
...
export const bully_seg5_dl_05003CD0 = [
...
export const bully_seg5_dl_05003D08 = [
...
export const bully_seg5_dl_05003D40 = [
    gsDPPipeSync(),
...
const bully_seg5_vertex_05003DB8 = [
...
const bully_seg5_vertex_05003DF8 = [
...
export const bully_seg5_dl_05003E38 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bully_seg5_texture_05000468),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bully_seg5_dl_05003E70 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, bully_seg5_texture_05001468),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const bully_seg5_dl_05003EA8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
const bully_seg5_vertex_05003F20 = [
...
export const bully_seg5_dl_05003F80 = [
...
export const bully_seg5_dl_05003FC8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
