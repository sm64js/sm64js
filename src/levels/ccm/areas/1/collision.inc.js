...
import {
    ...
    SPECIAL_OBJECT_WITH_YAW, SPECIAL_OBJECT, SPECIAL_OBJECT_WITH_YAW_AND_PARAM,
    COL_WATER_BOX_INIT, COL_WATER_BOX, COL_END,
    SURFACE_DEFAULT, SURFACE_DEATH_PLANE, SURFACE_VERY_SLIPPERY, SURFACE_SLIPPERY,
    SURFACE_WALL_MISC, SURFACE_ICE, SURFACE_HARD, SURFACE_HARD_NOT_SLIPPERY,
    SURFACE_VERTICAL_WIND, SURFACE_NOISE_VERY_SLIPPERY, SURFACE_NO_CAM_COLLISION,
    special_null_start, special_level_geo_03, special_level_geo_04, special_level_geo_05,
    special_level_geo_06, special_level_geo_07, special_snow_tree, special_wooden_door_warp
...
export const ccm_seg7_area_1_collision = [
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(21),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_null_start,       /*pos*/ -1512,  2560, -2305, /*yaw*/ 100),
