...
goog.exportSymbol('proto.sm64js.PlayerNameMsg', null, global);
...
proto.sm64js.RootMsg.prototype.setUncompressedSm64jsMsg = function(value) {
  jspb.Message.setOneofWrapperField(this, 1, proto.sm64js.RootMsg.oneofGroups_[0], value);
};


proto.sm64js.RootMsg.prototype.clearUncompressedSm64jsMsg = function() {
  this.setUncompressedSm64jsMsg(undefined);
};
...
proto.sm64js.RootMsg.prototype.setCompressedSm64jsMsg = function(value) {
  jspb.Message.setOneofField(this, 2, proto.sm64js.RootMsg.oneofGroups_[0], value);
};


proto.sm64js.RootMsg.prototype.clearCompressedSm64jsMsg = function() {
  jspb.Message.setOneofField(this, 2, proto.sm64js.RootMsg.oneofGroups_[0], undefined);
};
...
proto.sm64js.Sm64JsMsg.prototype.setPingMsg = function(value) {
  jspb.Message.setOneofWrapperField(this, 3, proto.sm64js.Sm64JsMsg.oneofGroups_[0], value);
};


proto.sm64js.Sm64JsMsg.prototype.clearPingMsg = function() {
  this.setPingMsg(undefined);
};
...
proto.sm64js.Sm64JsMsg.prototype.setMarioMsg = function(value) {
  jspb.Message.setOneofWrapperField(this, 4, proto.sm64js.Sm64JsMsg.oneofGroups_[0], value);
};


proto.sm64js.Sm64JsMsg.prototype.clearMarioMsg = function() {
  this.setMarioMsg(undefined);
};
...
proto.sm64js.Sm64JsMsg.prototype.setPlayerListsMsg = function(value) {
  jspb.Message.setOneofWrapperField(this, 5, proto.sm64js.Sm64JsMsg.oneofGroups_[0], value);
};


proto.sm64js.Sm64JsMsg.prototype.clearPlayerListsMsg = function() {
  this.setPlayerListsMsg(undefined);
};
...
proto.sm64js.Sm64JsMsg.prototype.setAttackMsg = function(value) {
  jspb.Message.setOneofWrapperField(this, 6, proto.sm64js.Sm64JsMsg.oneofGroups_[0], value);
};


proto.sm64js.Sm64JsMsg.prototype.clearAttackMsg = function() {
  this.setAttackMsg(undefined);
};
...
proto.sm64js.Sm64JsMsg.prototype.setGrabMsg = function(value) {
  jspb.Message.setOneofWrapperField(this, 7, proto.sm64js.Sm64JsMsg.oneofGroups_[0], value);
};


proto.sm64js.Sm64JsMsg.prototype.clearGrabMsg = function() {
  this.setGrabMsg(undefined);
};
...
proto.sm64js.Sm64JsMsg.prototype.setChatMsg = function(value) {
  jspb.Message.setOneofWrapperField(this, 8, proto.sm64js.Sm64JsMsg.oneofGroups_[0], value);
};


proto.sm64js.Sm64JsMsg.prototype.clearChatMsg = function() {
  this.setChatMsg(undefined);
};
...
proto.sm64js.Sm64JsMsg.prototype.clearPlayerNameMsg = function() {
  this.setPlayerNameMsg(undefined);
};
...
proto.sm64js.FlagMsg.toObject = function(includeInstance, msg) {
  var f, obj = {
    posList: jspb.Message.getRepeatedFloatingPointField(msg, 1),
    linkedtoplayer: jspb.Message.getFieldWithDefault(msg, 2, false),
    socketid: jspb.Message.getFieldWithDefault(msg, 3, 0),
    heightBeforeFall: +jspb.Message.getFieldWithDefault(msg, 4, 0.0)
  };
...
proto.sm64js.MarioMsg.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    parachuting: jspb.Message.getFieldWithDefault(msg, 21, false)
  };
 ...
 */
proto.sm64js.PlayerListsMsg.prototype.getRoomList = function() {
...
proto.sm64js.PlayerListsMsg.prototype.setRoomList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 */
proto.sm64js.PlayerListsMsg.prototype.addRoom = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.sm64js.ValidPlayersMsg, opt_index);
};


proto.sm64js.PlayerListsMsg.prototype.clearRoomList = function() {
  this.setRoomList([]);
};
...
proto.sm64js.ValidPlayersMsg.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    validplayersList: jspb.Message.getRepeatedField(msg, 2)
  };
 ...
 * @constructor
 */
proto.sm64js.PlayerNameMsg = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.sm64js.PlayerNameMsg, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.sm64js.PlayerNameMsg.displayName = 'proto.sm64js.PlayerNameMsg';
}
 ...
 * @return {!Object}
 */
proto.sm64js.PlayerNameMsg.prototype.toObject = function(opt_includeInstance) {
  return proto.sm64js.PlayerNameMsg.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sm64js.PlayerNameMsg} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sm64js.PlayerNameMsg.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.sm64js.PlayerNameMsg}
 */
proto.sm64js.PlayerNameMsg.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sm64js.PlayerNameMsg;
  return proto.sm64js.PlayerNameMsg.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sm64js.PlayerNameMsg} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sm64js.PlayerNameMsg}
 */
proto.sm64js.PlayerNameMsg.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.sm64js.PlayerNameMsg.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sm64js.PlayerNameMsg.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sm64js.PlayerNameMsg} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sm64js.PlayerNameMsg.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.sm64js.PlayerNameMsg.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.sm64js.PlayerNameMsg.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.sm64js.PlayerNameMsg.prototype.getLevel = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.sm64js.PlayerNameMsg.prototype.setLevel = function(value) {
  jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {boolean}
 */
proto.sm64js.PlayerNameMsg.prototype.getAccepted = function() {
