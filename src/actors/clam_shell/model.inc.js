...
const clam_shell_lights_unused1 = gdSPDefLights1(
    0x1b, 0x23, 0x30,
    0x6d, 0x8f, 0xc3, 0x28, 0x28, 0x28
);

// Unreferenced light group
const clam_shell_lights_unused2 = gdSPDefLights1(
    0x18, 0x28, 0x38,
...
// 0x05001030
const clam_shell_seg5_lights_05001030 = gdSPDefLights1(
    0x66, 0x66, 0x66,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05001048
const clam_shell_seg5_vertex_05001048 = [
...
// 0x050010F8
const clam_shell_seg5_vertex_050010F8 = [
...
export const clam_shell_seg5_dl_050011A8 = [
...
export const clam_shell_seg5_dl_05001238 = [
...
export const clam_shell_seg5_dl_050012B8 = [
    gsDPPipeSync(),
...
// 0x05001320
const clam_shell_seg5_lights_05001320 = gdSPDefLights1(
    0x66, 0x66, 0x66,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05001338
const clam_shell_seg5_vertex_05001338 = [
...
// 0x050013D8
const clam_shell_seg5_vertex_050013D8 = [
...
export const clam_shell_seg5_dl_05001478 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, clam_shell_seg5_texture_05000030),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const clam_shell_seg5_dl_050014F8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, clam_shell_seg5_texture_05000830),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const clam_shell_seg5_dl_05001568 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
