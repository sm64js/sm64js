...
const mario_Face_VtxInfo = { type: 0x1, data: mario_Face_VtxData };

const mario_Face_FaceInfo = { type: 0x1, data: mario_Face_FaceData };

export const dynlist_mario_face = [
    Macros.StartList(),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0xDE),
    Macros.LinkWithPtr(mario_Face_VtxInfo),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0xDF),
    Macros.LinkWithPtr(mario_Face_FaceInfo),
    Macros.StartGroup(0xE0),
    ...
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(1),
    Macros.SetAmbient(0.883, 0.602, 0.408),
    Macros.SetDiffuse(0.883, 0.602, 0.408),
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(2),
    Macros.SetAmbient(0.362, 0.0, 0.0),
    Macros.SetDiffuse(0.362, 0.0, 0.0),
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(3),
    Macros.SetAmbient(1.0, 1.0, 1.0),
    Macros.SetDiffuse(1.0, 1.0, 1.0),
    ...
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(6),
    Macros.SetAmbient(0.526, 0.0, 0.0),
    Macros.SetDiffuse(0.526, 0.0, 0.0),
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(7),
    Macros.SetAmbient(1.0, 0.0, 0.0),
    Macros.SetDiffuse(1.0, 0.0, 0.0),
    Macros.EndGroup(0xE0),
    Macros.MakeDynObj(Dynlist.D_SHAPE, 0xE1),
    Macros.SetNodeGroup(0xDE),
    Macros.SetPlaneGroup(0xDF),
    Macros.SetMaterialGroup(0xE0),
    Macros.StopList()
]