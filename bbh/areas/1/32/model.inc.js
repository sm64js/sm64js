...
const bbh_seg7_vertex_0701A008 = [
	{ pos: [ 640, -1433, 1536 ], flag: 0, tc: [ -1564, -2588 ], color: [ 255, 255, 255, 255 ] },
	{ pos: [ 640, -2354, 1536 ], flag: 0, tc: [ 3034, 2010 ], color: [ 255, 255, 255, 255 ] },
	{ pos: [ 640, -2354, 2048 ], flag: 0, tc: [ 480, 4564 ], color: [ 255, 255, 255, 255 ] },
	{ pos: [ 640, -1433, 2048 ], flag: 0, tc: [ -4118, 0 ], color: [ 255, 255, 255, 255 ] },
]

export const bbh_seg7_dl_0701A048 = [
	Gbi.gsDPSetTextureImage(Gbi.G_IM_FMT_RGBA, Gbi.G_IM_SIZ_16b, 1, spooky_09000000),
	Gbi.gsDPLoadBlock(Gbi.G_TX_LOADTILE, 0, 0, 32 * 32 - 1),
	Gbi.gsSPVertex(bbh_seg7_vertex_0701A008, 4, 0),
...
export const bbh_seg7_dl_0701A080 = [
	...
	Gbi.gsSPDisplayList(bbh_seg7_dl_0701A048),
