...
var level = "jrb" // level name in sm64ex directory
...
var inputBase = require('os').homedir() + '/sm64ex/levels/jrb/areas/1/geo.inc.c' // directory of each model file

const mydir = require('os').homedir() + '/sm64ex/levels/jrb/areas/1/'
