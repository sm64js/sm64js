import {
    gsSPVertex, gsSP2Triangles, gsSPEndDisplayList, gsDPPipeSync, gsDPSetCombineMode,
    gsSPTexture, gsSPDisplayList, gsSPSetGeometryMode,G_IM_SIZ_16b_BYTES, G_TX_RENDERTILE,
    G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE, G_IM_SIZ_16b, G_TX_LOADTILE, CALC_DXT, G_CC_MODULATERGBFADEA, G_LIGHTING, G_CULL_BACK, G_IM_FMT_RGBA, G_TX_WRAP, G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_ON, gsDPSetTextureImage, gsDPLoadSync, gsDPLoadBlock, gsSP1Triangle, gsDPSetEnvColor, gsSPClearGeometryMode, gsDPSetTile, gsDPTileSync, gsDPSetTileSize, G_TX_CLAMP
} from "../../../../../include/gbi"
