...
import { CALC_DXT, G_CC_MODULATERGB, G_CC_SHADE, G_IM_FMT_RGBA, G_IM_SIZ_16b, G_IM_SIZ_16b_BYTES, G_OFF, G_ON, G_TEXTURE_IMAGE_FRAC, G_TX_CLAMP, G_TX_LOADTILE, G_TX_NOLOD, G_TX_NOMASK, G_TX_NOMIRROR, G_TX_RENDERTILE, G_TX_WRAP, gdSPDefLights1, gsDPLoadBlock, gsDPLoadSync, gsDPPipeSync, gsDPSetCombineMode, gsDPSetTextureImage, gsDPSetTile, gsDPSetTileSize, gsDPTileSync, gsSP1Triangle, gsSP2Triangles, gsSPDisplayList, gsSPEndDisplayList, gsSPLight, gsSPTexture, gsSPVertex } from "../../include/gbi";

export const thwomp_seg5_texture_05009900 = []
export const thwomp_seg5_texture_0500A900 = []

const thwomp_seg5_lights_050098E8 = gdSPDefLights1(
    0x4c, 0x4c, 0x4c,
