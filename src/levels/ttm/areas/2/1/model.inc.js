...
import {
    mountain_09006800, mountain_0900B800, mountain_0900A800, mountain_09008800
} from "../../../../../textures/mountain"

const ttm_seg7_lights_070172D8 = gdSPDefLights1(
    0x08, 0x08, 0x08,
    0x22, 0x22, 0x22, 0x28, 0x28, 0x28
);

// 0x070172F0 - 0x07017308
const ttm_seg7_lights_070172F0 = gdSPDefLights1(
    0x0c, 0x0c, 0x0c,
    0x33, 0x33, 0x33, 0x28, 0x28, 0x28
);

// 0x07017308 - 0x07017320
const ttm_seg7_lights_07017308 = gdSPDefLights1(
    0x11, 0x11, 0x11,
    0x44, 0x44, 0x44, 0x28, 0x28, 0x28
);

// 0x07017320 - 0x07017338
const ttm_seg7_lights_07017320 = gdSPDefLights1(
    0x15, 0x15, 0x15,
    0x55, 0x55, 0x55, 0x28, 0x28, 0x28
);

// 0x07017338 - 0x07017350
const ttm_seg7_lights_07017338 = gdSPDefLights1(
    0x19, 0x19, 0x19,
    0x66, 0x66, 0x66, 0x28, 0x28, 0x28
);

// 0x07017350 - 0x07017368
const ttm_seg7_lights_07017350 = gdSPDefLights1(
    0x1d, 0x1d, 0x1d,
    0x77, 0x77, 0x77, 0x28, 0x28, 0x28
);

// 0x07017368 - 0x07017380
const ttm_seg7_lights_07017368 = gdSPDefLights1(
    0x2a, 0x2a, 0x2a,
    0xaa, 0xaa, 0xaa, 0x28, 0x28, 0x28
);

// 0x07017380 - 0x07017398
const ttm_seg7_lights_07017380 = gdSPDefLights1(
    0x2e, 0x2e, 0x2e,
    0xbb, 0xbb, 0xbb, 0x28, 0x28, 0x28
);

// 0x07017398 - 0x070173B0
const ttm_seg7_lights_07017398 = gdSPDefLights1(
    0x33, 0x33, 0x33,
    0xcc, 0xcc, 0xcc, 0x28, 0x28, 0x28
);

// 0x070173B0 - 0x070173C8
const ttm_seg7_lights_070173B0 = gdSPDefLights1(
    0x37, 0x37, 0x37,
    0xdd, 0xdd, 0xdd, 0x28, 0x28, 0x28
);

// 0x070173C8 - 0x070173E0
const ttm_seg7_lights_070173C8 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x070173E0 - 0x070173F8
const ttm_seg7_lights_070173E0 = gdSPDefLights1(
    0x22, 0x22, 0x22,
    0x88, 0x88, 0x88, 0x28, 0x28, 0x28
);

// 0x070173F8 - 0x07017410
const ttm_seg7_lights_070173F8 = gdSPDefLights1(
    0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x07017410 - 0x07017450
const ttm_seg7_vertex_07017410 = [
...
const ttm_seg7_vertex_07017450 = [
...
const ttm_seg7_vertex_070174D0 = [
...
const ttm_seg7_vertex_07017550 = [
...
const ttm_seg7_vertex_070175D0 = [
...
const ttm_seg7_vertex_07017650 = [
...
const ttm_seg7_vertex_07017690 = [
...
const ttm_seg7_vertex_07017780 = [
...
const ttm_seg7_vertex_07017870 = [
    [[ -6316,   -663,  -6317], 0, [  1018,     26], [0x2f, 0x14, 0x74, 0xff]],
    [[ -6600,   -663,  -6165], 0, [   352,    -40], [0x47, 0x10, 0x68, 0xff]],
...
const ttm_seg7_vertex_07017960 = [
    [[ -4633,   -663,  -5502], 0, [   706,     12], [0xa9, 0x0d, 0x5b, 0xff]],
    [[ -5310,   -663,  -6165], 0, [  -158,      0], [0xb7, 0x1b, 0x63, 0xff]],
...
const ttm_seg7_vertex_07017A60 = [
    [[ -5310,   -663,  -6165], 0, [  -158,      0], [0xb7, 0x1b, 0x63, 0xff]],
...
const ttm_seg7_vertex_07017AE0 = [
    [[ -6090,   -816,  -6330], 0, [   602,    832], [0x0c, 0x46, 0x68, 0xff]],
    [[ -6297,   -816,  -6270], 0, [  1044,    798], [0x28, 0x42, 0x64, 0xff]],
...
const ttm_seg7_vertex_07017BD0 = [
    [[ -6932,   -816,  -5776], 0, [   958,    144], [0x41, 0x4a, 0x4f, 0xff]],
...
const ttm_seg7_vertex_07017CC0 = [
    [[ -7222,   -919,  -5486], 0, [   706,    132], [0x3b, 0x41, 0x5b, 0xff]],
    [[ -8127,  -1380,  -4653], 0, [   -72,    120], [0x3d, 0x38, 0x5f, 0xff]],
...
const ttm_seg7_vertex_07017D60 = [
    [[ -6238,   -970,  -6128], 0, [  1074,    392], [0x18, 0x6c, 0x3e, 0xff]],
    [[ -6481,   -970,  -5999], 0, [   504,    336], [0x2c, 0x66, 0x3c, 0xff]],
...
const ttm_seg7_vertex_07017E50 = [
    [[ -3660,   -614,  -4529], 0, [    64,    156], [0xbe, 0x69, 0x15, 0xff]],
    [[ -4452,   -919,  -5249], 0, [  1068,    184], [0xbc, 0x5a, 0x38, 0xff]],
...
const ttm_seg7_vertex_07017F30 = [
...
const ttm_seg7_vertex_07017FC0 = [
...
const ttm_seg7_vertex_070180C0 = [
    [[  -177,   2068,    112], 0, [   758,    990], [0x28, 0x53, 0xaa, 0xff]],
...
const ttm_seg7_vertex_070181C0 = [
...
const ttm_seg7_vertex_070182C0 = [
    [[  2719,   3656,   3008], 0, [   928,    990], [0x28, 0x53, 0xaa, 0xff]],
...
const ttm_seg7_vertex_070183C0 = [
    [[  3696,   3860,   3986], 0, [   740,    990], [0x22, 0x67, 0xbf, 0xff]],
...
const ttm_seg7_vertex_070184C0 = [
    [[  5036,   4321,   4167], 0, [   464,      0], [0xb3, 0x57, 0x31, 0xff]],
    [[  4312,   4270,   4601], 0, [   332,    990], [0x39, 0x49, 0xaa, 0xff]],
...
const ttm_seg7_vertex_070185C0 = [
    [[ -5869,  -1021,  -6027], 0, [   424,    398], [0xfe, 0x7d, 0x10, 0xff]],
    [[ -5967,  -1021,  -5572], 0, [   912,    -24], [0x00, 0x7f, 0x00, 0xff]],
...
const ttm_seg7_vertex_070186C0 = [
...
const ttm_seg7_vertex_070187C0 = [
    [[ -7548,  -1533,  -4074], 0, [    -6,     88], [0xe5, 0x7b, 0x0a, 0xff]],
    [[ -8019,  -1533,  -4545], 0, [    14,    858], [0x0a, 0x6d, 0x3f, 0xff]],
    [[ -8562,  -1636,  -4219], 0, [   660,   1002], [0x02, 0x78, 0x29, 0xff]],
];
...
const ttm_seg7_vertex_070187F0 = [
...
const ttm_seg7_vertex_07018830 = [
...
const ttm_seg7_vertex_07018870 = [
...
const ttm_seg7_vertex_07018970 = [
...
const ttm_seg7_vertex_07018A60 = [
...
const ttm_seg7_vertex_07018B10 = [
    [[  2960,   4269,   3105], 0, [  1052,      0], [0x37, 0x9d, 0xc8, 0xff]],
    [[  3033,   4269,   3177], 0, [  1052,    990], [0x64, 0xc0, 0x2b, 0xff]],
...
const ttm_seg7_vertex_07018C00 = [
    [[    62,   2681,    207], 0, [  1052,      0], [0x38, 0x9e, 0xc8, 0xff]],
    [[   135,   2681,    279], 0, [  1052,    990], [0x62, 0xb6, 0x1d, 0xff]],
...
const ttm_seg7_vertex_07018CF0 = [
...
const ttm_seg7_vertex_07018D30 = [
...
const ttm_seg7_vertex_07018E20 = [
    [[    26,   2630,    243], 0, [  1776,      0], [0x4b, 0xbc, 0xb5, 0xff]],
...
const ttm_seg7_vertex_07018ED0 = [
...
const ttm_seg7_vertex_07018FD0 = [
...
const ttm_seg7_vertex_070190B0 = [
...
const ttm_seg7_vertex_070191A0 = [
    [[  -177,   2068,    112], 0, [  1584,    990], [0x28, 0x53, 0xaa, 0xff]],
...
const ttm_seg7_vertex_07019280 = [
...
const ttm_seg7_vertex_07019370 = [
...
const ttm_seg7_vertex_07019460 = [
...
const ttm_seg7_vertex_07019550 = [
...
const ttm_seg7_vertex_07019640 = [
...
const ttm_seg7_vertex_07019730 = [
...
const ttm_seg7_vertex_07019820 = [
...
const ttm_seg7_vertex_07019910 = [
...
const ttm_seg7_vertex_07019A00 = [
...
const ttm_seg7_vertex_07019B00 = [
...
const ttm_seg7_vertex_07019BF0 = [
    [[  4601,   4014,   3732], 0, [     0,    990], [0x9f, 0x4b, 0x1d, 0xff]],
    [[  4501,   4058,   3632], 0, [  1040,      0], [0xa7, 0x52, 0x25, 0xff]],
...
const ttm_seg7_vertex_07019CD0 = [
...
const ttm_seg7_vertex_07019DC0 = [
...
const ttm_seg7_vertex_07019EB0 = [
...
const ttm_seg7_vertex_07019FA0 = [
...
const ttm_seg7_vertex_0701A090 = [
...
const ttm_seg7_vertex_0701A180 = [
...
const ttm_seg7_vertex_0701A270 = [
...
const ttm_seg7_vertex_0701A2F0 = [
...
const ttm_seg7_vertex_0701A330 = [
...
const ttm_seg7_vertex_0701A410 = [
...
const ttm_seg7_vertex_0701A500 = [
...
const ttm_seg7_vertex_0701A5F0 = [
...
const ttm_seg7_vertex_0701A6E0 = [
...
const ttm_seg7_vertex_0701A7D0 = [
...
const ttm_seg7_vertex_0701A8C0 = [
...
const ttm_seg7_vertex_0701A9B0 = [
...
const ttm_seg7_vertex_0701AA70 = [
...
const ttm_seg7_vertex_0701AB50 = [
...
const ttm_seg7_vertex_0701ABD0 = [
...
const ttm_seg7_vertex_0701ACC0 = [
...
const ttm_seg7_vertex_0701ADB0 = [
...
const ttm_seg7_vertex_0701AEA0 = [
    [[  4827,   4314,   3813], 0, [ -3780,      0], [0xe0, 0x76, 0xe0, 0xff]],
...
const ttm_seg7_vertex_0701AFA0 = [
    [[  4472,   4010,   3459], 0, [  5912,      0], [0xe8, 0x7a, 0xe8, 0xff]],
...
const ttm_seg7_vertex_0701B0A0 = [
    [[  3459,   3805,   2445], 0, [  3064,      0], [0xe7, 0x79, 0xe6, 0xff]],
...
const ttm_seg7_vertex_0701B1A0 = [
    [[  2916,   3344,   1902], 0, [ -4036,      0], [0xe9, 0x7a, 0xe8, 0xff]],
...
const ttm_seg7_vertex_0701B2A0 = [
    [[  1142,   2372,    128], 0, [  4196,      0], [0xe9, 0x7a, 0xe8, 0xff]],
...
const ttm_seg7_vertex_0701B3A0 = [
...
const ttm_seg7_vertex_0701B4A0 = [
    [[  -634,   1259,   -345], 0, [     0,    990], [0xf9, 0x41, 0x94, 0xff]],
    [[  -763,   1180,   -328], 0, [  1072,      0], [0xc8, 0x62, 0xc8, 0xff]],
...
const ttm_seg7_vertex_0701B5A0 = [
...
const ttm_seg7_vertex_0701B6A0 = [
    [[   591,   2419,    880], 0, [     0,    990], [0x28, 0x53, 0xaa, 0xff]],
    [[   417,   2372,    852], 0, [  1460,      0], [0xe6, 0x79, 0xe7, 0xff]],
...
const ttm_seg7_vertex_0701B7A0 = [
    [[  2264,   3344,   2553], 0, [  1464,    990], [0x2e, 0x56, 0xb0, 0xff]],
    [[  2054,   3296,   2488], 0, [  3468,      0], [0xee, 0x7c, 0xee, 0xff]],
...
const ttm_seg7_vertex_0701B8A0 = [
...
const ttm_seg7_vertex_0701B990 = [
...
const ttm_seg7_vertex_0701BA90 = [
    [[  4088,   4252,   4377], 0, [  1344,    990], [0x0c, 0x51, 0xa0, 0xff]],
...
const ttm_seg7_vertex_0701BB90 = [
...
const ttm_seg7_vertex_0701BC90 = [
    [[  6396,   4781,   6397], 0, [  3036,   5076], [0xd8, 0x00, 0x88, 0xff]],
...
const ttm_seg7_vertex_0701BD90 = [
...
const ttm_seg7_vertex_0701BE00 = [
...
export const ttm_seg7_dl_0701D798 = [
    gsDPPipeSync(),
