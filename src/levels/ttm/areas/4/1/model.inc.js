...
import {
    mountain_0900B800, mountain_0900A800, mountain_09008800
} from "../../../../../textures/mountain"

const ttm_seg7_lights_07025FF0 = gdSPDefLights1(
    0x15, 0x15, 0x15,
    0x55, 0x55, 0x55, 0x28, 0x28, 0x28
);

// 0x07026008 - 0x07026020
const ttm_seg7_lights_07026008 = gdSPDefLights1(
    0x19, 0x19, 0x19,
    0x66, 0x66, 0x66, 0x28, 0x28, 0x28
);

// 0x07026020 - 0x07026038
const ttm_seg7_lights_07026020 = gdSPDefLights1(
    0x1d, 0x1d, 0x1d,
    0x77, 0x77, 0x77, 0x28, 0x28, 0x28
);

// 0x07026038 - 0x07026050
const ttm_seg7_lights_07026038 = gdSPDefLights1(
    0x22, 0x22, 0x22,
    0x88, 0x88, 0x88, 0x28, 0x28, 0x28
);

// 0x07026050 - 0x07026068
const ttm_seg7_lights_07026050 = gdSPDefLights1(
    0x26, 0x26, 0x26,
    0x99, 0x99, 0x99, 0x28, 0x28, 0x28
);

// 0x07026068 - 0x07026080
const ttm_seg7_lights_07026068 = gdSPDefLights1(
    0x2a, 0x2a, 0x2a,
    0xaa, 0xaa, 0xaa, 0x28, 0x28, 0x28
);

// 0x07026080 - 0x07026098
const ttm_seg7_lights_07026080 = gdSPDefLights1(
    0x2e, 0x2e, 0x2e,
    0xbb, 0xbb, 0xbb, 0x28, 0x28, 0x28
);

// 0x07026098 - 0x070260B0
const ttm_seg7_lights_07026098 = gdSPDefLights1(
    0x33, 0x33, 0x33,
    0xcc, 0xcc, 0xcc, 0x28, 0x28, 0x28
);

// 0x070260B0 - 0x070260C8
const ttm_seg7_lights_070260B0 = gdSPDefLights1(
    0x37, 0x37, 0x37,
    0xdd, 0xdd, 0xdd, 0x28, 0x28, 0x28
);

// 0x070260C8 - 0x070260E0
const ttm_seg7_lights_070260C8 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x070260E0 - 0x070260F8
const ttm_seg7_lights_070260E0 = gdSPDefLights1(
    0x11, 0x11, 0x11,
    0x44, 0x44, 0x44, 0x28, 0x28, 0x28
);

// 0x070260F8 - 0x07026110
const ttm_seg7_lights_070260F8 = gdSPDefLights1(
    0x3b, 0x3b, 0x3b,
    0xee, 0xee, 0xee, 0x28, 0x28, 0x28
);

// 0x07026110 - 0x07026128
const ttm_seg7_lights_07026110 = gdSPDefLights1(
    0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x07026128 - 0x07026228
const ttm_seg7_vertex_07026128 = [
...
const ttm_seg7_vertex_07026228 = [
...
const ttm_seg7_vertex_07026328 = [
...
const ttm_seg7_vertex_07026428 = [
...
const ttm_seg7_vertex_070264A8 = [
...
const ttm_seg7_vertex_07026568 = [
...
const ttm_seg7_vertex_07026668 = [
...
const ttm_seg7_vertex_07026758 = [
    [[ -5157,   5325,   2359], 0, [   -26,    866], [0x1f, 0x75, 0x24, 0xff]],
    [[ -5635,   5428,   2478], 0, [   950,    864], [0x28, 0x73, 0x22, 0xff]],
    [[ -5422,   5428,   3054], 0, [   950,     98], [0x0f, 0x72, 0xcb, 0xff]],
    [[ -5082,   5325,   2969], 0, [   244,    100], [0x14, 0x6e, 0xc5, 0xff]],
...
const ttm_seg7_vertex_07026848 = [
    [[   600,   3654,   2865], 0, [   -46,    824], [0x21, 0x60, 0xb5, 0xff]],
    [[  -613,   4023,   2691], 0, [   962,    858], [0x27, 0x72, 0xdb, 0xff]],
    [[  -613,   4418,   3162], 0, [   962,     92], [0x11, 0x39, 0x91, 0xff]],
    [[   600,   4186,   3172], 0, [     8,    112], [0x03, 0x10, 0x83, 0xff]],
...
const ttm_seg7_vertex_07026928 = [
    [[ -6161,   5735,   3793], 0, [   244,     98], [0xe1, 0x72, 0xd3, 0xff]],
    [[ -6737,   5735,   3580], 0, [   -26,    866], [0x34, 0x73, 0xf8, 0xff]],
    [[ -6246,   5837,   4133], 0, [   950,     98], [0xd7, 0x72, 0xdd, 0xff]],
    [[ -6963,   6144,   5120], 0, [     0,    990], [0x72, 0x37, 0xf9, 0xff]],
...
const ttm_seg7_vertex_07026998 = [
...
const ttm_seg7_vertex_07026A38 = [
...
const ttm_seg7_vertex_07026AB8 = [
...
const ttm_seg7_vertex_07026BA8 = [
...
const ttm_seg7_vertex_07026C98 = [
...
const ttm_seg7_vertex_07026D98 = [
...
const ttm_seg7_vertex_07026E78 = [
...
const ttm_seg7_vertex_07026EB8 = [
...
const ttm_seg7_vertex_07026FB8 = [
...
const ttm_seg7_vertex_070270B8 = [
...
const ttm_seg7_vertex_070271A8 = [
...
const ttm_seg7_vertex_07027288 = [
...
const ttm_seg7_vertex_07027388 = [
...
const ttm_seg7_vertex_07027488 = [
...
const ttm_seg7_vertex_07027588 = [
...
const ttm_seg7_vertex_07027668 = [
...
const ttm_seg7_vertex_07027758 = [
...
const ttm_seg7_vertex_07027838 = [
    [[  7051,   1923,  -1124], 0, [   -40,    406], [0xe9, 0x7b, 0xec, 0xff]],
...
const ttm_seg7_vertex_07027928 = [
    [[  6968,   2384,   1942], 0, [  -724,    388], [0xf4, 0x7c, 0xe8, 0xff]],
    [[  6378,   2435,   1973], 0, [   990,    990], [0x0d, 0x7c, 0xe9, 0xff]],
    [[  6802,   2435,   2279], 0, [   882,    396], [0xfc, 0x7b, 0xe5, 0xff]],
    [[  6802,   2435,   2279], 0, [ -1196,    378], [0xfc, 0x7b, 0xe5, 0xff]],
...
const ttm_seg7_vertex_07027A08 = [
    [[  6495,   1513,  -3812], 0, [  -258,    394], [0xe7, 0x7c, 0x00, 0xff]],
...
const ttm_seg7_vertex_07027AF8 = [
...
const ttm_seg7_vertex_07027BA8 = [
...
const ttm_seg7_vertex_07027BE8 = [
...
const ttm_seg7_vertex_07027CD8 = [
...
const ttm_seg7_vertex_07027DC8 = [
...
const ttm_seg7_vertex_07027E38 = [
...
const ttm_seg7_vertex_07027EB8 = [
...
const ttm_seg7_vertex_07027FB8 = [
...
const ttm_seg7_vertex_070280A8 = [
...
const ttm_seg7_vertex_07028148 = [
...
const ttm_seg7_vertex_07028248 = [
...
const ttm_seg7_vertex_07028328 = [
...
const ttm_seg7_vertex_07028408 = [
...
const ttm_seg7_vertex_07028508 = [
    [[ -7489,   -841,  -3787], 0, [ 10188,  -4120], [0x54, 0xd6, 0xac, 0xff]],
...
const ttm_seg7_vertex_07028578 = [
    [[ -6065,   6452,   3829], 0, [  1264,    100], [0x8f, 0xd1, 0xe1, 0xff]],
...
const ttm_seg7_vertex_07028668 = [
...
const ttm_seg7_vertex_07028718 = [
...
const ttm_seg7_vertex_07028818 = [
...
const ttm_seg7_vertex_07028918 = [
...
const ttm_seg7_vertex_07028A08 = [
    [[ -6575,   6349,   3039], 0, [  2052,    126], [0x5d, 0xd0, 0x47, 0xff]],
    [[ -6833,   6452,   3545], 0, [   976,    144], [0x6c, 0xd0, 0x2d, 0xff]],
...
const ttm_seg7_vertex_07028AF8 = [
    [[ -5169,   6042,   2258], 0, [  2052,    122], [0x05, 0xca, 0x72, 0xff]],
    [[ -5670,   6144,   2382], 0, [  1412,    138], [0x24, 0xd1, 0x6f, 0xff]],
...
const ttm_seg7_vertex_07028BF8 = [
    [[ -5169,   6042,   2258], 0, [  2052,    122], [0x05, 0xca, 0x72, 0xff]],
    [[ -5670,   5530,   2382], 0, [  1372,   1004], [0x2d, 0x2f, 0x6c, 0xff]],
...
const ttm_seg7_vertex_07028C78 = [
    [[ -6065,   5837,   3829], 0, [  1324,    974], [0x96, 0x2f, 0xcf, 0xff]],
...
const ttm_seg7_vertex_07028D78 = [
    [[ -6963,   6144,   5120], 0, [     0,    990], [0x72, 0x37, 0xf9, 0xff]],
    [[ -6957,   6554,   4046], 0, [  2028,    130], [0x73, 0xd0, 0x13, 0xff]],
    [[ -6963,   6759,   5120], 0, [   -16,    130], [0x78, 0xda, 0x05, 0xff]],
    [[  1829,   3365,   2290], 0, [  2044,    126], [0x1e, 0x65, 0x45, 0xff]],
...
const ttm_seg7_vertex_07028E78 = [
...
const ttm_seg7_vertex_07028F68 = [
    [[  3058,   3817,   2971], 0, [     0,    990], [0x37, 0x94, 0xdd, 0xff]],
    [[  1829,   4065,   3037], 0, [  2012,    990], [0xe4, 0x9b, 0xba, 0xff]],
    [[  1829,   4172,   2432], 0, [  2040,    130], [0xdc, 0x89, 0x17, 0xff]],
    [[  3058,   3817,   2356], 0, [   -36,    124], [0x52, 0xaa, 0x2c, 0xff]],
...
const ttm_seg7_vertex_07029028 = [
...
const ttm_seg7_vertex_07029128 = [
...
export const ttm_seg7_dl_0702A1B8 = [
    gsDPPipeSync(),
