...
import {
    gdSPDefLights1, gsSPLight, gsSPVertex, gsSP2Triangles, gsSP1Triangle, gsSPEndDisplayList,
    gsDPSetTextureImage, gsDPLoadSync, gsDPLoadBlock, gsDPPipeSync, gsDPSetCombineMode,
    ...
    G_TX_RENDERTILE, G_ON, G_TX_CLAMP, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE, G_IM_FMT_RGBA,
    G_CC_MODULATERGB
} from "../../include/gbi"
...
// 0x0800E088
export const flyguy_seg8_texture_0800E088 = []
// actors/flyguy/flyguy_cloth_wrinkle.rgba16.png

// 0x0800F088
export const flyguy_seg8_texture_0800F088 = []
// actors/flyguy/flyguy_face.rgba16.png

// 0x0800F888
export const flyguy_seg8_texture_0800F888 = []
// actors/flyguy/flyguy_propeller.ia16.png

// Unreferenced light group
const flyguy_lights_unused1 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x080100A0
const flyguy_seg8_lights_080100A0 = gdSPDefLights1(
    0x00, 0x1f, 0x33,
    0x02, 0x7f, 0xcc, 0x28, 0x28, 0x28
);

// 0x080100B8
const flyguy_seg8_lights_080100B8 = gdSPDefLights1(
    0x3f, 0x32, 0x08,
    0xff, 0xc8, 0x23, 0x28, 0x28, 0x28
);

// Unreferenced light group
const flyguy_lights_unused2 = gdSPDefLights1(
    0x3a, 0x2f, 0x04,
    0xe8, 0xbd, 0x13, 0x28, 0x28, 0x28
);

// Unreferenced light group
const flyguy_lights_unused3 = gdSPDefLights1(
    0x2c, 0x00, 0x00,
    0xb2, 0x00, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const flyguy_lights_unused4 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// Unreferenced light group
const flyguy_lights_unused5 = gdSPDefLights1(
    0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x08010130
const flyguy_seg8_vertex_08010130 = [
...
// 0x08010230
const flyguy_seg8_vertex_08010230 = [
    [[    82,     19,     44], 0, [     0,      0], [0x16, 0x7c, 0x00, 0xff]],
...
// 0x08010330
const flyguy_seg8_vertex_08010330 = [
    [[     5,     18,     30], 0, [     0,      0], [0xca, 0xba, 0x5a, 0xff]],
...
// 0x08010430
const flyguy_seg8_vertex_08010430 = [
    [[   103,     -2,     20], 0, [     0,      0], [0x65, 0xc5, 0x2f, 0xff]],
...
// 0x08010460
const flyguy_seg8_vertex_08010460 = [
    [[   107,     14,    -20], 0, [     0,      0], [0x6a, 0xeb, 0xbf, 0x00]],
    [[   107,     14,     20], 0, [     0,      0], [0x6a, 0xeb, 0x41, 0x00]],
...
// 0x08010560
const flyguy_seg8_vertex_08010560 = [
    [[     8,     31,    -34], 0, [     0,      0], [0xc6, 0xf2, 0x90, 0xff]],
...
// 0x08010640
const flyguy_seg8_vertex_08010640 = [
    [[    82,     19,     44], 0, [     0,      0], [0x16, 0x7c, 0x00, 0xff]],
    [[   107,     14,     20], 0, [     0,      0], [0x18, 0x7c, 0x00, 0x00]],
    [[   107,     14,    -20], 0, [     0,      0], [0x18, 0x7c, 0x00, 0x00]],
    [[    82,     19,    -44], 0, [     0,      0], [0x16, 0x7c, 0x00, 0xff]],
...
// 0x08010740
const flyguy_seg8_vertex_08010740 = [
    [[     5,     18,    -30], 0, [     0,      0], [0xca, 0xba, 0xa6, 0xff]],
    [[    83,      1,    -40], 0, [     0,      0], [0x29, 0xca, 0x95, 0x00]],
...
// 0x08010770
const flyguy_seg8_vertex_08010770 = [
...
export const flyguy_seg8_dl_08010840 = [
...
export const flyguy_seg8_dl_08010968 = [
    gsSPLight(flyguy_seg8_lights_080100A0.l, 1),
    gsSPLight(flyguy_seg8_lights_080100A0.a, 2),
...
export const flyguy_seg8_dl_08010A90 = [
...
// 0x08010AE0
const flyguy_seg8_lights_08010AE0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x08010AF8
const flyguy_seg8_vertex_08010AF8 = [
...
export const flyguy_seg8_dl_08010B38 = [
...
export const flyguy_seg8_dl_08010B80 = [
    gsDPPipeSync(),
...
// 0x08010BF0
const flyguy_seg8_lights_08010BF0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x08010C08
const flyguy_seg8_lights_08010C08 = gdSPDefLights1(
    0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x08010C20
const flyguy_seg8_lights_08010C20 = gdSPDefLights1(
    0x62, 0x00, 0x13,
    0xc4, 0x00, 0x26, 0x28, 0x28, 0x28
);

// 0x08010C38
const flyguy_seg8_vertex_08010C38 = [
...
// 0x08010CC8
const flyguy_seg8_vertex_08010CC8 = [
...
// 0x08010D28
const flyguy_seg8_vertex_08010D28 = [
...
// 0x08010E08
const flyguy_seg8_vertex_08010E08 = [
...
// 0x08010F08
const flyguy_seg8_vertex_08010F08 = [
    [[     0,    117,      0], 0, [  -940,    334], [0xfd, 0x7e, 0x00, 0xff]],
    [[    56,    100,     68], 0, [  -764,    128], [0xf4, 0x64, 0x4c, 0xff]],
...
// 0x08011008
const flyguy_seg8_vertex_08011008 = [
    [[    61,    -61,    -81], 0, [   356,    330], [0x16, 0xb7, 0x9b, 0xff]],
    [[   -28,   -165,      0], 0, [   964,    828], [0xff, 0x82, 0x00, 0xff]],
...
// 0x080110F8
const flyguy_seg8_vertex_080110F8 = [
    [[   -45,    -22,    112], 0, [     0,    700], [0xb4, 0xf8, 0x64, 0xff]],
...
// 0x080111F8
const flyguy_seg8_vertex_080111F8 = [
    [[   239,    -50,    -61], 0, [   860,    578], [0x62, 0xdd, 0xb9, 0xff]],
    [[   232,     24,    -75], 0, [   780,    360], [0x54, 0x10, 0xa3, 0xff]],
...
// 0x080112D8
const flyguy_seg8_vertex_080112D8 = [
    [[   126,     73,    100], 0, [  1272,    212], [0xf3, 0x1d, 0x7a, 0xff]],
...
// 0x08011348
const flyguy_seg8_vertex_08011348 = [
...
export const flyguy_seg8_dl_080113A8 = [
...
export const flyguy_seg8_dl_08011420 = [
...
export const flyguy_seg8_dl_080116D0 = [
    gsSPLight(flyguy_seg8_lights_08010C08.l, 1),
    gsSPLight(flyguy_seg8_lights_08010C08.a, 2),
...
export const flyguy_seg8_dl_08011710 = [
    gsDPPipeSync(),
