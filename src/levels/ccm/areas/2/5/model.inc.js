...
const ccm_seg7_lights_0701FCD8 = Gbi.gdSPDefLights1(
	    0x3f, 0x3f, 0x3f,
	    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

const ccm_seg7_vertex_0701FCF0 = [
...
export const ccm_seg7_dl_0701FD30 = [
	Gbi.gsDPSetTextureImage(Gbi.G_IM_FMT_RGBA, Gbi.G_IM_SIZ_16b, 1, snow_09004000),
	Gbi.gsDPLoadBlock(Gbi.G_TX_LOADTILE, 0, 0, 32 * 32 - 1),
	Gbi.gsSPLight(ccm_seg7_lights_0701FCD8.l[0], 1),
	Gbi.gsSPLight(ccm_seg7_lights_0701FCD8.a, 2),
	Gbi.gsSPVertex(ccm_seg7_vertex_0701FCF0, 4, 0),
	...Gbi.gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
	Gbi.gsSPEndDisplayList(),
]

export const ccm_seg7_dl_0701FD78 = [
	...
	Gbi.gsSPDisplayList(ccm_seg7_dl_0701FD30),
