...
import {
    ...
    gsDPSetEnvColor, gsSPClearGeometryMode, gsDPSetCombineMode, gsSPDisplayList,
    gsSPSetGeometryMode, gsSPLight, gsSPBranchList, gsDPSetTextureImage, gsDPLoadSync,
    gsDPLoadBlock, gsDPSetTile, gsSPTexture, gsDPTileSync, gsDPSetTileSize,
    G_SHADING_SMOOTH, G_CC_SHADEFADEA, G_CC_SHADE, G_IM_FMT_RGBA, G_IM_SIZ_16b, CALC_DXT,
    G_TX_LOADTILE, G_IM_SIZ_16b_BYTES, G_CC_DECALRGBA, G_LIGHTING, G_CULL_BACK, G_TX_WRAP,
    G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_RENDERTILE, G_ON, G_TX_CLAMP,
    G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_MODULATERGBA
} from "../../include/gbi"

// 0x08024CB8
const exclamation_box_outline_seg8_lights_08024CB8 = gdSPDefLights1(
    0x7f, 0x00, 0x00,
    0xff, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x08024CD0
const exclamation_box_outline_seg8_lights_08024CD0 = gdSPDefLights1(
    0x00, 0x7f, 0x00,
    0x00, 0xff, 0x00, 0x28, 0x28, 0x28
);

// 0x08024CE8
const exclamation_box_outline_seg8_lights_08024CE8 = gdSPDefLights1(
    0x00, 0x00, 0x7f,
    0x00, 0x00, 0xff, 0x28, 0x28, 0x28
);

// 0x08024D00
const exclamation_box_outline_seg8_lights_08024D00 = gdSPDefLights1(
    0x7f, 0x6a, 0x00,
...
// 0x08025168
export const exclamation_box_outline_seg8_texture_08025168 = []
...
// 0x08025A68
const exclamation_box_outline_seg8_lights_08025A68 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x08025A80
export const exclamation_box_outline_seg8_texture_08025A80 = []
