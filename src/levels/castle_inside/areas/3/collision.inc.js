...
import {
    ...
    COL_SPECIAL_INIT, SPECIAL_OBJECT_WITH_YAW, SPECIAL_OBJECT_WITH_YAW_AND_PARAM,
    COL_WATER_BOX_INIT, COL_WATER_BOX, COL_END,
    SURFACE_DEFAULT, SURFACE_FLOWING_WATER, SURFACE_VERY_SLIPPERY, SURFACE_NOT_SLIPPERY,
    SURFACE_WALL_MISC, SURFACE_CAMERA_BOUNDARY, SURFACE_NO_CAM_COLLISION,
    SURFACE_PAINTING_WOBBLE_B2, SURFACE_PAINTING_WOBBLE_B3, SURFACE_PAINTING_WOBBLE_B4,
    SURFACE_PAINTING_WOBBLE_B5, SURFACE_PAINTING_WOBBLE_B6, SURFACE_PAINTING_WOBBLE_B7,
    SURFACE_PAINTING_WOBBLE_BB, SURFACE_PAINTING_WOBBLE_D0, SURFACE_PAINTING_WARP_DF,
    SURFACE_PAINTING_WARP_E0, SURFACE_PAINTING_WARP_E1, SURFACE_PAINTING_WARP_E2,
    SURFACE_PAINTING_WARP_E3, SURFACE_PAINTING_WARP_E4, SURFACE_WOBBLING_WARP,
    SURFACE_PAINTING_WARP_E8, SURFACE_PAINTING_WARP_E9, SURFACE_PAINTING_WARP_EA,
    special_wooden_door, special_0stars_door, special_metal_door_warp
} from "../../../../include/surface_terrains"

// 0x07073AAC - 0x070775B4
export const inside_castle_seg7_area_3_collision = [
    COL_INIT(),
...
export const inside_castle_seg7_collision_ddd_warp = [
    COL_INIT(),
...
export const inside_castle_seg7_collision_ddd_warp_2 = [
    COL_INIT(),
    COL_VERTEX_INIT(0x12),
    COL_VERTEX(5939, -1074, 1587),
