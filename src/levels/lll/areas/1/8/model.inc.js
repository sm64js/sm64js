...
import {
    ...
    G_TX_CLAMP, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE, G_CC_MODULATERGBA, G_CULL_BACK
} from "../../../../../include/gbi"
import {
    fire_09006800, fire_09006000, fire_09000800
} from "../../../../../textures/fire"

import { lll_seg7_lights_0700FC00 } from "../light.inc"

// 0x070154F8 - 0x070155E8
const lll_seg7_vertex_070154F8 = [
...
const lll_seg7_vertex_070155E8 = [
...
const lll_seg7_vertex_070156E8 = [
    [[   640,      0,   -127], 0, [  -604,    990], [0x81, 0x00, 0x00, 0xff]],
    [[   640,    307,      0], 0, [  -286,    224], [0x81, 0x00, 0x00, 0xff]],
...
const lll_seg7_vertex_07015758 = [
...
const lll_seg7_vertex_07015858 = [
...
const lll_seg7_vertex_07015948 = [
...
const lll_seg7_vertex_07015A38 = [
...
export const lll_seg7_dl_07015C88 = [
    gsDPPipeSync(),
...
export const lll_seg7_dl_07015E20 = [
    gsDPPipeSync(),
