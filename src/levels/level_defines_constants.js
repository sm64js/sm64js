...
export const UNKNOWN_1        = 1
export const UNKNOWN_2        = 2
export const UNKNOWN_3        = 3
export const BBH              = 4
export const CCM              = 5
export const CASTLE           = 6
export const HMC              = 7
export const SSL              = 8
export const BOB              = 9
export const SL               = 10
...
export const BITDW            = 17
export const VCUTM            = 18
export const BITFS            = 19
export const SA               = 20
export const BITS             = 21
export const LLL              = 22
export const DDD              = 23
export const WF               = 24
export const ENDING           = 25
export const CASTLE_COURTYARD = 26
export const PSS              = 27
export const COTMC            = 28
export const TOTWC            = 29
export const BOWSER_1         = 30
export const WMOTR            = 31
export const UNKNOWN_32       = 32
export const BOWSER_2         = 33
export const BOWSER_3         = 34
export const UNKNOWN_35       = 35
export const TTM              = 36
export const UNKNOWN_37       = 37
export const UNKNOWN_38       = 38

export const CCS              = 56
export const CCM_2            = 57

export const CASTLE_2         = 602
