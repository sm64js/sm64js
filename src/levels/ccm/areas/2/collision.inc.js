...
import {
    ...
    SURFACE_DEFAULT, SURFACE_DEATH_PLANE, SURFACE_ICE, SURFACE_NO_CAM_COL_SLIPPERY,
    special_null_start, special_wooden_door_warp
...
export const ccm_seg7_area_2_collision = [
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(2),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_null_start,       /*pos*/ -5836,  7465, -6143, /*yaw*/ 64),
