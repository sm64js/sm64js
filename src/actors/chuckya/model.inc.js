...
import {
    ...
    gsSPTexture, gsDPTileSync, gsDPSetTileSize, gsSPDisplayList, gsSPSetGeometryMode, gsSPLight,
    gsSP1Triangle,
    ...
    G_TX_CLAMP, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE, G_CC_MODULATERGBA, G_SHADING_SMOOTH
} from "../../include/gbi"

// Unreferenced light group
const chuckya_lights_unused1 = gdSPDefLights1(
    0x26, 0x00, 0x27,
    0x9a, 0x00, 0x9c, 0x28, 0x28, 0x28
);

// Unreferenced light group
const chuckya_lights_unused2 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// Unreferenced light group
const chuckya_lights_unused3 = gdSPDefLights1(
    0x3f, 0x00, 0x00,
    0xff, 0x00, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const chuckya_lights_unused4 = gdSPDefLights1(
    0x0e, 0x0e, 0x0e,
    0x39, 0x39, 0x39, 0x28, 0x28, 0x28
);

// Unreferenced light group
const chuckya_lights_unused5 = gdSPDefLights1(
    0x39, 0x20, 0x00,
    0xe4, 0x83, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const chuckya_lights_unused6 = gdSPDefLights1(
    0x3f, 0x27, 0x00,
    0xff, 0x9e, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const chuckya_lights_unused7 = gdSPDefLights1(
    0x15, 0x14, 0x16,
    0x57, 0x53, 0x58, 0x28, 0x28, 0x28
);

// 0x08006778
export const chuckya_seg8_texture_08006778 = []
// actors/chuckya/chuckya_eyes.rgba16.png

// 0x08007778
export const chuckya_seg8_texture_08007778 = []
// actors/chuckya/chuckya_hand_antenna.rgba16.png

// 0x08007F78
export const chuckya_seg8_texture_08007F78 = []
// actors/chuckya/chuckya_body_arm_left_side.rgba16.png

// 0x08008F78
export const chuckya_seg8_texture_08008F78 = []
// actors/chuckya/chuckya_body_arm_right_side.rgba16.png

// 0x08009F78
const chuckya_seg8_vertex_08009F78 = [
...
// 0x08009FB8
const chuckya_seg8_vertex_08009FB8 = [
...
export const chuckya_seg8_dl_08009FF8 = [
...
export const chuckya_seg8_dl_0800A030 = [
...
export const chuckya_seg8_dl_0800A068 = [
    gsDPPipeSync(),
...
// 0x0800A0E0
const chuckya_seg8_vertex_0800A0E0 = [
...
// 0x0800A120
const chuckya_seg8_vertex_0800A120 = [
...
export const chuckya_seg8_dl_0800A160 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chuckya_seg8_texture_08007F78),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const chuckya_seg8_dl_0800A198 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chuckya_seg8_texture_08008F78),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const chuckya_seg8_dl_0800A1D0 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x0800A248
const chuckya_seg8_vertex_0800A248 = [
    [[     0,     13,      0], 0, [   990,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   -13,    -13,      0], 0, [     0,   2012], [0xff, 0xff, 0xff, 0xff]],
    [[     0,    -13,      0], 0, [   990,   2012], [0xff, 0xff, 0xff, 0xff]],
    [[   -13,     13,      0], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]],
...
// 0x0800A288
const chuckya_seg8_vertex_0800A288 = [
    [[    13,     13,      0], 0, [   990,      0], [0xff, 0xff, 0xff, 0xff]],
    [[     0,    -13,      0], 0, [     0,   2012], [0xff, 0xff, 0xff, 0xff]],
    [[    13,    -13,      0], 0, [   990,   2012], [0xff, 0xff, 0xff, 0xff]],
    [[     0,     13,      0], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]],
...
export const chuckya_seg8_dl_0800A2C8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chuckya_seg8_texture_08007F78),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const chuckya_seg8_dl_0800A300 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chuckya_seg8_texture_08008F78),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const chuckya_seg8_dl_0800A338 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x0800A3B0
const chuckya_seg8_vertex_0800A3B0 = [
...
export const chuckya_seg8_dl_0800A3F0 = [
...
export const chuckya_seg8_dl_0800A428 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x0800A498
const chuckya_seg8_vertex_0800A498 = [
    [[    23,     23,      0], 0, [   990,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   -22,     23,      0], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   -22,    -22,      0], 0, [     0,    990], [0xff, 0xff, 0xff, 0xff]],
    [[    23,    -22,      0], 0, [   990,    990], [0xff, 0xff, 0xff, 0xff]],
...
export const chuckya_seg8_dl_0800A4D8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chuckya_seg8_texture_08007778),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const chuckya_seg8_dl_0800A510 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x0800A580
const chuckya_seg8_vertex_0800A580 = [
...
export const chuckya_seg8_dl_0800A5C0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chuckya_seg8_texture_08007778),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const chuckya_seg8_dl_0800A5F8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x0800A668
const chuckya_seg8_lights_0800A668 = gdSPDefLights1(
    0x66, 0x66, 0x66,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0800A680
const chuckya_seg8_vertex_0800A680 = [
...
export const chuckya_seg8_dl_0800A700 = [
...
export const chuckya_seg8_dl_0800A758 = [
    gsDPPipeSync(),
...
// 0x0800A7C8
const chuckya_seg8_lights_0800A7C8 = gdSPDefLights1(
    0x29, 0x29, 0x29,
    0x89, 0x89, 0x8a, 0x28, 0x28, 0x28
);

// 0x0800A7E0
const chuckya_seg8_vertex_0800A7E0 = [
...
export const chuckya_seg8_dl_0800A870 = [
...
export const chuckya_seg8_dl_0800A8D0 = [
    gsDPPipeSync(),
...
// 0x0800A8F0
const chuckya_seg8_lights_0800A8F0 = gdSPDefLights1(
    0x4c, 0x4c, 0x00,
    0xff, 0xff, 0x00, 0x28, 0x28, 0x28
);

// 0x0800A908
const chuckya_seg8_vertex_0800A908 = [
...
export const chuckya_seg8_dl_0800A958 = [
...
export const chuckya_seg8_dl_0800A998 = [
    gsDPPipeSync(),
...
// 0x0800A9B8
const chuckya_seg8_lights_0800A9B8 = gdSPDefLights1(
    0x0c, 0x0c, 0x0c,
    0x32, 0x32, 0x32, 0x28, 0x28, 0x28
);

// 0x0800A9D0
const chuckya_seg8_vertex_0800A9D0 = [
...
// 0x0800AAC0
const chuckya_seg8_vertex_0800AAC0 = [
...
export const chuckya_seg8_dl_0800AB70 = [
...
export const chuckya_seg8_dl_0800ABE8 = [
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_SHADING_SMOOTH),
