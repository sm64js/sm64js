import { CALC_DXT, G_CC_DECALRGBA, G_CC_SHADE, G_CULL_BACK, G_IM_FMT_RGBA, G_IM_SIZ_16b, G_IM_SIZ_16b_BYTES, G_LIGHTING, G_OFF, G_ON, G_TEXTURE_IMAGE_FRAC, G_TX_CLAMP, G_TX_LOADTILE, G_TX_NOLOD, G_TX_NOMASK, G_TX_NOMIRROR, G_TX_RENDERTILE, G_TX_WRAP, gdSPDefLights1, gsDPLoadBlock, gsDPLoadSync, gsDPPipeSync, gsDPSetCombineMode, gsDPSetTextureImage, gsDPSetTile, gsDPSetTileSize, gsDPTileSync, gsSP2Triangles, gsSPClearGeometryMode, gsSPDisplayList, gsSPEndDisplayList, gsSPLight, gsSPSetGeometryMode, gsSPTexture, gsSPVertex } from "../../include/gbi"

// Unreferenced light group
const scuttlebug_lights_unused1 = gdSPDefLights1(
    0x2c, 0x00, 0x00,
    0xb2, 0x00, 0x00, 0x28, 0x28, 0x28
)

// Unreferenced light group
const scuttlebug_lights_unused2 = gdSPDefLights1(
    0x00, 0x00, 0x00,
...
// 0x06013908
const scuttlebug_seg6_vertex_06013908= [
...
// 0x06013948
const scuttlebug_seg6_vertex_06013948= [
...
export const scuttlebug_seg6_dl_06013988= [
...
export const scuttlebug_seg6_dl_060139C0= [
...
export const scuttlebug_seg6_dl_060139F8= [
    gsDPPipeSync(),
...
// 0x06013A70
const scuttlebug_seg6_vertex_06013A70= [
...
export const scuttlebug_seg6_dl_06013AB0= [
...
export const scuttlebug_seg6_dl_06013AE8= [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x06013B58
const scuttlebug_seg6_vertex_06013B58= [
    [[    15,     15,      0], 0, [   990,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   -15,     15,      0], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   -15,    -15,      0], 0, [     0,    990], [0xff, 0xff, 0xff, 0xff]],
    [[    15,    -15,      0], 0, [   990,    990], [0xff, 0xff, 0xff, 0xff]],
...
export const scuttlebug_seg6_dl_06013B98= [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, scuttlebug_seg6_texture_06010108),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const scuttlebug_seg6_dl_06013BD0= [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x06013C40
const scuttlebug_seg6_vertex_06013C40= [
...
export const scuttlebug_seg6_dl_06013C80= [
...
export const scuttlebug_seg6_dl_06013CB8= [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x06013D28
const scuttlebug_seg6_vertex_06013D28= [
...
export const scuttlebug_seg6_dl_06013D68= [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, scuttlebug_seg6_texture_06012908),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const scuttlebug_seg6_dl_06013DA0= [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x06013E10
const scuttlebug_seg6_lights_06013E10 = gdSPDefLights1(
    0x33, 0x22, 0x01,
    0xcf, 0x89, 0x06, 0x28, 0x28, 0x28
)

// 0x06013E28
const scuttlebug_seg6_vertex_06013E28= [
...
// 0x06013F28
const scuttlebug_seg6_vertex_06013F28= [
    [[  -103,     89,    199], 0, [     0,      0], [0x7c, 0xee, 0xf3, 0xff]],
...
export const scuttlebug_seg6_dl_06013FC8= [
...
export const scuttlebug_seg6_dl_060140F0= [
    gsDPPipeSync(),
...
// 0x06014110
const scuttlebug_seg6_vertex_06014110= [
...
export const scuttlebug_seg6_dl_06014150= [
...
export const scuttlebug_seg6_dl_06014188= [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
...
// 0x060141F8
const scuttlebug_seg6_vertex_060141F8= [
...
export const scuttlebug_seg6_dl_06014238= [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, scuttlebug_seg6_texture_06013108),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const scuttlebug_seg6_dl_06014270= [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING | G_CULL_BACK),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x060142E0
const scuttlebug_seg6_lights_060142E0 = gdSPDefLights1(
    0x26, 0x05, 0x05,
    0x99, 0x16, 0x16, 0x28, 0x28, 0x28
)

// 0x060142F8
const scuttlebug_seg6_vertex_060142F8= [
...
export const scuttlebug_seg6_dl_06014338 = [
...
export const scuttlebug_seg6_dl_06014378 = [
    gsDPPipeSync(),
