...
const facedata_mario_eye_right = [
...
const vtx_mario_eye_right = { type: 0x1, data: verts_mario_eye_right }

const faces_mario_eye_right = { type: 0x1, data: facedata_mario_eye_right }


export const dynlist_mario_eye_right = [
    Macros.StartList(),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0x71),
    Macros.LinkWithPtr(vtx_mario_eye_right),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0x72),
    Macros.LinkWithPtr(faces_mario_eye_right),
    Macros.StartGroup(0x73),
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(0),
    Macros.SetAmbient(0.0, 0.291, 1.0),
    Macros.SetDiffuse(0.0, 0.291, 1.0),
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(1),
    Macros.SetAmbient(0.0, 0.576, 1.0),
    Macros.SetDiffuse(0.0, 0.576, 1.0),
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(2),
    ...
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(3),
    Macros.SetAmbient(1.0, 1.0, 1.0),
    Macros.SetDiffuse(1.0, 1.0, 1.0),
    Macros.EndGroup(0x73),
    Macros.MakeDynObj(Dynlist.D_SHAPE, 0x74),
    Macros.SetNodeGroup(0x71),
    Macros.SetPlaneGroup(0x72),
    Macros.SetMaterialGroup(0x73),
    Macros.StopList(),
]

const verts_mario_eye_left = [
...
const vtx_mario_eye_left = { type: 0x1, data: verts_mario_eye_left }

const faces_mario_eye_left = { type: 0x1, data: facedata_mario_eye_left }

export const dynlist_mario_eye_left = [
    Macros.StartList(),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0x61),
    Macros.LinkWithPtr(vtx_mario_eye_left),
    Macros.MakeDynObj(Dynlist.D_DATA_GRP, 0x62),
    Macros.LinkWithPtr(faces_mario_eye_left),
    Macros.StartGroup(0x63),
    Macros.MakeDynObj(Dynlist.D_MATERIAL, 0x0),
    Macros.SetId(0),
    Macros.SetAmbient(0.0, 0.291, 1.0),
    Macros.SetDiffuse(0.0, 0.291, 1.0),
    ...
    Macros.SetAmbient(1.0, 1.0, 1.0),
    Macros.SetDiffuse(1.0, 1.0, 1.0),
    Macros.EndGroup(0x63),
    Macros.MakeDynObj(Dynlist.D_SHAPE, 0x64),
    Macros.SetNodeGroup(0x61),
    Macros.SetPlaneGroup(0x62),
    Macros.SetMaterialGroup(0x63),
    Macros.StopList(),
]