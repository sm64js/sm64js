...
import {
    ...
    WARP_NODE, INSTANT_WARP, TERRAIN, MACRO_OBJECTS, SET_BACKGROUND_MUSIC, TERRAIN_TYPE, END_AREA,
    MARIO_POS, CALL, CALL_LOOP, CLEAR_LEVEL, SLEEP_BEFORE_EXIT, EXIT
} from "../../engine/LevelCommands"

import {
    MODEL_WDW_SQUARE_FLOATING_PLATFORM, MODEL_WDW_ARROW_LIFT, MODEL_NONE,
    MODEL_WDW_WATER_LEVEL_DIAMOND, MODEL_PURPLE_SWITCH, MODEL_WDW_HIDDEN_PLATFORM,
    MODEL_WDW_EXPRESS_ELEVATOR, MODEL_WDW_RECTANGULAR_FLOATING_PLATFORM,
    MODEL_WDW_ROTATING_PLATFORM, MODEL_SKEETER, MODEL_STAR, MODEL_MARIO, MODEL_WDW_BUBBLY_TREE
...
import { wdw_geo_0005E8 } from "./hidden_platform/geo.inc"

import { wdw_geo_000610 } from "./express_elevator/geo.inc"

import { wdw_geo_000628 } from "./rectangular_floating_platform/geo.inc"

import { wdw_geo_000640 } from "./rotating_platform/geo.inc"

import { wdw_geo_000658 } from "./areas/1/geo.inc"

import {
    LEVEL_WDW, LEVEL_CASTLE
} from "../level_defines_constants"

import { WARP_NO_CHECKPOINT } from "../../engine/LevelCommands"

import { wdw_seg7_area_1_collision } from "./areas/1/collision.inc"

import { wdw_seg7_area_1_macro_objs } from "./areas/1/macro.inc"
...
import { wdw_geo_000724 } from "./areas/2/geo.inc"

import { wdw_seg7_area_2_collision } from "./areas/2/collision.inc"

import { wdw_seg7_area_2_macro_objs } from "./areas/2/macro.inc"
...
import { wdw_geo_000580 } from "./square_floating_platform/geo.inc"

import { wdw_geo_0005C0 } from "./water_level_diamond/geo.inc"
...
export const level_wdw_entry = [
    ...
    AREA(/*index*/ 2,  wdw_geo_000724),
        ...
        WARP_NODE(/*id*/ 0xF0,  /*destLevel*/ LEVEL_CASTLE,  /*destArea*/ 0x02,  /*destNode*/ 0x32,  /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0xF1,  /*destLevel*/ LEVEL_CASTLE,  /*destArea*/ 0x02,  /*destNode*/ 0x64,  /*flags*/ WARP_NO_CHECKPOINT),
        INSTANT_WARP(/*index*/ 2,  /*destArea*/ 1,  /*displace*/ 0,  0,  0),
...
gLinker.level_scripts.level_wdw_entry = level_wdw_entry
