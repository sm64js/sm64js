...
import {
    ...
    G_RM_AA_ZB_TEX_EDGE2, G_CC_DECALRGBA, G_LIGHTING, G_RM_AA_ZB_TEX_EDGE
} from '../../include/gbi'

// 0x06009BA0
export const dorrie_seg6_texture_06009BA0 = []  // "actors/dorrie/dorrie_eye.rgba16.inc.c"

// 0x06009DA0
export const dorrie_seg6_texture_06009DA0 = []  // "actors/dorrie/dorrie_skin.rgba16.inc.c"

// 0x0600ADA0
export const dorrie_seg6_texture_0600ADA0 = []  // "actors/dorrie/dorrie_tongue.rgba16.inc.c"

// 0x0600B5A0
const dorrie_seg6_lights_0600B5A0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x0600B5B8
const dorrie_seg6_vertex_0600B5B8 = [
...
// 0x0600B618
const dorrie_seg6_vertex_0600B618 = [
...
// 0x0600B718
const dorrie_seg6_vertex_0600B718 = [
    [[   778,    532,    166], 0, [   466,    796], [0x6b, 0x25, 0x38, 0xff]],
    [[   349,    372,    482], 0, [   388,    948], [0x2c, 0x14, 0x75, 0xff]],
...
// 0x0600B808
const dorrie_seg6_vertex_0600B808 = [
    [[    91,     29,   -516], 0, [   628,   1228], [0xf2, 0xe8, 0x85, 0xff]],
...
export const dorrie_seg6_dl_0600B8E8 = [
...
export const dorrie_seg6_dl_0600B940 = [
...
export const dorrie_seg6_dl_0600BAF8 = [
    gsDPPipeSync(),
...
// 0x0600BBC0
const dorrie_seg6_lights_0600BBC0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x0600BBD8
const dorrie_seg6_vertex_0600BBD8 = [
...
// 0x0600BC98
const dorrie_seg6_vertex_0600BC98 = [
...
// 0x0600BD98
const dorrie_seg6_vertex_0600BD98 = [
    [[   498,    236,   -165], 0, [     0,   1120], [0x41, 0x64, 0xd7, 0xff]],
...
export const dorrie_seg6_dl_0600BE68 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dorrie_seg6_texture_0600ADA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const dorrie_seg6_dl_0600BF10 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dorrie_seg6_texture_06009DA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const dorrie_seg6_dl_0600C030 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0600C0F8
const dorrie_seg6_lights_0600C0F8 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x0600C110
const dorrie_seg6_vertex_0600C110 = [
...
// 0x0600C210
const dorrie_seg6_vertex_0600C210 = [
    [[  1090,    -93,   -205], 0, [   612,    144], [0x5c, 0xe0, 0xaf, 0xff]],
    [[   852,   -373,   -231], 0, [   558,    336], [0x3f, 0x98, 0xdf, 0xff]],
...
export const dorrie_seg6_dl_0600C310 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dorrie_seg6_texture_06009DA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const dorrie_seg6_dl_0600C468 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0600C510
const dorrie_seg6_lights_0600C510 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x0600C528
const dorrie_seg6_vertex_0600C528 = [
...
// 0x0600C628
const dorrie_seg6_vertex_0600C628 = [
...
// 0x0600C728
const dorrie_seg6_vertex_0600C728 = [
    [[   899,   -211,    569], 0, [  1306,    920], [0x3f, 0xef, 0x6c, 0xff]],
...
export const dorrie_seg6_dl_0600C758 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dorrie_seg6_texture_06009DA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const dorrie_seg6_dl_0600C8B8 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0600C960
const dorrie_seg6_lights_0600C960 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x0600C978
const dorrie_seg6_vertex_0600C978 = [
...
// 0x0600CA68
const dorrie_seg6_vertex_0600CA68 = [
...
// 0x0600CB58
const dorrie_seg6_vertex_0600CB58 = [
    [[   560,    718,  -1192], 0, [   830,    992], [0x18, 0x34, 0x90, 0xff]],
...
// 0x0600CC58
const dorrie_seg6_vertex_0600CC58 = [
    [[  -765,    228,   1204], 0, [   114,   1888], [0xc2, 0x11, 0x6c, 0xff]],
    [[ -1340,   -279,    694], 0, [    88,   2356], [0x8a, 0x19, 0x26, 0xff]],
    [[  -975,   -982,    549], 0, [   232,   2348], [0xac, 0xb1, 0x34, 0xff]],
    [[  -860,    411,   -776], 0, [   894,   1888], [0xae, 0x5e, 0xee, 0xff]],
...
// 0x0600CD58
const dorrie_seg6_vertex_0600CD58 = [
    [[  1832,    492,   -639], 0, [   742,    332], [0x64, 0x31, 0xc4, 0xff]],
    [[  1573,    878,    611], 0, [  1134,    368], [0x4c, 0x5b, 0x2b, 0xff]],
...
export const dorrie_seg6_dl_0600CDE8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dorrie_seg6_texture_06009DA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const dorrie_seg6_dl_0600CFD0 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0600D078
const dorrie_seg6_lights_0600D078 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x0600D090
const dorrie_seg6_vertex_0600D090 = [
...
// 0x0600D180
const dorrie_seg6_vertex_0600D180 = [
    [[   218,   -509,      5], 0, [   996,   1416], [0x00, 0x82, 0xfc, 0xff]],
...
// 0x0600D280
const dorrie_seg6_vertex_0600D280 = [
    [[  1312,   -229,   -372], 0, [   816,   1836], [0x3d, 0xb9, 0xac, 0xff]],
    [[   241,    413,   -661], 0, [   656,   1388], [0x17, 0x46, 0x9a, 0xff]],
    [[  1263,    236,   -372], 0, [   636,   1796], [0x46, 0x31, 0xa3, 0xff]],
    [[  1568,   -185,      4], 0, [   992,   1936], [0x68, 0xbd, 0xe6, 0xff]],
...
export const dorrie_seg6_dl_0600D300 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dorrie_seg6_texture_06009DA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const dorrie_seg6_dl_0600D440 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0600D4E8
const dorrie_seg6_lights_0600D4E8 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x0600D500
const dorrie_seg6_vertex_0600D500 = [
...
// 0x0600D5F0
const dorrie_seg6_vertex_0600D5F0 = [
    [[  1443,      8,      5], 0, [   502,   2084], [0x7e, 0xf8, 0x00, 0xff]],
...
export const dorrie_seg6_dl_0600D620 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dorrie_seg6_texture_06009DA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const dorrie_seg6_dl_0600D6D8 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0600D780
const dorrie_seg6_lights_0600D780 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x0600D798
const dorrie_seg6_vertex_0600D798 = [
...
export const dorrie_seg6_dl_0600D818 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dorrie_seg6_texture_06009DA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const dorrie_seg6_dl_0600D8B0 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0600D958
const dorrie_seg6_lights_0600D958 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x0600D970
const dorrie_seg6_vertex_0600D970 = [
...
export const dorrie_seg6_dl_0600D9F0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dorrie_seg6_texture_06009DA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const dorrie_seg6_dl_0600DA88 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0600DB30
const dorrie_seg6_lights_0600DB30 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x0600DB48
const dorrie_seg6_vertex_0600DB48 = [
...
export const dorrie_seg6_dl_0600DBC8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dorrie_seg6_texture_06009DA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const dorrie_seg6_dl_0600DC60 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0600DD08
const dorrie_seg6_lights_0600DD08 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
)

// 0x0600DD20
const dorrie_seg6_vertex_0600DD20 = [
...
export const dorrie_seg6_dl_0600DDA0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, dorrie_seg6_texture_06009DA0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 64 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const dorrie_seg6_dl_0600DE38 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0600DEE0
const dorrie_seg6_vertex_0600DEE0 = [
...
export const dorrie_seg6_dl_0600DF60 = [
...
export const dorrie_seg6_dl_0600DFA8 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
