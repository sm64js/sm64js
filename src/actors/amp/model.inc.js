...
import {
    ...
    gdSPDefLights1, gsSPLight, gsSP1Triangle,
...
// 0x08000F18
export const amp_seg8_texture_08000F18 = []
// actors/amp/amp_electricity.rgba16.png

// 0x08001318
export const amp_seg8_texture_08001318 = []
// actors/amp/amp_eyes.rgba16.png

// 0x08001B18
export const amp_seg8_texture_08001B18 = []
// actors/amp/amp_body.rgba16.png

// 0x08002318
export const amp_seg8_texture_08002318 = []
// actors/amp/amp_mouth.rgba16.png

// 0x08002B18
const amp_seg8_vertex_08002B18 = [
...
export const amp_seg8_dl_08002B68 = [
...
export const amp_seg8_dl_08002BA0 = [
    gsDPPipeSync(),
...
// 0x08002C10
const amp_seg8_vertex_08002C10 = [
...
export const amp_seg8_dl_08002C50 = [
...
export const amp_seg8_dl_08002C88 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
...
// 0x08002CF8
const amp_seg8_vertex_08002CF8 = [
...
export const amp_seg8_dl_08002D38 = [
...
export const amp_seg8_dl_08002D70 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x08002DE0
const amp_seg8_vertex_08002DE0 = [
...
export const amp_seg8_dl_08002E20 = [
...
export const amp_seg8_dl_08002E58 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x08002EC8
const amp_seg8_lights_08002EC8 = gdSPDefLights1(
    0x33, 0x3f, 0x00,
    0xcf, 0xff, 0x00, 0x28, 0x28, 0x28
);

// For js, dupe previous light, rename with memory address below, and fix up in the Gfxes.
const amp_seg8_lights_08002EE0 = gdSPDefLights1(
    0x33, 0x3f, 0x00,
    0xcf, 0xff, 0x00, 0x28, 0x28, 0x28
);
...
// 0x08002EE0
const amp_seg8_vertex_08002EE0 = [
...
// 0x08002F40
const amp_seg8_vertex_08002F40 = [
    [[   280,      0,     35], 0, [     0,      0], [0x7b, 0xe2, 0x00, 0x00]],
    [[   240,   -160,      0], 0, [     0,      0], [0x7b, 0xe2, 0x00, 0x00]],
    [[   280,      0,    -35], 0, [     0,      0], [0x7b, 0xe2, 0x00, 0x00]],
    [[   280,      0,    -35], 0, [     0,      0], [0x7b, 0x1e, 0x00, 0xff]],
...
// 0x08002FA0
const amp_seg8_vertex_08002FA0 = [
    [[   280,      0,     35], 0, [     0,      0], [0x7b, 0xe2, 0x00, 0x00]],
    [[   240,   -160,      0], 0, [     0,      0], [0x7b, 0xe2, 0x00, 0x00]],
    [[   280,      0,    -35], 0, [     0,      0], [0x7b, 0xe2, 0x00, 0x00]],
    [[   280,      0,    -35], 0, [     0,      0], [0x7b, 0x1e, 0x00, 0xff]],
...
// 0x08003000
const amp_seg8_vertex_08003000 = [
...
// 0x08003060
const amp_seg8_vertex_08003060 = [
...
// 0x08003160
const amp_seg8_vertex_08003160 = [
...
// 0x08003260
const amp_seg8_vertex_08003260 = [
...
// 0x08003360
const amp_seg8_vertex_08003360 = [
...
// 0x08003460
const amp_seg8_vertex_08003460 = [
...
// 0x08003560
const amp_seg8_vertex_08003560 = [
...
// 0x08003660
const amp_seg8_vertex_08003660 = [
...
// 0x08003760
const amp_seg8_vertex_08003760 = [
...
// 0x08003860
const amp_seg8_vertex_08003860 = [
...
// 0x080038A0
const amp_seg8_vertex_080038A0 = [
...
// 0x080038D0
const amp_seg8_vertex_080038D0 = [
...
export const amp_seg8_dl_08003910 = [
...
export const amp_seg8_dl_08003940 = [
    gsSPLight(amp_seg8_lights_08002EC8.l, 1),
    gsSPLight(amp_seg8_lights_08002EC8.a, 2),
...
export const amp_seg8_dl_08003970 = [
    gsSPLight(amp_seg8_lights_08002EC8.l, 1),
    gsSPLight(amp_seg8_lights_08002EC8.a, 2),
...
export const amp_seg8_dl_080039A0 = [
    gsSPLight(amp_seg8_lights_08002EC8.l, 1),
    gsSPLight(amp_seg8_lights_08002EC8.a, 2),
...
export const amp_seg8_dl_080039D0 = [
    gsSPLight(amp_seg8_lights_08002EE0.l, 1),           // fixed
    gsSPLight(amp_seg8_lights_08002EE0.a, 2),           // fixed
...
export const amp_seg8_dl_08003DA8 = [
    gsSPLight(amp_seg8_lights_08002EE0.l, 1),           // fixed
    gsSPLight(amp_seg8_lights_08002EE0.a, 2),           // fixed
...
export const amp_seg8_dl_08003DD8 = [
    gsSPLight(amp_seg8_lights_08002EE0.l, 1),           // fixed
    gsSPLight(amp_seg8_lights_08002EE0.a, 2),           // fixed
...
export const amp_seg8_dl_08003E00 = [
    gsSPLight(amp_seg8_lights_08002EE0.l, 1),           // fixed
    gsSPLight(amp_seg8_lights_08002EE0.a, 2),           // fixed
