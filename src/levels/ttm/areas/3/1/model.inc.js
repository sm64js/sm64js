...
import {
    mountain_09006800, mountain_0900B800, mountain_09007000, mountain_09008800, mountain_09000800
} from "../../../../../textures/mountain"

const ttm_seg7_lights_0701DC60 = gdSPDefLights1(
    0x08, 0x08, 0x08,
    0x22, 0x22, 0x22, 0x28, 0x28, 0x28
);

// 0x0701DC78 - 0x0701DC90
const ttm_seg7_lights_0701DC78 = gdSPDefLights1(
    0x0c, 0x0c, 0x0c,
    0x33, 0x33, 0x33, 0x28, 0x28, 0x28
);

// 0x0701DC90 - 0x0701DCA8
const ttm_seg7_lights_0701DC90 = gdSPDefLights1(
    0x11, 0x11, 0x11,
    0x44, 0x44, 0x44, 0x28, 0x28, 0x28
);

// 0x0701DCA8 - 0x0701DCC0
const ttm_seg7_lights_0701DCA8 = gdSPDefLights1(
    0x15, 0x15, 0x15,
    0x55, 0x55, 0x55, 0x28, 0x28, 0x28
);

// 0x0701DCC0 - 0x0701DCD8
const ttm_seg7_lights_0701DCC0 = gdSPDefLights1(
    0x19, 0x19, 0x19,
    0x66, 0x66, 0x66, 0x28, 0x28, 0x28
);

// 0x0701DCD8 - 0x0701DCF0
const ttm_seg7_lights_0701DCD8 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0701DCF0 - 0x0701DD08
const ttm_seg7_lights_0701DCF0 = gdSPDefLights1(
    0x1d, 0x1d, 0x1d,
    0x77, 0x77, 0x77, 0x28, 0x28, 0x28
);

// 0x0701DD08 - 0x0701DD20
const ttm_seg7_lights_0701DD08 = gdSPDefLights1(
    0x22, 0x22, 0x22,
    0x88, 0x88, 0x88, 0x28, 0x28, 0x28
);

// 0x0701DD20 - 0x0701DD38
const ttm_seg7_lights_0701DD20 = gdSPDefLights1(
    0x26, 0x26, 0x26,
    0x99, 0x99, 0x99, 0x28, 0x28, 0x28
);

// 0x0701DD38 - 0x0701DD50
const ttm_seg7_lights_0701DD38 = gdSPDefLights1(
    0x2a, 0x2a, 0x2a,
    0xaa, 0xaa, 0xaa, 0x28, 0x28, 0x28
);

// 0x0701DD50 - 0x0701DD68
const ttm_seg7_lights_0701DD50 = gdSPDefLights1(
    0x2e, 0x2e, 0x2e,
    0xbb, 0xbb, 0xbb, 0x28, 0x28, 0x28
);

// 0x0701DD68 - 0x0701DD80
const ttm_seg7_lights_0701DD68 = gdSPDefLights1(
    0x33, 0x33, 0x33,
    0xcc, 0xcc, 0xcc, 0x28, 0x28, 0x28
);

// 0x0701DD80 - 0x0701DD98
const ttm_seg7_lights_0701DD80 = gdSPDefLights1(
    0x37, 0x37, 0x37,
    0xdd, 0xdd, 0xdd, 0x28, 0x28, 0x28
);

// 0x0701DD98 - 0x0701DDB0
const ttm_seg7_lights_0701DD98 = gdSPDefLights1(
    0x3b, 0x3b, 0x3b,
    0xee, 0xee, 0xee, 0x28, 0x28, 0x28
);

// 0x0701DDB0 - 0x0701DDC8
const ttm_seg7_lights_0701DDB0 = gdSPDefLights1(
    0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x0701DDC8 - 0x0701DE08
const ttm_seg7_vertex_0701DDC8 = [
...
const ttm_seg7_vertex_0701DE08 = [
...
const ttm_seg7_vertex_0701DE88 = [
...
const ttm_seg7_vertex_0701DF08 = [
...
const ttm_seg7_vertex_0701DF88 = [
...
const ttm_seg7_vertex_0701E008 = [
...
const ttm_seg7_vertex_0701E0F8 = [
...
const ttm_seg7_vertex_0701E1E8 = [
...
const ttm_seg7_vertex_0701E2E8 = [
...
const ttm_seg7_vertex_0701E3E8 = [
...
const ttm_seg7_vertex_0701E4E8 = [
...
const ttm_seg7_vertex_0701E5E8 = [
...
const ttm_seg7_vertex_0701E668 = [
...
const ttm_seg7_vertex_0701E728 = [
    [[ 10650,  -9288,   -380], 0, [   -48,    828], [0x27, 0x72, 0xdb, 0xff]],
    [[  9421,  -8640,     25], 0, [   960,     94], [0x1c, 0x59, 0xab, 0xff]],
    [[ 10650,  -8893,     90], 0, [     8,    104], [0x11, 0x39, 0x91, 0xff]],
...
const ttm_seg7_vertex_0701E828 = [
...
const ttm_seg7_vertex_0701E918 = [
...
const ttm_seg7_vertex_0701EA08 = [
    [[  5270,  -7679,    386], 0, [   272,    104], [0xf1, 0x72, 0xcb, 0xff]],
    [[  4771,  -7679,     27], 0, [   -16,    866], [0x34, 0x73, 0x06, 0xff]],
    [[  5102,  -7576,    721], 0, [   958,     98], [0xe1, 0x72, 0xd3, 0xff]],
    [[  4526,  -7576,    508], 0, [   958,    864], [0x34, 0x73, 0xf8, 0xff]],
...
const ttm_seg7_vertex_0701EA48 = [
    [[ 11864,  -9657,   -206], 0, [   -46,    824], [0x21, 0x60, 0xb5, 0xff]],
    [[ 10650,  -9288,   -380], 0, [   962,    858], [0x27, 0x72, 0xdb, 0xff]],
    [[ 10650,  -8893,     90], 0, [   962,     92], [0x11, 0x39, 0x91, 0xff]],
    [[ 11864,  -9125,    100], 0, [     8,    112], [0x03, 0x10, 0x83, 0xff]],
...
const ttm_seg7_vertex_0701EB28 = [
    [[  5102,  -7576,    721], 0, [   244,     98], [0xe1, 0x72, 0xd3, 0xff]],
    [[  4526,  -7576,    508], 0, [   -26,    866], [0x34, 0x73, 0xf8, 0xff]],
    [[  5017,  -7474,   1061], 0, [   950,     98], [0xd7, 0x72, 0xdd, 0xff]],
    [[  4300,  -7167,   2048], 0, [     0,    990], [0x72, 0x37, 0xf9, 0xff]],
...
const ttm_seg7_vertex_0701EB98 = [
...
const ttm_seg7_vertex_0701EC38 = [
...
const ttm_seg7_vertex_0701ED28 = [
...
const ttm_seg7_vertex_0701EE18 = [
...
const ttm_seg7_vertex_0701EE98 = [
    [[  3922,   6505,   3922], 0, [  1018,     26], [0x2f, 0x14, 0x74, 0xff]],
...
const ttm_seg7_vertex_0701EF88 = [
    [[  5605,   6505,   4737], 0, [   706,     12], [0xa9, 0x0d, 0x5b, 0xff]],
    [[  4929,   6505,   4074], 0, [  -158,      0], [0xb7, 0x1b, 0x63, 0xff]],
...
const ttm_seg7_vertex_0701F088 = [
...
const ttm_seg7_vertex_0701F0F8 = [
    [[  4418,   6351,   3909], 0, [    78,    798], [0xef, 0x48, 0x67, 0xff]],
    [[  4149,   6351,   3909], 0, [   602,    832], [0x0c, 0x46, 0x68, 0xff]],
...
const ttm_seg7_vertex_0701F1E8 = [
    [[  3306,   6351,   4463], 0, [   958,    144], [0x41, 0x4a, 0x4f, 0xff]],
    [[  3016,   6249,   4753], 0, [   706,    132], [0x3b, 0x41, 0x5b, 0xff]],
...
const ttm_seg7_vertex_0701F2D8 = [
...
const ttm_seg7_vertex_0701F3C8 = [
...
const ttm_seg7_vertex_0701F4B8 = [
...
const ttm_seg7_vertex_0701F5A8 = [
...
const ttm_seg7_vertex_0701F6A8 = [
...
const ttm_seg7_vertex_0701F798 = [
    [[ -4241,    -89,  -7202], 0, [   990,      0], [0x31, 0x38, 0x66, 0xff]],
    [[ -5419,    -89,  -6497], 0, [  -182,    186], [0x39, 0x5f, 0x3c, 0xff]],
...
const ttm_seg7_vertex_0701F898 = [
    [[  4278,  -6540,   7049], 0, [    86,    796], [0xd9, 0x59, 0xaf, 0xff]],
...
const ttm_seg7_vertex_0701F978 = [
...
const ttm_seg7_vertex_0701FA58 = [
...
const ttm_seg7_vertex_0701FB48 = [
    [[  -220,   -601,  -6989], 0, [   990,      0], [0xca, 0x38, 0x63, 0xff]],
...
const ttm_seg7_vertex_0701FC38 = [
...
const ttm_seg7_vertex_0701FCE8 = [
    [[  4001,   6198,   4111], 0, [  1074,    392], [0x18, 0x6c, 0x3e, 0xff]],
...
const ttm_seg7_vertex_0701FDD8 = [
    [[  6578,   6554,   5710], 0, [    64,    156], [0xbe, 0x69, 0x15, 0xff]],
    [[  5786,   6249,   4990], 0, [  1068,    184], [0xbc, 0x5a, 0x38, 0xff]],
...
const ttm_seg7_vertex_0701FED8 = [
    [[  5786,   6249,   4990], 0, [   978,    198], [0xbc, 0x5a, 0x38, 0xff]],
...
const ttm_seg7_vertex_0701FFC8 = [
    [[   860,   5371,   7271], 0, [   222,     96], [0xed, 0x67, 0xb9, 0xff]],
...
const ttm_seg7_vertex_070200C8 = [
...
const ttm_seg7_vertex_070201A8 = [
    [[ -4795,   4211,   7293], 0, [  -312,     90], [0x06, 0x52, 0xa1, 0xff]],
...
const ttm_seg7_vertex_07020298 = [
    [[ -5419,    -89,  -6497], 0, [  1014,    168], [0x39, 0x5f, 0x3c, 0xff]],
    [[ -6502,    115,  -5413], 0, [  -180,    184], [0x49, 0x60, 0x26, 0xff]],
...
const ttm_seg7_vertex_07020388 = [
    [[ -4208,   -293,  -7105], 0, [  1018,    166], [0x27, 0x5f, 0x49, 0xff]],
...
const ttm_seg7_vertex_07020478 = [
...
const ttm_seg7_vertex_07020568 = [
    [[  5120,  -7052,   4338], 0, [   990,    990], [0xd2, 0x75, 0xf3, 0xff]],
...
const ttm_seg7_vertex_07020648 = [
...
const ttm_seg7_vertex_07020738 = [
    [[  -279,   -805,  -6906], 0, [  1144,    160], [0xe0, 0x66, 0x44, 0xff]],
    [[  -860,   -754,  -7202], 0, [   -20,    276], [0xea, 0x5f, 0x50, 0xff]],
...
const ttm_seg7_vertex_07020828 = [
    [[ -3022,   -498,  -7345], 0, [  1022,    164], [0x15, 0x5f, 0x50, 0xff]],
    [[ -4208,   -293,  -7105], 0, [  -154,    182], [0x27, 0x5f, 0x49, 0xff]],
...
const ttm_seg7_vertex_07020908 = [
    [[  4059,   6147,   4253], 0, [  1064,    564], [0x06, 0x7d, 0x13, 0xff]],
    [[  3848,   6147,   4364], 0, [   568,    514], [0x0d, 0x7c, 0x12, 0xff]],
...
const ttm_seg7_vertex_07020A08 = [
    [[  3848,   6147,   4364], 0, [   568,    514], [0x0d, 0x7c, 0x12, 0xff]],
    [[  3523,   6147,   4680], 0, [  -326,    544], [0xff, 0x7c, 0x18, 0xff]],
    [[  3849,   6147,   5006], 0, [     0,    990], [0xf9, 0x7e, 0x07, 0xff]],
    [[  4059,   6147,   4253], 0, [  1064,    564], [0x06, 0x7d, 0x13, 0xff]],
...
const ttm_seg7_vertex_07020AF8 = [
...
const ttm_seg7_vertex_07020BF8 = [
    [[  1210,   5430,   6387], 0, [   522,    978], [0xeb, 0x7c, 0x0a, 0xff]],
    [[  1506,   5430,   6927], 0, [   456,    258], [0xe2, 0x7a, 0xf1, 0xff]],
...
const ttm_seg7_vertex_07020CD8 = [
    [[  2690,   5635,   6165], 0, [    -6,     88], [0xe5, 0x7b, 0x0a, 0xff]],
    [[  2220,   5635,   5694], 0, [    14,    858], [0x0a, 0x6d, 0x3f, 0xff]],
    [[  1677,   5532,   6020], 0, [   660,   1002], [0xfc, 0x7b, 0x1d, 0xff]],
    [[  2185,   5532,   6529], 0, [   640,    172], [0xe0, 0x79, 0xee, 0xff]],
...
const ttm_seg7_vertex_07020DC8 = [
...
const ttm_seg7_vertex_07020EB8 = [
...
const ttm_seg7_vertex_07020FA8 = [
...
const ttm_seg7_vertex_07021088 = [
    [[ -6820,    218,  -4103], 0, [  1022,    544], [0x19, 0x7b, 0xf4, 0xff]],
    [[ -7045,    422,  -2986], 0, [   -88,    550], [0x16, 0x7a, 0xe9, 0xff]],
...
const ttm_seg7_vertex_07021178 = [
    [[  4706,  -6847,   6115], 0, [  1054,    530], [0xef, 0x78, 0xde, 0xff]],
...
const ttm_seg7_vertex_07021268 = [
    [[  3289,  -6437,   7208], 0, [  -114,    414], [0x12, 0x79, 0xe1, 0xff]],
...
const ttm_seg7_vertex_07021358 = [
    [[  -294,  -5925,   6576], 0, [  -280,    412], [0x1a, 0x7b, 0xf0, 0xff]],
...
const ttm_seg7_vertex_07021448 = [
...
const ttm_seg7_vertex_07021528 = [
...
const ttm_seg7_vertex_07021618 = [
...
const ttm_seg7_vertex_070216F8 = [
...
const ttm_seg7_vertex_070217F8 = [
    [[  1536,   -939,  -4466], 0, [  1152,    586], [0xa7, 0x00, 0xa7, 0xff]],
...
const ttm_seg7_vertex_07021898 = [
...
const ttm_seg7_vertex_07021988 = [
...
const ttm_seg7_vertex_070219C8 = [
...
const ttm_seg7_vertex_07021AB8 = [
...
const ttm_seg7_vertex_07021B78 = [
...
const ttm_seg7_vertex_07021BF8 = [
...
const ttm_seg7_vertex_07021C78 = [
...
const ttm_seg7_vertex_07021CF8 = [
...
const ttm_seg7_vertex_07021DF8 = [
...
const ttm_seg7_vertex_07021ED8 = [
...
const ttm_seg7_vertex_07021FC8 = [
...
const ttm_seg7_vertex_07022098 = [
    [[  5198,  -6859,    757], 0, [  1264,    100], [0x8f, 0xd1, 0xe1, 0xff]],
...
const ttm_seg7_vertex_07022198 = [
...
const ttm_seg7_vertex_07022298 = [
...
const ttm_seg7_vertex_07022398 = [
...
const ttm_seg7_vertex_07022488 = [
    [[  4688,  -6962,    -32], 0, [  2052,    126], [0x5d, 0xd1, 0x47, 0xff]],
    [[  4430,  -6859,    473], 0, [   976,    144], [0x6c, 0xd0, 0x2d, 0xff]],
...
const ttm_seg7_vertex_07022578 = [
    [[  6094,  -7269,   -813], 0, [  2052,    122], [0x05, 0xca, 0x72, 0xff]],
    [[  5593,  -7167,   -689], 0, [  1412,    138], [0x24, 0xd1, 0x6f, 0xff]],
...
const ttm_seg7_vertex_07022678 = [
    [[  6094,  -7269,   -813], 0, [  2052,    122], [0x05, 0xca, 0x72, 0xff]],
    [[  5593,  -7781,   -689], 0, [  1372,   1004], [0x2d, 0x2f, 0x6c, 0xff]],
...
const ttm_seg7_vertex_070226F8 = [
    [[  5198,  -7474,    757], 0, [  1324,    974], [0x96, 0x2f, 0xcf, 0xff]],
    [[  5119,  -6757,   1074], 0, [  1952,    118], [0x8b, 0xd1, 0xfa, 0xff]],
    [[  5198,  -6859,    757], 0, [  1264,    100], [0x8f, 0xd1, 0xe1, 0xff]],
    [[ 11864,  -9388,   -878], 0, [  2036,    124], [0x1a, 0x4b, 0x62, 0xff]],
...
const ttm_seg7_vertex_070227F8 = [
    [[  4300,  -7167,   2048], 0, [     0,    990], [0x72, 0x37, 0xf9, 0xff]],
...
const ttm_seg7_vertex_070228F8 = [
    [[ 14322, -10313,   -715], 0, [  2040,    160], [0x1d, 0x75, 0x26, 0xff]],
    [[ 13093,  -9946,   -781], 0, [     0,    -18], [0x1e, 0x65, 0x45, 0xff]],
    [[ 13093, -10053,   -176], 0, [     0,    990], [0x20, 0x79, 0xed, 0xff]],
...
const ttm_seg7_vertex_070229F8 = [
...
const ttm_seg7_vertex_07022AF8 = [
...
const ttm_seg7_vertex_07022BD8 = [
...
const ttm_seg7_vertex_07022CB8 = [
...
const ttm_seg7_vertex_07022DA8 = [
...
const ttm_seg7_vertex_07022E98 = [
...
export const ttm_seg7_dl_070249A0 = [
    gsDPPipeSync(),
