...
import {
    ...
    gsDPSetCombineMode, gsDPSetEnvColor, gsSPDisplayList,
    G_CC_SHADEFADEA, G_CC_SHADE
} from "../../include/gbi"

// 0x0302C488
const transparent_star_seg3_lights_0302C488 = gdSPDefLights1(
    0x03, 0x05, 0x17,
    0x1e, 0x32, 0xe6, 0x28, 0x28, 0x28
);

// 0x0302C4A0
const transparent_star_seg3_vertex_0302C4A0 = [
...
export const transparent_star_seg3_dl_0302C560 = [
...
export const transparent_star_seg3_dl_0302C620 = [
    gsDPPipeSync(),
