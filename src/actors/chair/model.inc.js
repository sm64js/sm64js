...
const chair_lights_unused = gdSPDefLights1(
    0x19, 0x0d, 0x06,
    0x64, 0x36, 0x1a, 0x28, 0x28, 0x28
);

// 0x05003060
export const chair_seg5_texture_05003060 = []
// actors/chair/chair_front.rgba16.png

// 0x05003860
export const chair_seg5_texture_05003860 = []
// actors/chair/chair_leg.rgba16.png

// 0x05004060
export const chair_seg5_texture_05004060 = []
// actors/chair/chair_bottom.rgba16.png

// unreferenced
// 0x05004460
export const chair_seg5_texture_05004460 = []
// actors/chair/chair_surface_unused.rgba16.png

// 0x05004C60
const chair_seg5_lights_05004C60 = gdSPDefLights1(
    0x47, 0x47, 0x47,
    0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28
);

// 0x05004C78
const chair_seg5_vertex_05004C78 = [
...
// 0x05004D78
const chair_seg5_vertex_05004D78 = [
...
export const chair_seg5_dl_05004E38 = [
...
export const chair_seg5_dl_05004EE8 = [
    gsDPPipeSync(),
...
// 0x05004F58
const chair_seg5_lights_05004F58 = gdSPDefLights1(
    0x47, 0x47, 0x47,
    0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28
);

// 0x05004F70
const chair_seg5_vertex_05004F70 = [
...
// 0x05005070
const chair_seg5_vertex_05005070 = [
...
export const chair_seg5_dl_050050F0 = [
...
export const chair_seg5_dl_05005190 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_SHADING_SMOOTH),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x05005200
const chair_seg5_lights_05005200 = gdSPDefLights1(
    0x47, 0x47, 0x47,
    0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28
);

// 0x05005218
const chair_seg5_vertex_05005218 = [
...
// 0x05005308
const chair_seg5_vertex_05005308 = [
...
export const chair_seg5_dl_05005378 = [
...
export const chair_seg5_dl_05005408 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_SHADING_SMOOTH),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x05005478
const chair_seg5_lights_05005478 = gdSPDefLights1(
    0x47, 0x47, 0x47,
    0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28
);

// 0x05005490
const chair_seg5_vertex_05005490 = [
...
// 0x05005580
const chair_seg5_vertex_05005580 = [
...
export const chair_seg5_dl_050055F0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chair_seg5_texture_05003860),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const chair_seg5_dl_05005680 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_SHADING_SMOOTH),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
