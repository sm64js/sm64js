...
import {
    ...
    gsSP1Triangle, gsSPEndDisplayList, gsDPPipeSync, gsDPSetCycleType, gsDPSetRenderMode,
    ...
    G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2, G_ZS_PIXEL, G_FOG, G_CC_DECALRGB, G_CC_PASS2,
    G_LIGHTING, G_TX_WRAP, G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_RENDERTILE, G_ON,
    G_TX_CLAMP, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CYC_1CYCLE, G_RM_AA_ZB_OPA_SURF, G_RM_NOOP2,
    G_CC_SHADE, G_RM_AA_ZB_TEX_EDGE2, G_CC_DECALRGBA, G_RM_AA_ZB_TEX_EDGE, G_CULL_BACK
} from "../../include/gbi"

// Unreferenced light group
const unagi_lights_unused1 = gdSPDefLights1(
    0x2c, 0x25, 0x00,
    0xb2, 0x94, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const unagi_lights_unused2 = gdSPDefLights1(
    0x35, 0x00, 0x00,
    0xd5, 0x00, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const unagi_lights_unused3 = gdSPDefLights1(
    0x37, 0x00, 0x00,
    0xdd, 0x00, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const unagi_lights_unused4 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// Unreferenced light group
const unagi_lights_unused5 = gdSPDefLights1(
    0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const unagi_lights_unused6 = gdSPDefLights1(
    0x34, 0x00, 0x00,
    0xd2, 0x00, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const unagi_lights_unused7 = gdSPDefLights1(
    0x34, 0x00, 0x00,
    0xd3, 0x00, 0x00, 0x28, 0x28, 0x28
);

// Unreferenced light group
const unagi_lights_unused8 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);
...
// actors/unagi/unagi_body.rgba16.png

// 0x0500B720
export const unagi_seg5_texture_0500B720 = []
// actors/unagi/unagi_eye.rgba16.png

// 0x0500B920
export const unagi_seg5_texture_0500B920 = []
// actors/unagi/unagi_head_base.rgba16.png

// 0x0500C120
export const unagi_seg5_texture_0500C120 = []
// actors/unagi/unagi_tooth.rgba16.png

// 0x0500C320
export const unagi_seg5_texture_0500C320 = []
// actors/unagi/unagi_mouth.rgba16.png

// 0x0500C3A0
export const unagi_seg5_texture_0500C3A0 = []
// actors/unagi/unagi_tail.rgba16.png

// 0x0500CBA0
const unagi_seg5_vertex_0500CBA0 = [
...
// 0x0500CC10
const unagi_seg5_vertex_0500CC10 = [
...
export const unagi_seg5_dl_0500CCE0 = [
...
export const unagi_seg5_dl_0500CD30 = [
...
export const unagi_seg5_dl_0500CDD0 = [
    gsDPPipeSync(),
...
// 0x0500CEA8
const unagi_seg5_vertex_0500CEA8 = [
...
// 0x0500CF58
const unagi_seg5_vertex_0500CF58 = [
...
export const unagi_seg5_dl_0500CF88 = [
...
export const unagi_seg5_dl_0500D038 = [
...
export const unagi_seg5_dl_0500D050 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0500D120
const unagi_seg5_vertex_0500D120 = [
...
export const unagi_seg5_dl_0500D1C0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, unagi_seg5_texture_0500AF20),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const unagi_seg5_dl_0500D268 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0500D320
const unagi_seg5_vertex_0500D320 = [
...
export const unagi_seg5_dl_0500D3C0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, unagi_seg5_texture_0500AF20),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const unagi_seg5_dl_0500D468 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0500D520
const unagi_seg5_vertex_0500D520 = [
...
export const unagi_seg5_dl_0500D5C0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, unagi_seg5_texture_0500AF20),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const unagi_seg5_dl_0500D668 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0500D720
const unagi_seg5_vertex_0500D720 = [
...
export const unagi_seg5_dl_0500D7A0 = [
...
export const unagi_seg5_dl_0500D828 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0500D8E0
const unagi_seg5_vertex_0500D8E0 = [
...
// 0x0500D980
const unagi_seg5_vertex_0500D980 = [
...
// 0x0500DA70
const unagi_seg5_vertex_0500DA70 = [
...
export const unagi_seg5_dl_0500DB60 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, unagi_seg5_texture_0500C320),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 8 * 8 - 1, CALC_DXT(8, G_IM_SIZ_16b_BYTES)),
...
export const unagi_seg5_dl_0500DBC0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, unagi_seg5_texture_0500B920),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const unagi_seg5_dl_0500DD08 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0500DDE0
const unagi_seg5_vertex_0500DDE0 = [
...
export const unagi_seg5_dl_0500DE70 = [
...
export const unagi_seg5_dl_0500DEB8 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
...
// 0x0500DF70
const unagi_seg5_vertex_0500DF70 = [
...
export const unagi_seg5_dl_0500E030 = [
...
export const unagi_seg5_dl_0500E088 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPSetDepthSource(G_ZS_PIXEL),
...
// 0x0500E140
const unagi_seg5_vertex_0500E140 = [
...
export const unagi_seg5_dl_0500E200 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, unagi_seg5_texture_0500C120),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 16 * 16 - 1, CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
...
export const unagi_seg5_dl_0500E258 = [
    gsDPPipeSync(),
    gsDPSetCycleType(G_CYC_2CYCLE),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPSetDepthSource(G_ZS_PIXEL),
