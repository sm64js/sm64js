...
import { script_func_global_1, script_func_global_11, script_func_global_16 } from "../global_scripts"

import { MODEL_MARIO, MODEL_BIRDS, MODEL_BOB_BUBBLY_TREE, MODEL_BUBBLE, MODEL_BUTTERFLY,
         ...
         MODEL_MIST, MODEL_NONE, MODEL_WHITE_PUFF, MODEL_YOSHI, MODEL_LAKITU
} from "../../include/model_ids"

import { LEVEL_CASTLE_GROUNDS, LEVEL_CASTLE, LEVEL_VCUTM } from "../level_defines_constants"
...
export const level_castle_grounds_entry = [
    ...
    CALL(0, 'LevelUpdate.lvl_init_or_update'),
...
gLinker.level_scripts.level_castle_grounds_entry = level_castle_grounds_entry
