...
import {
    ...
    gsSPNumLights, gsSPLight, gsSPDisplayList, gsSPBranchList, gsDPSetTextureImage, gsDPLoadSync,
    gsDPLoadBlock, gsDPSetCombineMode, gsDPSetTile, gsSPTexture, gsDPTileSync, gsDPSetTileSize,
    NUMLIGHTS_1, G_IM_FMT_RGBA, G_IM_SIZ_16b, CALC_DXT, G_TX_LOADTILE, G_IM_SIZ_16b_BYTES,
    G_CC_MODULATERGB, G_TX_WRAP, G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_RENDERTILE, G_ON,
    G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE
} from "../../include/gbi"

// 0x08026388
const koopa_shell_seg8_lights_08026388 = gdSPDefLights1(
    0x11, 0x33, 0x06,
    0x45, 0xcd, 0x1a, 0x28, 0x28, 0x28
);

// 0x080263A0
const koopa_shell_seg8_lights_080263A0 = gdSPDefLights1(
    0x39, 0x0a, 0x07,
    0xe4, 0x29, 0x1d, 0x28, 0x28, 0x28
);

// 0x080263B8
const koopa_shell_seg8_lights_080263B8 = gdSPDefLights1(
    0x21, 0x30, 0x39,
    0x84, 0xc3, 0xe5, 0x28, 0x28, 0x28
);

// 0x080263D0
const koopa_shell_seg8_lights_080263D0 = gdSPDefLights1(
    0x3e, 0x3f, 0x3e,
    0xfa, 0xff, 0xf8, 0x28, 0x28, 0x28
);

// 0x080263E8
const koopa_shell_seg8_vertex_080263E8 = [
...
// 0x080264D8
const koopa_shell_seg8_vertex_080264D8 = [
    [[     0,    138,    -67], 0, [     0,      0], [0x00, 0x69, 0xb8, 0xff]],
    [[   -40,    149,     46], 0, [     0,      0], [0xc0, 0x6a, 0x1e, 0xff]],
    [[    40,    149,     46], 0, [     0,      0], [0x40, 0x6a, 0x1e, 0xff]],
    [[   -40,    149,     46], 0, [     0,      0], [0xc0, 0x6a, 0x1e, 0xff]],
...
// 0x080265C8
const koopa_shell_seg8_vertex_080265C8 = [
...
// 0x080266B8
const koopa_shell_seg8_vertex_080266B8 = [
    [[    46,      0,    -68], 0, [     0,      0], [0x2a, 0x8a, 0xe9, 0xff]],
...
// 0x080267A8
const koopa_shell_seg8_vertex_080267A8 = [
...
// 0x08026898
const koopa_shell_seg8_vertex_08026898 = [
...
// 0x08026988
const koopa_shell_seg8_vertex_08026988 = [
    [[    46,      0,     60], 0, [     0,      0], [0x23, 0x8c, 0x25, 0xff]],
    [[     0,     17,    108], 0, [     0,      0], [0x00, 0xab, 0x5f, 0xff]],
    [[   -46,      0,     59], 0, [     0,      0], [0xdd, 0x8c, 0x25, 0xff]],
    [[   -45,      0,    -69], 0, [     0,      0], [0xd7, 0x8a, 0xe9, 0xff]],
...
// 0x08026A18
const koopa_shell_seg8_vertex_08026A18 = [
    [[     0,     39,   -112], 0, [     0,      0], [0x00, 0xc4, 0x90, 0xff]],
...
// 0x08026B08
const koopa_shell_seg8_vertex_08026B08 = [
    [[    70,     17,     41], 0, [     0,      0], [0x49, 0x98, 0x07, 0xff]],
    [[    70,     21,    -50], 0, [     0,      0], [0x44, 0x95, 0xf7, 0xff]],
    [[   117,     36,    -19], 0, [     0,      0], [0x70, 0xc4, 0x00, 0xff]],
    [[    70,     21,    -50], 0, [     0,      0], [0x44, 0x95, 0xf7, 0xff]],
...
// 0x08026BF8
const koopa_shell_seg8_vertex_08026BF8 = [
    [[    38,     70,    129], 0, [     0,      0], [0x27, 0x11, 0x78, 0xff]],
    [[   103,     44,     80], 0, [     0,      0], [0x6f, 0xfe, 0x3e, 0xff]],
    [[   101,     53,     57], 0, [     0,      0], [0x53, 0x5e, 0x14, 0xff]],
    [[   101,     53,     57], 0, [     0,      0], [0x53, 0x5e, 0x14, 0xff]],
...
// 0x08026CE8
const koopa_shell_seg8_vertex_08026CE8 = [
    [[    70,     27,    -99], 0, [     0,      0], [0x33, 0xa5, 0xb8, 0xff]],
    [[   103,     44,    -89], 0, [     0,      0], [0x52, 0x0e, 0x9f, 0xff]],
    [[   117,     36,    -19], 0, [     0,      0], [0x70, 0xc4, 0x00, 0xff]],
...
// 0x08026DD8
const koopa_shell_seg8_vertex_08026DD8 = [
    [[   -70,     28,     88], 0, [     0,      0], [0xc9, 0xa0, 0x3f, 0xff]],
...
// 0x08026EC8
const koopa_shell_seg8_vertex_08026EC8 = [
    [[  -101,     53,     57], 0, [     0,      0], [0xad, 0x5e, 0x14, 0xff]],
    [[  -117,     36,    -19], 0, [     0,      0], [0x90, 0xc4, 0x00, 0xff]],
    [[  -103,     44,     80], 0, [     0,      0], [0x91, 0xfe, 0x3e, 0xff]],
    [[   -90,     51,    -81], 0, [     0,      0], [0xbe, 0x69, 0xe3, 0xff]],
...
// 0x08026FB8
const koopa_shell_seg8_vertex_08026FB8 = [
    [[   -70,     28,     88], 0, [     0,      0], [0xc9, 0xa0, 0x3f, 0xff]],
    [[  -117,     36,    -19], 0, [     0,      0], [0x90, 0xc4, 0x00, 0xff]],
    [[   -70,     17,     41], 0, [     0,      0], [0xb8, 0x98, 0x07, 0xff]],
    [[   -70,     28,     88], 0, [     0,      0], [0xc9, 0xa0, 0x3f, 0xff]],
...
// 0x080270A8
const koopa_shell_seg8_vertex_080270A8 = [
    [[   -25,     51,    118], 0, [     0,      0], [0xf0, 0xbb, 0x6a, 0xff]],
    [[    25,     51,    118], 0, [     0,      0], [0x14, 0xba, 0x68, 0xff]],
    [[    38,     70,    129], 0, [     0,      0], [0x27, 0x11, 0x78, 0xff]],
    [[    38,     70,    129], 0, [     0,      0], [0x27, 0x11, 0x78, 0xff]],
...
export const koopa_shell_seg8_dl_08027108 = [
...
export const koopa_shell_seg8_dl_08027170 = [
...
export const koopa_shell_seg8_dl_08027258 = [
...
export const koopa_shell_seg8_dl_080273C8 = [
    gsDPPipeSync(),
...
export const koopa_shell_seg8_dl_08027420 = [
    gsDPPipeSync(),
...
// 0x08027470
const koopa_shell_seg8_lights_08027470 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x08027488
const koopa_shell_seg8_lights_08027488 = gdSPDefLights1(
    0x38, 0x2b, 0x00,
    0xe0, 0xae, 0x00, 0x28, 0x28, 0x28
);

// 0x080274A0
export const koopa_shell_seg8_texture_080274A0 = []
// actors/koopa_shell/koopa_shell_front.rgba16.png

// 0x08027CA0
export const koopa_shell_seg8_texture_08027CA0 = []
// actors/koopa_shell/koopa_shell_back.rgba16.png

// 0x080284A0
const koopa_shell_seg8_vertex_080284A0 = [
...
// 0x08028540
const koopa_shell_seg8_vertex_08028540 = [
...
// 0x08028620
const koopa_shell_seg8_vertex_08028620 = [
...
// 0x08028670
const koopa_shell_seg8_vertex_08028670 = [
...
// 0x08028760
const koopa_shell_seg8_vertex_08028760 = [
    [[     0,     22,    -56], 0, [     0,      0], [0x00, 0x3d, 0x92, 0xff]],
...
// 0x08028850
const koopa_shell_seg8_vertex_08028850 = [
    [[    27,     10,    -39], 0, [     0,      0], [0x22, 0xa1, 0xb5, 0xff]],
    [[    41,     17,    -38], 0, [     0,      0], [0x4a, 0xf3, 0x9b, 0xff]],
...
export const koopa_shell_seg8_dl_080288E0 = [
...
export const koopa_shell_seg8_dl_08028978 = [
...
export const koopa_shell_seg8_dl_08028A20 = [
...
export const koopa_shell_seg8_dl_08028B78 = [
    gsDPPipeSync(),
