...
export const is_point_within_radius_of_mario = (x, y, z, dist) => {
    const mGfxX = ObjectListProc.gMarioObject[0].header.gfx.pos[0]
    const mGfxY = ObjectListProc.gMarioObject[0].header.gfx.pos[1]
    const mGfxZ = ObjectListProc.gMarioObject[0].header.gfx.pos[2]
