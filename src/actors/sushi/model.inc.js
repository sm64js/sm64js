...
import {
    ...
    G_TX_CLAMP, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE, G_CC_DECALRGBA, G_CULL_BACK
} from "../../include/gbi"
...
// 0x05009B50
const sushi_seg5_vertex_05009B50 = [
...
// 0x05009C40
const sushi_seg5_vertex_05009C40 = [
    [[     0,      4,   -257], 0, [   528,    804], [0xff, 0xff, 0xff, 0xff]],
...
export const sushi_seg5_dl_05009CC0 = [
...
export const sushi_seg5_dl_05009DD0 = [
    gsDPPipeSync(),
...
// 0x05009E40
const sushi_seg5_vertex_05009E40 = [
...
export const sushi_seg5_dl_05009F30 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, sushi_seg5_texture_05008ED0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const sushi_seg5_dl_0500A008 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGB, G_CC_DECALRGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x0500A078
const sushi_seg5_vertex_0500A078 = [
...
export const sushi_seg5_dl_0500A0E8 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, sushi_seg5_texture_05008ED0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const sushi_seg5_dl_0500A160 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGB, G_CC_DECALRGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x0500A1D0
const sushi_seg5_vertex_0500A1D0 = [
...
// 0x0500A2C0
const sushi_seg5_vertex_0500A2C0 = [
    [[  -221,    231,   -200], 0, [   358,    700], [0xff, 0xff, 0xff, 0xff]],
...
// 0x0500A3C0
const sushi_seg5_vertex_0500A3C0 = [
    [[  -645,     -3,    185], 0, [   190,     -4], [0xff, 0xff, 0xff, 0xff]],
...
// 0x0500A4A0
const sushi_seg5_vertex_0500A4A0 = [
...
// 0x0500A540
const sushi_seg5_vertex_0500A540 = [
...
export const sushi_seg5_dl_0500A580 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, sushi_seg5_texture_05008ED0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const sushi_seg5_dl_0500A748 = [
...
export const sushi_seg5_dl_0500A768 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGB, G_CC_DECALRGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x0500A7E0
const sushi_seg5_vertex_0500A7E0 = [
...
export const sushi_seg5_dl_0500A860 = [
...
export const sushi_seg5_dl_0500A8A8 = [
    gsDPPipeSync(),
...
// 0x0500A918
const sushi_seg5_vertex_0500A918 = [
...
export const sushi_seg5_dl_0500A958 = [
...
export const sushi_seg5_dl_0500A990 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
