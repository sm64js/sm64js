...
import {
    ...
    gsSPSetGeometryMode, gsDPSetCombineMode, gsDPLoadTextureBlock, gsSPTexture, gsSPDisplayList,
    gsSPClearGeometryMode,
    G_TEXTURE_GEN, G_CC_MODULATEIA, G_IM_FMT_IA, G_IM_SIZ_16b, G_TX_WRAP, G_TX_NOMIRROR,
    G_TX_NOLOD, G_TX_RENDERTILE, G_ON, G_OFF, G_CC_SHADE
} from "../../../../../include/gbi"

import { inside_castle_seg7_texture_0700A000 } from "../../../texture.inc"

const inside_castle_seg7_lights_0704A1B8 = gdSPDefLights1(
    0x3d, 0x3d, 0x3f,
...
const inside_castle_seg7_dl_0704A290 = [
