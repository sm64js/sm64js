...
import {
    grass_09003800, grass_09004800, grass_09005000, grass_09005800, grass_09003000,
    grass_09008000, grass_0900A800
} from "../../../../../textures/grass"

import { thi_seg7_texture_07000800 } from "../../../texture.inc"

const thi_seg7_lights_07001000 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x07001018 - 0x07001030
const thi_seg7_lights_07001018 = gdSPDefLights1(
    0x4c, 0x4c, 0x4c,
    0x99, 0x99, 0x99, 0x28, 0x28, 0x28
);

// 0x07001030 - 0x07001048
const thi_seg7_lights_07001030 = gdSPDefLights1(
    0x5d, 0x5d, 0x5d,
    0xbb, 0xbb, 0xbb, 0x28, 0x28, 0x28
);

// 0x07001048 - 0x07001060
const thi_seg7_lights_07001048 = gdSPDefLights1(
    0x7f, 0x7f, 0x3c,
    0xff, 0xff, 0x78, 0x28, 0x28, 0x28
);

// 0x07001060 - 0x07001140
const thi_seg7_vertex_07001060 = [
...
const thi_seg7_vertex_07001140 = [
...
const thi_seg7_vertex_07001220 = [
...
const thi_seg7_vertex_07001310 = [
...
const thi_seg7_vertex_070013F0 = [
...
const thi_seg7_vertex_070014F0 = [
    [[ -5119,   -511,   4096], 0, [ -5870,   1718], [0xac, 0x54, 0x2b, 0xff]],
...
const thi_seg7_vertex_070015E0 = [
    [[ -1497,   -204,   1331], 0, [ -2686,   1396], [0x58, 0x2b, 0x4f, 0xff]],
...
const thi_seg7_vertex_070016D0 = [
...
const thi_seg7_vertex_070017D0 = [
    [[ -4607,  -1535,   7168], 0, [ 14276,   4054], [0x7d, 0x14, 0x05, 0xff]],
    [[ -5119,   -511,   4096], 0, [  8144,   2010], [0xac, 0x54, 0x2b, 0xff]],
    [[ -5119,   -511,   8192], 0, [ 16320,   2010], [0x96, 0x1f, 0x3e, 0xff]],
    [[ -5119,  -6655,  -8191], 0, [  7268,  10478], [0x00, 0x00, 0x81, 0xff]],
...
const thi_seg7_vertex_07001830 = [
    [[ -5128,  -1352,  -5220], 0, [  7412,   2918], [0xb2, 0xae, 0xc9, 0xff]],
    [[ -5631,   -204,  -4607], 0, [  6538,   1280], [0x8e, 0xce, 0x15, 0xff]],
    [[ -5631,   -204,  -5631], 0, [  7998,   1280], [0x87, 0xe8, 0xe6, 0xff]],
    [[ -5128,   -613,  -6244], 0, [  8872,   1864], [0xd7, 0xdc, 0x8e, 0xff]],
...
const thi_seg7_vertex_07001920 = [
...
const thi_seg7_vertex_07001960 = [
...
const thi_seg7_vertex_070019F0 = [
...
const thi_seg7_vertex_07001A50 = [
...
const thi_seg7_vertex_07001B30 = [
...
const thi_seg7_vertex_07001C10 = [
...
const thi_seg7_vertex_07001D10 = [
    [[  1946,  -2047,  -5631], 0, [  1972,      0], [0xed, 0x4d, 0x9d, 0xff]],
    [[  2970,  -2457,  -5631], 0, [     0,    376], [0x59, 0x00, 0xa7, 0xff]],
...
const thi_seg7_vertex_07001E10 = [
...
const thi_seg7_vertex_07001EF0 = [
...
const thi_seg7_vertex_07001FF0 = [
...
const thi_seg7_vertex_070020D0 = [
...
const thi_seg7_vertex_070021C0 = [
...
const thi_seg7_vertex_07002220 = [
...
const thi_seg7_vertex_07002260 = [
...
const thi_seg7_vertex_07002360 = [
    [[ -3583,   1016,  -1842], 0, [ -7184,  -2690], [0xeb, 0x7b, 0xee, 0xff]],
...
const thi_seg7_vertex_07002440 = [
...
const thi_seg7_vertex_07002530 = [
    [[ -4607,     64,  -3583], 0, [ -9228,  -6164], [0xdf, 0x7a, 0xfb, 0xff]],
    [[ -5119,      0,  -4607], 0, [-10250,  -8208], [0x1a, 0x7b, 0xf2, 0xff]],
    [[ -5119,    102,  -2149], 0, [-10250,  -3302], [0x05, 0x7d, 0x10, 0xff]],
    [[ -4607,     94,  -2457], 0, [ -9228,  -3916], [0xe8, 0x7c, 0xfd, 0xff]],
...
const thi_seg7_vertex_07002630 = [
    [[ -4607,  -2559,  -7167], 0, [ -9228, -13318], [0x23, 0x77, 0xea, 0xff]],
...
const thi_seg7_vertex_07002720 = [
...
const thi_seg7_vertex_07002820 = [
...
const thi_seg7_vertex_07002920 = [
...
const thi_seg7_vertex_07002A20 = [
    [[ -5119,  -2047,  -7167], 0, [-10250, -13318], [0xb1, 0x59, 0xd7, 0xff]],
...
const thi_seg7_vertex_07002B20 = [
...
const thi_seg7_vertex_07002C00 = [
    [[  2304,   3226,  -1789], 0, [  4568,  -2584], [0x34, 0x70, 0x18, 0xff]],
    [[  2304,   3226,  -2909], 0, [  4568,  -4818], [0x11, 0x6f, 0xc7, 0xff]],
...
const thi_seg7_vertex_07002D00 = [
...
const thi_seg7_vertex_07002E00 = [
...
const thi_seg7_vertex_07002F00 = [
    [[ -7679,  -2969,   6144], 0, [-15360,  13252], [0xd5, 0x60, 0xbb, 0xff]],
...
const thi_seg7_vertex_07002F40 = [
...
const thi_seg7_vertex_07002F80 = [
...
const thi_seg7_vertex_07003080 = [
...
const thi_seg7_vertex_07003180 = [
    [[  5632,  -2559,   4864], 0, [  7998,   4638], [0xe5, 0x73, 0x2c, 0xff]],
...
const thi_seg7_vertex_07003270 = [
    [[   512,   -306,   1024], 0, [   698,   1426], [0x00, 0x00, 0x7f, 0xff]],
...
const thi_seg7_vertex_07003370 = [
...
const thi_seg7_vertex_07003470 = [
    [[  1792,   2202,    258], 0, [  2524,  -2150], [0x18, 0x4d, 0x61, 0xff]],
    [[ -1023,   4096,   -507], 0, [ -1490,  -4850], [0x04, 0x76, 0x2d, 0xff]],
    [[ -1279,   2202,    258], 0, [ -1856,  -2150], [0xbb, 0x5a, 0x38, 0xff]],
...
const thi_seg7_vertex_07003570 = [
    [[ -8191,  -3583,   8192], 0, [-11710,   6098], [0xa7, 0x00, 0x59, 0xff]],
...
const thi_seg7_vertex_07003650 = [
...
const thi_seg7_vertex_07003750 = [
...
const thi_seg7_vertex_07003850 = [
...
const thi_seg7_vertex_07003930 = [
...
const thi_seg7_vertex_07003A20 = [
...
const thi_seg7_vertex_07003B20 = [
    [[ -7167,  -2559,   1024], 0, [  3232,   -470], [0x89, 0x25, 0x13, 0xff]],
    [[ -6655,  -3583,      0], 0, [  1926,    990], [0xbe, 0x00, 0x94, 0xff]],
...
const thi_seg7_vertex_07003C00 = [
...
const thi_seg7_vertex_07003D00 = [
    [[ -2559,   -204,   2048], 0, [  3618,   1280], [0x0c, 0x27, 0x78, 0xff]],
...
const thi_seg7_vertex_07003D60 = [
...
const thi_seg7_vertex_07003E50 = [
...
const thi_seg7_vertex_07003EE0 = [
...
const thi_seg7_vertex_07003FA0 = [
...
const thi_seg7_vertex_07004090 = [
...
const thi_seg7_vertex_070040F0 = [
...
export const thi_seg7_dl_07005260 = [
    gsDPPipeSync(),
