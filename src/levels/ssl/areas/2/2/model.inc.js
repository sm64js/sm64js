...
import {
    ...
    G_ON, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CYC_1CYCLE, G_RM_AA_ZB_TEX_EDGE, G_RM_NOOP2, G_CC_SHADE, gsSPFogPosition
} from "../../../../../include/gbi"
import { generic_09000000 } from "../../../../../textures/generic"

const ssl_seg7_vertex_0701EF80 = [
...
const ssl_seg7_vertex_0701F070 = [
...
const ssl_seg7_vertex_0701F160 = [
...
const ssl_seg7_vertex_0701F250 = [
...
const ssl_seg7_vertex_0701F340 = [
...
const ssl_seg7_vertex_0701F430 = [
...
const ssl_seg7_vertex_0701F530 = [
...
const ssl_seg7_vertex_0701F620 = [
    [[  1352,   1843,   3113], 0, [-15360,      0], [0xff, 0xff, 0xff, 0xff]],
...
export const ssl_seg7_dl_0701F920 = [
    gsDPPipeSync(),
