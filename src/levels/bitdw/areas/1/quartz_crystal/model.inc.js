...
import {
    ...
    G_CC_MODULATERGBFADE, G_LIGHTING, G_CULL_BACK, G_TX_WRAP, G_TX_NOMIRROR, G_TX_NOMASK,
    G_TX_NOLOD, G_TX_RENDERTILE, G_ON, G_TEXTURE_IMAGE_FRAC, G_OFF, G_CC_SHADE
} from "../../../../../include/gbi"
import { bitdw_seg7_texture_07001800 } from "../../../texture.inc"

const bitdw_seg7_vertex_07009078 = [
...
const bitdw_seg7_vertex_07009168 = [
...
const bitdw_seg7_vertex_07009268 = [
...
export const bitdw_seg7_dl_070093B0 = [
    gsDPPipeSync(),
