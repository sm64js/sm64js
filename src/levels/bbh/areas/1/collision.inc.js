...
import {
    ...
    SURFACE_DEFAULT, SURFACE_INTANGIBLE, SURFACE_VERY_SLIPPERY, SURFACE_MGR_MUSIC,
    SURFACE_NOISE_DEFAULT, SURFACE_VANISH_CAP_WALLS,
    special_null_start, special_haunted_door
...
export const bbh_seg7_collision_level = [
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(26),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_null_start,   /*pos*/  1434,  -204,  4710, /*yaw*/ 128),
