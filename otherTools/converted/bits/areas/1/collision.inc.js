...
export const bits_seg7_collision_level = [
    ...COL_INIT(),
    ...
    /*
    ...COL_SPECIAL_INIT(22),
    SPECIAL_OBJECT_WITH_YAW( special_null_start,    -7039, -4812,     4,  64), // unused, probably an early way to set intial position
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_03,  -4505, -5119,     0,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_04,  -2291, -2073,  -762,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_05,   3891, -3276,  -705,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_06,   1753, -1986,  -531,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_07,  -5414, -1330,  -787,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_07,  -3182,  2059,  -904,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_08,  -3182,  1854,  -904,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_08,    759,  5628, -1008,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_09,  -4902,  -895, -1171,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_0A,  -3882,  -357, -1241,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_0B,  -1199,  -387, -1308,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_0C,   5584,  2735, -1851,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_0D,  -5248,  3800,  -895,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_0D,  -1356,  3800,  -895,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_0E,  -6459,  3800,  -904,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_0F,   -930,  2884,  -904,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_10,   2486,  -438,  -899,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_11,    563,  2249,  -904,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_12,  -6459,  2039,  -904,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_13,   1143,  4670,  -494,   0),
    SPECIAL_OBJECT_WITH_YAW( special_level_geo_14,    349,  6268, -4054,   0),
    */
    ...COL_END(),
]