...
const bitfs_seg7_lights_0700C430 = gdSPDefLights1(
    0x46, 0x46, 0x46,
    0x8c, 0x8c, 0x8c, 0x28, 0x28, 0x28
);

// 0x0700C448 - 0x0700C460
const bitfs_seg7_lights_0700C448 = gdSPDefLights1(
    0x64, 0x64, 0x64,
    0xc8, 0xc8, 0xc8, 0x28, 0x28, 0x28
);

// 0x0700C460 - 0x0700C478
const bitfs_seg7_lights_0700C460 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0700C478 - 0x0700C490
const bitfs_seg7_lights_0700C478 = gdSPDefLights1(
    0x32, 0x32, 0x32,
    0x64, 0x64, 0x64, 0x28, 0x28, 0x28
);

// 0x0700C490 - 0x0700C4A8
const bitfs_seg7_lights_0700C490 = gdSPDefLights1(
    0x62, 0x7f, 0x7f,
    0xc4, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0700C4A8 - 0x0700C4C0
const bitfs_seg7_lights_0700C4A8 = gdSPDefLights1(
    0x32, 0x7f, 0x59,
    0x65, 0xff, 0xb2, 0x28, 0x28, 0x28
);

// 0x0700C4C0 - 0x0700C540
const bitfs_seg7_vertex_0700C4C0 = [
...
const bitfs_seg7_vertex_0700C540 = [
...
const bitfs_seg7_vertex_0700C580 = [
...
const bitfs_seg7_vertex_0700C5C0 = [
...
const bitfs_seg7_vertex_0700C600 = [
...
const bitfs_seg7_vertex_0700C700 = [
...
const bitfs_seg7_vertex_0700C7E0 = [
...
const bitfs_seg7_vertex_0700C8E0 = [
    [[   -49,    -15,    119], 0, [  -806,    520], [0x66, 0x4a, 0x00, 0xff]],
...
const bitfs_seg7_vertex_0700C9E0 = [
...
const bitfs_seg7_vertex_0700CAE0 = [
...
const bitfs_seg7_vertex_0700CBD0 = [
...
const bitfs_seg7_vertex_0700CCB0 = [
...
const bitfs_seg7_vertex_0700CD90 = [
...
const bitfs_seg7_vertex_0700CE70 = [
...
const bitfs_seg7_vertex_0700CF60 = [
...
const bitfs_seg7_vertex_0700D060 = [
    [[    -2,   -294,     98], 0, [  -480,    560], [0x67, 0x4a, 0x00, 0xff]],
...
const bitfs_seg7_vertex_0700D160 = [
...
const bitfs_seg7_vertex_0700D260 = [
    [[   136,   -372,    158], 0, [  -372,    540], [0x00, 0x49, 0x99, 0xff]],
    [[   284,   -294,    213], 0, [  -442,    488], [0x00, 0x49, 0x99, 0xff]],
...
const bitfs_seg7_vertex_0700D360 = [
    [[    94,   -342,    253], 0, [  -412,    546], [0x00, 0x87, 0x26, 0xff]],
    [[   260,   -372,    158], 0, [  -356,    508], [0x00, 0x87, 0x26, 0xff]],
...
const bitfs_seg7_vertex_0700D440 = [
...
const bitfs_seg7_vertex_0700D520 = [
...
const bitfs_seg7_vertex_0700D620 = [
...
const bitfs_seg7_vertex_0700D720 = [
    [[   313,   -613,     61], 0, [   -72,    542], [0x25, 0x87, 0x00, 0xff]],
...
const bitfs_seg7_vertex_0700D810 = [
...
const bitfs_seg7_vertex_0700D910 = [
...
const bitfs_seg7_vertex_0700D9F0 = [
...
const bitfs_seg7_vertex_0700DAF0 = [
...
const bitfs_seg7_vertex_0700DBF0 = [
    [[   148,   -613,    127], 0, [   -92,    584], [0x48, 0x4a, 0xb8, 0xff]],
...
const bitfs_seg7_vertex_0700DCE0 = [
...
const bitfs_seg7_vertex_0700DDC0 = [
...
const bitfs_seg7_vertex_0700DEA0 = [
...
const bitfs_seg7_vertex_0700DFA0 = [
...
const bitfs_seg7_vertex_0700E0A0 = [
    [[  -131,    608,   -761], 0, [   452,    638], [0x00, 0x97, 0xb9, 0xff]],
    [[   285,    224,   -194], 0, [   230,    500], [0x00, 0x97, 0xb9, 0xff]],
...
const bitfs_seg7_vertex_0700E180 = [
...
const bitfs_seg7_vertex_0700E260 = [
...
const bitfs_seg7_vertex_0700E350 = [
...
const bitfs_seg7_vertex_0700E430 = [
...
export const bitfs_seg7_dl_0700EC78 = [
    gsDPPipeSync(),
