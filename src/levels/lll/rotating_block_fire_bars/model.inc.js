...
import { lll_seg7_texture_07004000 } from "../texture.inc"

import { lll_seg7_lights_0700FC00 } from "../areas/1/light.inc"

const lll_seg7_vertex_07018708 = [
...
const lll_seg7_vertex_07018808 = [
...
const lll_seg7_vertex_07018908 = [
    [[    83,      0,   -143], 0, [  -138,   1162], [0x6b, 0x1a, 0xc2, 0xff]],
    [[   116,    205,      0], 0, [   990,   -364], [0x6b, 0x1a, 0xc2, 0xff]],
...
export const lll_seg7_dl_07018A30 = [
    gsDPPipeSync(),
