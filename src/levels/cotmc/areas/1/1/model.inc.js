...
import {
    cave_09006800, cave_09003800, cave_09005800, cave_09007800
} from "../../../../../textures/cave"

import {
    cotmc_seg7_texture_07002000, cotmc_seg7_texture_07001000, cotmc_seg7_texture_07002800,
    cotmc_seg7_texture_07000000
} from "../../../texture.inc"

const cotmc_seg7_lights_07003000 = gdSPDefLights1(
    0x4b, 0x78, 0x70,
    0x96, 0xf0, 0xe1, 0x28, 0x28, 0x28
);

// 0x07003018 - 0x07003030
const cotmc_seg7_lights_07003018 = gdSPDefLights1(
    0x44, 0x44, 0x44,
    0x88, 0x88, 0x88, 0x28, 0x28, 0x28
);

// 0x07003030 - 0x07003048
const cotmc_seg7_lights_07003030 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x07003048 - 0x07003060
const cotmc_seg7_lights_07003048 = gdSPDefLights1(
    0x00, 0x3c, 0x3c,
    0x00, 0x78, 0x78, 0x28, 0x28, 0x28
);

// 0x07003060 - 0x07003078
const cotmc_seg7_lights_07003060 = gdSPDefLights1(
    0x3b, 0x3b, 0x3b,
    0x77, 0x77, 0x77, 0x28, 0x28, 0x28
);

// 0x07003078 - 0x07003090
const cotmc_seg7_lights_07003078 = gdSPDefLights1(
    0x4c, 0x4c, 0x4c,
    0x99, 0x99, 0x99, 0x28, 0x28, 0x28
);

// 0x07003090 - 0x070030A8
const cotmc_seg7_lights_07003090 = gdSPDefLights1(
    0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x070030A8 - 0x070031A8
const cotmc_seg7_vertex_070030A8 = [
...
const cotmc_seg7_vertex_070031A8 = [
    [[    19,   -153,  -2029], 0, [   524,    478], [0xdb, 0x77, 0xee, 0xff]],
...
const cotmc_seg7_vertex_070032A8 = [
    [[  -589,   -358,  -5918], 0, [ -5084,  -3614], [0xff, 0x7e, 0xf9, 0xff]],
...
const cotmc_seg7_vertex_070033A8 = [
...
const cotmc_seg7_vertex_070034A8 = [
    [[   646,   -379,  -6747], 0, [ -4576,  -6190], [0xfa, 0x7e, 0x00, 0xff]],
    [[   397,   -344,  -6143], 0, [ -4134,  -5126], [0x5a, 0x57, 0x0b, 0xff]],
...
const cotmc_seg7_vertex_07003598 = [
...
const cotmc_seg7_vertex_07003688 = [
    [[   564,    -80,   3379], 0, [  7954,   6544], [0xae, 0x52, 0x31, 0xff]],
    [[  -563,   -153,   3072], 0, [  6162,   7568], [0x4c, 0x64, 0xf5, 0xff]],
...
const cotmc_seg7_vertex_07003768 = [
    [[  -249,   -386,  -6583], 0, [ -5490,  -4868], [0xfd, 0x7e, 0xf4, 0xff]],
    [[  -541,   -409,  -6769], 0, [ -6086,  -4736], [0x1c, 0x7b, 0x04, 0xff]],
    [[  -589,   -358,  -5918], 0, [ -5084,  -3614], [0xff, 0x7e, 0xf9, 0xff]],
    [[  -439,   -422,  -7070], 0, [ -6336,  -5238], [0x3c, 0x6f, 0xf9, 0xff]],
...
const cotmc_seg7_vertex_07003868 = [
    [[   564,   -255,  -7505], 0, [ -5624,  -7034], [0xc4, 0x5a, 0x41, 0xff]],
...
const cotmc_seg7_vertex_07003968 = [
    [[  -911,   -255,  -5514], 0, [ -4982,  -2708], [0x1c, 0x7b, 0xf6, 0xff]],
    [[ -1101,   -175,  -5704], 0, [ -5456,  -2708], [0x14, 0x7d, 0xfc, 0xff]],
    [[ -1225,   -204,  -5635], 0, [ -5526,  -2468], [0x0d, 0x7d, 0xf8, 0xff]],
    [[  -960,   -291,  -5945], 0, [ -5580,  -3184], [0x26, 0x78, 0xf7, 0xff]],
...
const cotmc_seg7_vertex_07003A48 = [
...
const cotmc_seg7_vertex_07003B08 = [
    [[   123,    256,  -5574], 0, [   148,    924], [0xb8, 0x4b, 0xb9, 0xff]],
    [[    -4,    256,  -5298], 0, [   296,   1326], [0x9c, 0x4a, 0x16, 0xff]],
...
const cotmc_seg7_vertex_07003B78 = [
    [[    -4,    187,  -5298], 0, [   296,   1326], [0x91, 0xc4, 0x02, 0xff]],
...
const cotmc_seg7_vertex_07003C38 = [
...
const cotmc_seg7_vertex_07003CD8 = [
...
const cotmc_seg7_vertex_07003D78 = [
...
const cotmc_seg7_vertex_07003E68 = [
    [[  -214,     20,   1090], 0, [  5368,   1338], [0x11, 0x7d, 0x0e, 0xff]],
...
const cotmc_seg7_vertex_07003F58 = [
    [[    36,     20,    597], 0, [  5834,     40], [0x11, 0x7d, 0x00, 0xff]],
...
const cotmc_seg7_vertex_07004048 = [
...
const cotmc_seg7_vertex_07004148 = [
    [[  -227,     72,  -3275], 0, [   992,   1558], [0x4c, 0x9b, 0x02, 0xff]],
...
const cotmc_seg7_vertex_07004248 = [
    [[  -257,    140,  -3270], 0, [  1006,   1632], [0xfd, 0x7d, 0x15, 0xff]],
...
const cotmc_seg7_vertex_07004348 = [
...
const cotmc_seg7_vertex_070043E8 = [
...
const cotmc_seg7_vertex_070044E8 = [
    [[     0,    352,  -6635], 0, [   968,    360], [0xf9, 0x70, 0xc7, 0xff]],
    [[  -347,    291,  -6491], 0, [   738,     62], [0xba, 0xce, 0xa4, 0xff]],
...
const cotmc_seg7_vertex_07004548 = [
...
const cotmc_seg7_vertex_07004648 = [
    [[   492,    352,  -6143], 0, [   620,    962], [0x47, 0x68, 0x00, 0xff]],
...
const cotmc_seg7_vertex_07004738 = [
...
const cotmc_seg7_vertex_07004838 = [
...
const cotmc_seg7_vertex_070048B8 = [
    [[   348,    291,  -6491], 0, [   918,    732], [0x55, 0xc6, 0xb6, 0xff]],
...
const cotmc_seg7_vertex_070049B8 = [
...
const cotmc_seg7_vertex_07004AA8 = [
...
const cotmc_seg7_vertex_07004BA8 = [
    [[  -563,    717,  -7505], 0, [     0,      0], [0x30, 0x00, 0x75, 0xff]],
    [[   564,      0,  -7505], 0, [  2012,   1652], [0xd0, 0x00, 0x75, 0xff]],
...
const cotmc_seg7_vertex_07004C98 = [
    [[  1362,      0,  -5579], 0, [     0,   1652], [0x8e, 0x00, 0xc9, 0xff]],
...
const cotmc_seg7_vertex_07004D98 = [
    [[     0,    201,  -6540], 0, [     0,      0], [0xf8, 0xc6, 0x90, 0xff]],
    [[  -280,   -376,  -6424], 0, [   990,   1908], [0xd1, 0x5d, 0xb9, 0xff]],
...
const cotmc_seg7_vertex_07004E98 = [
    [[   281,    201,  -5862], 0, [     0,      0], [0x5c, 0xd8, 0x4c, 0xff]],
...
const cotmc_seg7_vertex_07004F78 = [
    [[  -396,    201,  -6143], 0, [     0,      0], [0x8d, 0xce, 0x0f, 0xff]],
    [[  -280,   -260,  -5862], 0, [   990,   1548], [0xae, 0x53, 0x30, 0xff]],
...
const cotmc_seg7_vertex_07005058 = [
...
const cotmc_seg7_vertex_07005118 = [
...
const cotmc_seg7_vertex_070051D8 = [
...
const cotmc_seg7_vertex_070052D8 = [
    [[ -4094,     20,    470], 0, [  5372,   2012], [0xf7, 0x4a, 0x9a, 0xff]],
...
const cotmc_seg7_vertex_070053C8 = [
...
const cotmc_seg7_vertex_070054B8 = [
...
const cotmc_seg7_vertex_070055B8 = [
    [[   749,    256,  -3864], 0, [   862,   2012], [0x71, 0x00, 0xc8, 0xff]],
...
const cotmc_seg7_vertex_07005668 = [
...
const cotmc_seg7_vertex_07005758 = [
...
const cotmc_seg7_vertex_07005848 = [
...
const cotmc_seg7_vertex_070058C8 = [
...
const cotmc_seg7_vertex_070059A8 = [
...
const cotmc_seg7_vertex_07005A98 = [
...
const cotmc_seg7_vertex_07005B88 = [
...
const cotmc_seg7_vertex_07005C48 = [
...
const cotmc_seg7_vertex_07005D08 = [
...
const cotmc_seg7_vertex_07005DA8 = [
...
const cotmc_seg7_vertex_07005DE8 = [
...
const cotmc_seg7_vertex_07005ED8 = [
    [[   615,    684,  -3311], 0, [ -4128,      6], [0xce, 0xb0, 0xac, 0xff]],
...
const cotmc_seg7_vertex_07005FD8 = [
    [[  -563,    717,   3379], 0, [ -9456,      0], [0x7a, 0xe6, 0x15, 0xff]],
...
const cotmc_seg7_vertex_070060C8 = [
...
const cotmc_seg7_vertex_070061B8 = [
...
const cotmc_seg7_vertex_070062A8 = [
    [[  -666,   -460,   3584], 0, [ -9940,   1348], [0x50, 0x1c, 0x5d, 0xff]],
    [[  -563,    -80,   3379], 0, [ -9456,    904], [0x6b, 0x35, 0x28, 0xff]],
    [[  -563,      0,   3379], 0, [ -9456,    810], [0x7b, 0x00, 0x1d, 0xff]],
    [[  -666,    717,    478], 0, [ -2644,      0], [0x28, 0xa3, 0x4b, 0xff]],
...
const cotmc_seg7_vertex_07006358 = [
    [[ -4746,    717,    151], 0, [     0,      0], [0x30, 0x8d, 0xeb, 0xff]],
...
const cotmc_seg7_vertex_07006438 = [
...
const cotmc_seg7_vertex_07006538 = [
    [[   564,   4198,  -4781], 0, [     0,      0], [0xaf, 0xb0, 0xc9, 0xff]],
...
const cotmc_seg7_vertex_07006638 = [
    [[ -1361,   4198,  -6707], 0, [     0,      0], [0x6d, 0x00, 0x40, 0xff]],
    [[ -1361,    717,  -6707], 0, [     0,      0], [0x75, 0x00, 0x30, 0xff]],
    [[  -563,    717,  -7505], 0, [     0,      0], [0x30, 0x00, 0x75, 0xff]],
...
const cotmc_seg7_vertex_070066A8 = [
...
export const cotmc_seg7_dl_07007D48 = [
    gsDPPipeSync(),
