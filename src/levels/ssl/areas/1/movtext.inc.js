...
// 0x07012778
export const ssl_movtex_puddle_water = [
    {id: 0, movtex: ssl_movtex_puddle_water_data},
    {id: -1, movtex: null},
];

// 0x07012788 - 0x070127A8
const ssl_movtex_toxbox_quicksand_large_mist = [
    MOV_TEX_INIT_LOAD(    1),
...
const ssl_movtex_toxbox_quicksand_short_mist = [
    MOV_TEX_INIT_LOAD(    1),
    MOV_TEX_ROT_SPEED(   40),
    MOV_TEX_ROT_SCALE(    2),
...
export const ssl_movtex_toxbox_quicksand_mist = [
    {id: 51, movtex: ssl_movtex_toxbox_quicksand_large_mist},
    {id: 52, movtex: ssl_movtex_toxbox_quicksand_short_mist},
    {id: -1, movtex: null},
];

// 0x070127E0
/*export const ssl_dl_quicksand_begin = [
    gsSPBranchList(ssl_dl_quicksand_pit_begin),
].flat();

// 0x070127E8
export const ssl_dl_quicksand_end = [
    gsSPBranchList(ssl_dl_quicksand_pit_end),
].flat();*/

// 0x070127F0 - 0x070128B8
export const ssl_movtex_tris_pyramid_quicksand = [
    MOV_TEX_SPD(       20),
...
export const ssl_dl_pyramid_quicksand = [
...
export const ssl_movtex_tris_pyramid_corners_quicksand = [
    MOV_TEX_SPD(       20),
...
export const ssl_dl_pyramid_corners_quicksand = [
...
export const ssl_movtex_tris_sides_quicksand = [
    MOV_TEX_SPD(       20),
...
export const ssl_dl_sides_quicksand = [
