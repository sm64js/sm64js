...
import {
    ...
    SURFACE_DEFAULT, SURFACE_WATER, SURFACE_WALL_MISC, SURFACE_NOISE_DEFAULT,
    special_null_start, special_level_geo_03, special_spiky_tree, special_wooden_door_warp
...
export const castle_courtyard_seg7_collision = [
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(19),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_null_start,       /*pos*/    15,    0,   202, /*yaw*/ 128),
