...
import {
    ...
    gsDPPipeSync, gsDPSetCombineMode, gsDPSetTile, gsSPTexture, gsDPTileSync, gsDPSetTileSize,
    gsSPDisplayList, gsDPSetTextureImage, gsDPLoadSync, gsDPLoadBlock, gsSPBranchList,
    gsSPClearGeometryMode, gsSPSetGeometryMode, gsSPNumLights,
    G_CC_MODULATERGB, G_IM_FMT_RGBA, G_IM_SIZ_16b, G_TX_LOADTILE, G_TX_WRAP, G_TX_NOMIRROR,
    G_TX_NOMASK, G_TX_NOLOD, G_TX_RENDERTILE, G_ON, G_TX_CLAMP, G_TEXTURE_IMAGE_FRAC, G_OFF,
    G_CC_SHADE, CALC_DXT, G_IM_SIZ_16b_BYTES, G_CC_DECALRGBA, G_LIGHTING, NUMLIGHTS_1
} from "../../include/gbi"

// Unreferenced light group
const goomba_lights_unused1 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// Unreferenced light group
const goomba_lights_unused2 = gdSPDefLights1(
    0x2c, 0x2c, 0x2c,
    0xb2, 0xb2, 0xb2, 0x28, 0x28, 0x28
);

// 0x080194D0
const goomba_seg8_lights_080194D0 = gdSPDefLights1(
    0x15, 0x0b, 0x04,
    0x54, 0x2e, 0x10, 0x28, 0x28, 0x28
);

// 0x080194E8
const goomba_seg8_lights_080194E8 = gdSPDefLights1(
    0x18, 0x0d, 0x04,
    0x61, 0x34, 0x13, 0x28, 0x28, 0x28
);

// 0x08019500
const goomba_seg8_lights_08019500 = gdSPDefLights1(
    0x1d, 0x10, 0x08,
    0x77, 0x42, 0x20, 0x28, 0x28, 0x28
);

// 0x08019518
const goomba_seg8_lights_08019518 = gdSPDefLights1(
    0x37, 0x2d, 0x13,
...
// 0x0801AD30
const goomba_seg8_lights_0801AD30 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);
