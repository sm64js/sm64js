import {
    gdSPDefLights1, gsSP2Triangles, gsSPEndDisplayList, gsDPPipeSync, gsSPSetGeometryMode,
    gsDPSetCombineMode, gsSPLight, gsDPSetTile, gsDPTileSync, gsDPSetTileSize, gsSPTexture,
    gsSPVertex, gsSP1Triangle, gsSPDisplayList, gsDPSetTextureImage, gsDPLoadSync, gsDPLoadBlock,
    gsSPClearGeometryMode, gsSPBranchList,
    G_LIGHTING, G_SHADING_SMOOTH, G_CC_MODULATERGB, G_IM_FMT_RGBA, G_IM_SIZ_16b, G_TX_LOADTILE,
    G_TX_WRAP, G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_RENDERTILE, G_TX_CLAMP,
    G_TEXTURE_IMAGE_FRAC, G_ON, G_OFF, G_CC_SHADE, CALC_DXT, G_IM_SIZ_16b_BYTES
} from "../../include/gbi"
...
import {
    ...
    inside_castle_seg7_texture_07014800, inside_castle_seg7_texture_07015800,
    inside_castle_seg7_texture_07017800, inside_castle_seg7_texture_07018800,
    inside_castle_seg7_texture_07019800, inside_castle_seg7_texture_0701A800,
    inside_castle_seg7_texture_0701B800, inside_castle_seg7_texture_0701C800,
    inside_castle_seg7_texture_0701D800, inside_castle_seg7_texture_0701E800,
    inside_castle_seg7_texture_0701F800, inside_castle_seg7_texture_07020800,
...
const inside_castle_seg7_vertex_07021818 = [
...
const inside_castle_seg7_vertex_07021898 = [
...
const inside_castle_seg7_vertex_07021918 = [
...
const inside_castle_seg7_vertex_07021998 = [
...
const inside_castle_seg7_dl_07021A18 = [
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSPEndDisplayList(),
].flat();

// 0x07021A30 - 0x07021A48
const inside_castle_seg7_dl_07021A30 = [
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSPEndDisplayList(),
].flat();

// 0x07021A48 - 0x07021AA0
const inside_castle_seg7_dl_07021A48 = [
    gsDPPipeSync(),
...
const inside_castle_seg7_dl_07021AA0 = [
...
const inside_castle_seg7_painting_dl_07021AC0 = [
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 6, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (64 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPEndDisplayList(),
...
const inside_castle_seg7_painting_texture_map_bottom_07021AE0 = [
    85, // num mappings
    // Format:
...
const inside_castle_seg7_painting_texture_map_top_07021FFC = [
    85, // num mappings
    // Format:
    // mesh vtx ID, texture X, texture Y
       0, 2016,   72,
...
// 0x07022518
export const inside_castle_seg7_painting_texture_maps_07022518 = [
...
const inside_castle_seg7_lights_07022528 = gdSPDefLights1(
    0x50, 0x50, 0x50,
    0xff, 0xff, 0xff, 0x32, 0x32, 0x32
);
...
// };
const inside_castle_seg7_lights_07022540 = gdSPDefLights1(
    0x40, 0x40, 0x80,
    0x64, 0x64, 0xfa, 0x28, 0x28, 0x28
);

// 0x07022558 - 0x07022598
const inside_castle_seg7_vertex_07022558 = [
...
const inside_castle_seg7_vertex_07022598 = [
...
export const inside_castle_seg7_dl_070225D8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
...
export const inside_castle_seg7_dl_07022610 = [
...
const inside_castle_seg7_painting_dl_07022640 = [
    gsDPTileSync(),
...
const inside_castle_seg7_painting_env_map_texture_map_07022660 = [
    157, // num mappings
    // Format:
    // mesh vtx ID, texture X, texture Y
       0, 6100, -4832,
...
export const inside_castle_seg7_painting_env_map_texture_maps_07023044 = [
...
const inside_castle_seg7_painting_dl_07023050 = [
...
const inside_castle_seg7_painting_dl_070230B0 = [
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
const inside_castle_seg7_painting_dl_07023110 = [
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
const inside_castle_seg7_painting_dl_07023170 = [
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
const inside_castle_seg7_painting_dl_070231D0 = [
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
const inside_castle_seg7_painting_dl_07023230 = [
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
const inside_castle_seg7_painting_dl_07023290 = [
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
const inside_castle_seg7_painting_dl_070232F0 = [
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
const inside_castle_seg7_painting_dl_07023350 = [
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
const inside_castle_seg7_painting_dl_070233B0 = [
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
    gsSPVertex(inside_castle_seg7_vertex_07021818, 8, 0),
...
const inside_castle_seg7_painting_dl_07023410 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
...
export const inside_castle_seg7_dl_070234C0 = [
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
...
export const inside_castle_seg7_dl_07023520 = [
    gsSPDisplayList(inside_castle_seg7_dl_07021A48),
...
const inside_castle_seg7_painting_dl_07023580 = [
    gsDPPipeSync(),
...
export const bob_painting = {
    ...
    rippleStatus: 0x00,
    rotation:     [0.0,    90.0],
    position: [-5222.4,   409.6,   -153.6],
    /*                         curr   passive     entry */
    rippleMagnitude:     [0.0,    20.0,    80.0],
    rippleDecay:         [1.0,  0.9608,  0.9524],
    rippleRate:          [0.0,    0.24,    0.14],
    rippleDispersion:    [0.0,    40.0,    30.0],
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,    0.0],
    normalDList: inside_castle_seg7_painting_dl_07023050,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
    textures:     inside_castle_seg7_painting_textures_070235C0,
    textureWH: [64, 32],
    rippleDList: inside_castle_seg7_painting_dl_07021AC0,
...
export const ccm_painting = {
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,     0.0],
    normalDList: inside_castle_seg7_painting_dl_070230B0,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
...
export const wf_painting = {
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,     0.0],
    normalDList: inside_castle_seg7_painting_dl_07023110,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
...
export const jrb_painting = {
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,     0.0],
    normalDList: inside_castle_seg7_painting_dl_07023170,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
...
export const lll_painting = {
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,     0.0],
    normalDList: inside_castle_seg7_painting_dl_070231D0,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
...
export const ssl_painting = {
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,     0.0],
    normalDList: inside_castle_seg7_painting_dl_07023230,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
...
export const hmc_painting = {
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,   0.0],
    normalDList: inside_castle_seg7_painting_dl_07023580,
    textureMaps: inside_castle_seg7_painting_env_map_texture_maps_07023044,
    textures:     inside_castle_seg7_painting_textures_070235F0,
    textureWH: [32, 32],
    rippleDList: inside_castle_seg7_painting_dl_07022640,
...
export const ddd_painting = {
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,   0.0],
    normalDList: inside_castle_seg7_painting_dl_070235B8,
    textureMaps: inside_castle_seg7_painting_env_map_texture_maps_07023044,
...
export const wdw_painting = {
    ...
    rippleStatus: 0x00,
    rotation:     [0.0,     0.0],
    position: [-966.656, 1305.6, -143.36],
    /*                         curr   passive     entry */
    rippleMagnitude:     [0.0,    20.0,    80.0],
    rippleDecay:         [1.0,  0.9608,  0.9524],
    rippleRate:          [0.0,    0.24,    0.14],
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,     0.0],
    normalDList: inside_castle_seg7_painting_dl_07023290,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
...
export const thi_tiny_painting = {
    id: 0x0009,
    imageCount: 0x02,
    textureType: PAINTING_IMAGE,
    floorStatus: [0x00, 0x00, 0x00], /* which of the painting's nearby special floors Mario's on */
    rippleStatus: 0x00,
    rotation:     [0.0,   180.0],
    position: [-4598.7842, 1354.752, 3005.44],
    /*                         curr   passive     entry */
    rippleMagnitude:     [0.0,    20.0,    80.0],
    rippleDecay:         [1.0,  0.9608,  0.9524],
    rippleRate:          [0.0,    0.24,    0.14],
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,     0.0],
    normalDList: inside_castle_seg7_painting_dl_070232F0,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
...
export const ttm_painting = {
    ...
    rippleStatus: 0x00,
    rotation:     [ 0.0,   180.0],
    position: [-546.816, 1356.8, 3813.376],
    /*                         curr   passive     entry */
    rippleMagnitude:     [0.0,    20.0,    80.0],
    rippleDecay:         [1.0,  0.9608,  0.9524],
    rippleRate:          [0.0,    0.24,    0.14],
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,     0.0],
    normalDList: inside_castle_seg7_painting_dl_07023350,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
...
export const ttc_painting = {
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,     0.0],
    normalDList: inside_castle_seg7_painting_dl_070233B0,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
...
export const sl_painting = {
    ...
    rippleStatus: 0x00,
    rotation:     [0.0,     0.0],
    position: [3179.52, 1408.0, -271.36],
    /*                         curr   passive     entry */
    rippleMagnitude:     [0.0,    20.0,    80.0],
    rippleDecay:         [1.0,  0.9608,  0.9524],
    rippleRate:          [0.0,    0.24,    0.14],
    ...
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,     0.0],
    normalDList: inside_castle_seg7_painting_dl_07023410,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
...
export const thi_huge_painting = {
    id: 0x000D,
    imageCount: 0x02,
    textureType: PAINTING_IMAGE,
    floorStatus: [0x00, 0x00, 0x00], /* which of the painting's nearby special floors Mario's on */
    rippleStatus: 0x00,
    rotation:     [ 0.0,     0.0],
    position: [-5614.5918, 1510.4, -3292.16],
    /*                         curr   passive     entry */
    rippleMagnitude:     [0.0,    40.0,   160.0],
    rippleDecay:         [1.0,  0.9608,  0.9524],
    rippleRate:          [0.0,    0.12,    0.07],
    rippleDispersion:    [0.0,    80.0,    60.0],
    currRippleTimer:    0.0,
    currRippleXY:     [0.0,    0.0],
    normalDList: inside_castle_seg7_painting_dl_070232F0,
    textureMaps: inside_castle_seg7_painting_texture_maps_07022518,
