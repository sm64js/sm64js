...
import { LEVEL_CASTLE_GROUNDS, LEVEL_CASTLE, LEVEL_CASTLE_2, LEVEL_CASTLE_COURTYARD,
    LEVEL_BOB, LEVEL_CCM, LEVEL_PSS, LEVEL_TTM, LEVEL_WF, LEVEL_HMC,
    LEVEL_BBH, LEVEL_SSL, LEVEL_SL, LEVEL_CCM_2, LEVEL_THI, LEVEL_THI_2,
    LEVEL_CASTLE_3
...
switch (mapSelect) {
   ...
   case "Whomp's Fortress": return LEVEL_WF
   ...
   case "Cool, Cool Mountain Slide": return LEVEL_CCM_2
   case "Tiny-Huge Island Huge": return LEVEL_THI
   case "Tiny-Huge Island Tiny": return LEVEL_THI_2
   case "Castle Inside Basement": return LEVEL_CASTLE_3
}
