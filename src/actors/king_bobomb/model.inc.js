...
import { CALC_DXT, gdSPDefLights1, gsDPLoadBlock, gsDPLoadSync, gsDPPipeSync, gsDPSetCombineMode, gsDPSetTextureImage, gsDPSetTile, gsDPSetTileSize, gsDPTileSync, gsSP1Triangle, gsSP2Triangles, gsSPClearGeometryMode, gsSPDisplayList, gsSPEndDisplayList, gsSPLight, gsSPSetGeometryMode, gsSPTexture, gsSPVertex, G_CC_MODULATERGB, G_CC_MODULATERGBA, G_CC_SHADE, G_CULL_BACK, G_IM_FMT_RGBA, G_IM_SIZ_16b, G_IM_SIZ_16b_BYTES, G_LIGHTING, G_OFF, G_ON, G_TEXTURE_IMAGE_FRAC, G_TX_CLAMP, G_TX_LOADTILE, G_TX_NOLOD, G_TX_NOMASK, G_TX_NOMIRROR, G_TX_RENDERTILE, G_TX_WRAP } from "../../include/gbi"
...
const king_bobomb_seg5_vertex_0500A478 = [
...
const king_bobomb_seg5_vertex_0500A560 = [
...
const king_bobomb_seg5_vertex_0500A648 = [
...
const king_bobomb_seg5_vertex_0500A730 = [
    [[    23,     23,      0], 0, [   990,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   -22,     23,      0], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   -22,    -22,      0], 0, [     0,    990], [0xff, 0xff, 0xff, 0xff]],
    [[    23,    -22,      0], 0, [   990,    990], [0xff, 0xff, 0xff, 0xff]],
...
const king_bobomb_seg5_vertex_0500A818 = [
    [[    26,     26,      0], 0, [   990,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   -25,     26,      0], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   -25,    -25,      0], 0, [     0,    990], [0xff, 0xff, 0xff, 0xff]],
    [[    26,    -25,      0], 0, [   990,    990], [0xff, 0xff, 0xff, 0xff]],
...
const king_bobomb_seg5_vertex_0500A900 = [
    [[    49,     49,      0], 0, [   990,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   -48,     49,      0], 0, [     0,      0], [0xff, 0xff, 0xff, 0xff]],
    [[   -48,    -48,      0], 0, [     0,    990], [0xff, 0xff, 0xff, 0xff]],
    [[    49,    -48,      0], 0, [   990,    990], [0xff, 0xff, 0xff, 0xff]],
...
const king_bobomb_seg5_vertex_0500AA00 = [
...
const king_bobomb_seg5_vertex_0500AB00 = [
    [[     6,    138,    148], 0, [     0,      0], [0xbc, 0x65, 0x22, 0xff]],
    [[     6,    138,    -31], 0, [     0,      0], [0xd6, 0x6e, 0xd3, 0xff]],
...
const king_bobomb_seg5_vertex_0500AD50 = [
...
const king_bobomb_seg5_vertex_0500AE50 = [
...
const king_bobomb_seg5_vertex_0500B098 = [
...
const king_bobomb_seg5_vertex_0500B0D8 = [
...
const king_bobomb_seg5_vertex_0500B218 = [
...
const king_bobomb_seg5_vertex_0500B348 = [
...
const king_bobomb_seg5_vertex_0500B470 = [
...
const king_bobomb_seg5_vertex_0500B570 = [
    [[   729,   -304,   -175], 0, [  2948,   -458], [0xee, 0x94, 0xc2, 0xff]],
...
const king_bobomb_seg5_lights_0500A9E8 = gdSPDefLights1(
    0x6f, 0x56, 0x11,
    0xde, 0xad, 0x23, 0x28, 0x28, 0x28
);

const king_bobomb_seg5_lights_0500AD38 = gdSPDefLights1(
    0x6f, 0x4f, 0x10,
    0xde, 0x9e, 0x20, 0x28, 0x28, 0x28
);

const king_bobomb_seg5_lights_0500B200 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

const king_bobomb_seg5_lights_0500B330 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

const king_bobomb_seg5_lights_0500B458 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

const king_bobomb_seg5_dl_0500A4B8 = [
...
export const king_bobomb_seg5_dl_0500A4F0 = [
    gsDPPipeSync(),
...
const king_bobomb_seg5_dl_0500A5A0 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, king_bobomb_seg5_texture_05002078),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const king_bobomb_seg5_dl_0500A5D8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBA, G_CC_MODULATERGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
const king_bobomb_seg5_dl_0500A688 = [
...
export const king_bobomb_seg5_dl_0500A6C0 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBA, G_CC_MODULATERGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
const king_bobomb_seg5_dl_0500A770 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, king_bobomb_seg5_texture_05002078),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const king_bobomb_seg5_dl_0500A7A8 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBA, G_CC_MODULATERGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
const king_bobomb_seg5_dl_0500A858 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, king_bobomb_seg5_texture_05002078),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const king_bobomb_seg5_dl_0500A890 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBA, G_CC_MODULATERGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
const king_bobomb_seg5_dl_0500A940 = [
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, king_bobomb_seg5_texture_05005878),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
export const king_bobomb_seg5_dl_0500A978 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBA, G_CC_MODULATERGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
const king_bobomb_seg5_dl_0500ABC0 = [
...
export const king_bobomb_seg5_dl_0500AD08 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
...
const king_bobomb_seg5_dl_0500AF20 = [
...
export const king_bobomb_seg5_dl_0500B068 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
...
const king_bobomb_seg5_dl_0500B118 = [
...
const king_bobomb_seg5_dl_0500B150 = [
...
export const king_bobomb_seg5_dl_0500B188 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBA, G_CC_MODULATERGBA),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
const king_bobomb_seg5_dl_0500B278 = [
...
export const king_bobomb_seg5_dl_0500B2D0 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBA, G_CC_MODULATERGBA),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
...
const king_bobomb_seg5_dl_0500B3C8 = [
...
export const king_bobomb_seg5_dl_0500B418 = [
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
...
const king_bobomb_seg5_dl_0500B5F0 = [
...
export const king_bobomb_seg5_dl_0500B6C0 = [
    gsDPPipeSync(),
