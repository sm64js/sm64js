...
const loadDataIntoGame = (data) => {
    ...
    door_seg3_texture_03011D10.push(...data["actors/door/zero_star_door_sign.rgba16.png"].data)
    door_seg3_texture_03012510.push(...data["actors/door/one_star_door_sign.rgba16.png"].data)
    door_seg3_texture_03012D10.push(...data["actors/door/three_star_door_sign.rgba16.png"].data)
    door_seg3_texture_03013510.push(...data["actors/door/door_lock.rgba16.png"].data)
    door_seg3_texture_03011510.push(...data["actors/door/bbh_door_overlay.rgba16.png"].data)
    door_seg3_texture_03010510.push(...data["actors/door/bbh_door.rgba16.png"].data)
    door_seg3_texture_0300FD10.push(...data["actors/door/hmc_mural_door_overlay.rgba16.png"].data)
    door_seg3_texture_0300ED10.push(...data["actors/door/hmc_mural_door.rgba16.png"].data)
    door_seg3_texture_0300E510.push(...data["actors/door/metal_door_overlay.rgba16.png"].data)
    door_seg3_texture_0300D510.push(...data["actors/door/metal_door.rgba16.png"].data)
    door_seg3_texture_0300CD10.push(...data["actors/door/rough_wooden_door_overlay.rgba16.png"].data)
    door_seg3_texture_0300BD10.push(...data["actors/door/rough_wooden_door.rgba16.png"].data)
    door_seg3_texture_0300AD10.push(...data["actors/door/polished_wooden_door_overlay.rgba16.png"].data)
    door_seg3_texture_03009D10.push(...data["actors/door/polished_wooden_door.rgba16.png"].data)
