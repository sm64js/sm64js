...
import {
    ...
    COL_END,
    SURFACE_DEFAULT, SURFACE_DEATH_PLANE, SURFACE_SHALLOW_QUICKSAND, SURFACE_WALL_MISC,
    SURFACE_HORIZONTAL_WIND, SURFACE_ICE, SURFACE_HARD_VERY_SLIPPERY, SURFACE_HARD_NOT_SLIPPERY,
    SURFACE_VERTICAL_WIND, SURFACE_CAMERA_FREE_ROAM, SURFACE_CAMERA_8_DIR,
    SURFACE_CAMERA_ROTATE_RIGHT, SURFACE_NO_CAM_COLLISION, SURFACE_NO_CAM_COL_VERY_SLIPPERY,
    special_null_start, special_bubble_tree
} from "../../../../include/surface_terrains"

// 0x07009FC8 - 0x0700BD5E
export const thi_seg7_area_1_collision = [
    COL_INIT(),
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(2),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_null_start,  /*pos*/ -7372, -2969,  7373, /*yaw*/ 106),
