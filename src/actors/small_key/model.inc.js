...
import {
    gdSPDefLights1, gsSPVertex, gsSP2Triangles, gsSP1Triangle, gsSPEndDisplayList, gsSPSetLights1,
    gsSPBranchList
} from "../../include/gbi"
...
// 0x05005798
const small_key_seg5_lights_05005798 = gdSPDefLights1(
    0x3f, 0x19, 0x0c,
    0xff, 0x64, 0x32, 0x28, 0x28, 0x28
);

// 0x050057B0
const small_key_seg5_lights_050057B0 = gdSPDefLights1(
    0x0c, 0x3f, 0x19,
    0x32, 0xff, 0x64, 0x28, 0x28, 0x28
);

// 0x050057C8
const small_key_seg5_lights_050057C8 = gdSPDefLights1(
    0x0c, 0x19, 0x3f,
    0x32, 0x64, 0xff, 0x28, 0x28, 0x28
);

// 0x050057E0
const small_key_seg5_lights_050057E0 = gdSPDefLights1(
    0x33, 0x3f, 0x00,
...
// align
// 0x05005800
const small_key_seg5_vertex_05005800 = [
...
// 0x050058F0
const small_key_seg5_vertex_050058F0 = [
...
// 0x050059E0
const small_key_seg5_vertex_050059E0 = [
...
// 0x05005AD0
const small_key_seg5_vertex_05005AD0 = [
    [[   -14,   -109,    -14], 0, [     0,      0], [0x00, 0x81, 0x00, 0x00]],
...
// 0x05005BC0
const small_key_seg5_vertex_05005BC0 = [
    [[   -14,     57,     48], 0, [     0,      0], [0x00, 0x81, 0x00, 0x00]],
    [[   -14,     57,     14], 0, [     0,      0], [0x00, 0x81, 0x00, 0x00]],
    [[    14,     57,     48], 0, [     0,      0], [0x00, 0x81, 0x00, 0x00]],
...
// 0x05005CB0
const small_key_seg5_vertex_05005CB0 = [
    [[    14,     57,     14], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
    [[    14,    195,    -28], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
    [[    14,    195,     28], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
    [[    14,     57,    -14], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
...
// 0x05005DA0
const small_key_seg5_vertex_05005DA0 = [
...
// 0x05005E90
const small_key_seg5_vertex_05005E90 = [
...
// 0x05005F80
const small_key_seg5_vertex_05005F80 = [
    [[    14,     57,     14], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
    [[    14,     57,    -14], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
    [[    14,    195,    -28], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
    [[    23,    103,    -83], 0, [     0,      0], [0x00, 0xb5, 0x9a, 0x00]],
...
// 0x05006070
const small_key_seg5_vertex_05006070 = [
    [[   -19,    180,    -67], 0, [     0,      0], [0x00, 0x38, 0x8e, 0x00]],
    [[    19,    180,    -67], 0, [     0,      0], [0x00, 0x38, 0x8e, 0x00]],
    [[    23,    149,    -83], 0, [     0,      0], [0x00, 0x38, 0x8e, 0x00]],
    [[    23,    149,     83], 0, [     0,      0], [0x00, 0x00, 0x7f, 0x00]],
...
// 0x05006160
const small_key_seg5_vertex_05006160 = [
    [[   -14,    -50,    -58], 0, [     0,      0], [0x00, 0x81, 0x00, 0x00]],
    [[    14,    -50,    -58], 0, [     0,      0], [0x00, 0x81, 0x00, 0x00]],
    [[    14,    -50,    -14], 0, [     0,      0], [0x00, 0x81, 0x00, 0x00]],
    [[   -14,    -14,    -58], 0, [     0,      0], [0x81, 0x00, 0x00, 0x00]],
...
// 0x05006250
const small_key_seg5_vertex_05006250 = [
    [[   -14,    -73,    -58], 0, [     0,      0], [0x81, 0x00, 0x00, 0x00]],
...
// 0x05006340
const small_key_seg5_vertex_05006340 = [
    [[   -14,     57,    -14], 0, [     0,      0], [0x00, 0x00, 0x81, 0x00]],
    [[    14,     57,    -14], 0, [     0,      0], [0x00, 0x00, 0x81, 0x00]],
    [[    14,    -14,    -14], 0, [     0,      0], [0x00, 0x00, 0x81, 0x00]],
    [[   -14,     57,    -48], 0, [     0,      0], [0x00, 0x81, 0x00, 0x00]],
...
// 0x05006430
const small_key_seg5_vertex_05006430 = [
...
// 0x05006520
const small_key_seg5_vertex_05006520 = [
    [[   -14,    -50,    -14], 0, [     0,      0], [0x81, 0x00, 0x00, 0x00]],
    [[   -14,    -73,    -14], 0, [     0,      0], [0x81, 0x00, 0x00, 0x00]],
    [[   -14,   -109,     14], 0, [     0,      0], [0x81, 0x00, 0x00, 0x00]],
    [[   -14,    -73,    -14], 0, [     0,      0], [0x81, 0x00, 0x00, 0x00]],
...
// 0x05006610
const small_key_seg5_vertex_05006610 = [
    [[    14,    -14,    -14], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
    [[    14,     57,    -14], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
    [[    14,     57,     14], 0, [     0,      0], [0x7f, 0x00, 0x00, 0x00]],
    [[    14,   -109,    -14], 0, [     0,      0], [0x00, 0x81, 0x00, 0x00]],
...
export const small_key_seg5_dl_05006700 = [
